<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addtoconsult.aspx.cs" Inherits="addtoconsult" EnableEventValidation="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="javascript/addtoconsult.js"></script>
</head>
<body>
                    ...
                    <div class="col-sm-9">
                        <div class="accntsec">
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control form-control-lg"
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <%--<input type="text" name="" class="form-control form-control-lg" placeholder="Enter email id">--%>
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label class="required">Mobile No</label>
                                    <%--<input type="text" name="" class="form-control form-control-lg" placeholder="Latitude">--%>
                                    <asp:TextBox ID="mn" runat="server" CssClass="form-control form-control-lg" placeholder="Mobile No"></asp:TextBox>
                                </div>
                                <div class="col-sm-6 form-group" style="display: none;">
                                    <label class="required">Password</label>
                                    <asp:TextBox ID="txtpwd" runat="server" class="form-control form-control-lg" placeholder="Enter Password"></asp:TextBox>
                                    <%--<input type="text" name="" class="form-control form-control-lg" placeholder="Enter email id">--%>
                                </div>
                                <div class="col-sm-6 form-group" style="display: none;">
                                ...
                                <div class="col-sm-6 form-group">
                                    <label class="required" id="datelabel" runat="server">Birth Date</label>
                                    <div class="calicnrgt">
                                ...
                                <div class="col-sm-6 form-group">
                                    <label class="required" id="timelabel" runat="server">Birth Time <font color="red">(24 hours format)</font></label>
                                    <div class="calicnrgt">
                                ...
                                <div class="col-sm-6 form-group">
                                    <label class="required" id="citylabel" runat="server">Birth City</label>
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <%--<input type="text" name="" class="form-control form-control-lg" placeholder="Latitude">--%>
                                    <asp:TextBox ID="cl_pro" runat="server" CssClass="form-control form-control-lg" placeholder="Profession"></asp:TextBox>
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label class="required">Latitude</label>
                                    <%--<input type="text" name="" class="form-control form-control-lg" placeholder="Latitude">--%>
                                    <asp:TextBox ID="lat" runat="server" CssClass="form-control form-control-lg" placeholder="Latitude"></asp:TextBox>
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label class="required">Longitude</label>
                                    <%--<input type="text" name="" class="form-control form-control-lg" placeholder="Longitude">--%>
                                    <asp:TextBox ID="lng" runat="server" CssClass="form-control form-control-lg" placeholder="Longitude"></asp:TextBox>
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label class="required">Time Zone</label>
                                    <%--<input type="text" name="" class="form-control form-control-lg" placeholder="Time Zone">--%>
                                    <asp:TextBox ID="tz" runat="server" CssClass="form-control form-control-lg" placeholder="Time Zone"></asp:TextBox>
                                </div>
                                <div class="col-sm-6 form-group" style="display: none;">
                                    <label class="required">Group Name</label>
                                    <asp:DropDownList ID="cat" runat="server" CssClass="textbox" Enabled="true">
                                        <asp:ListItem Value="AENC" Selected="True">Astro Envision Natal Consult</asp:ListItem>
                                        <asp:ListItem Value="AEHC">Astro Envision Horary Consult</asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:TextBox ID="catn" runat="server" Height="25px" placeholder="Enter Group Name"
                                        CssClass="textbox" Style="display: none;"></asp:TextBox>
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label class="required">Select No of Questions</label>
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddlnoofquestions" runat="server" CssClass="form-control form-control-lg"
                                                AutoPostBack="true" OnSelectedIndexChanged="ddlNoOfQuestions_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-sm-6 form-group">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddlservice" runat="server" CssClass="form-control form-control-lg" AutoPostBack="true"
                                                OnSelectedIndexChanged="ddlservice_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-sm-12 form-group" runat="server" id="divQuestion">
                                    <asp:UpdatePanel ID="UpdatePanel7" runat="server" style="width: 100%;">
                                        <ContentTemplate>
                                            <div class="col-sm-12 form-group" id="question1" runat="server" style="display: none;">
                                                <label class="required">Question 1</label>
                                                <asp:TextBox ID="txtques1" runat="server"
                                                    CssClass="form-control form-control-lg"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-12 form-group" id="question2" runat="server" style="display: none;">
                                                <label class="required">Question 2</label>
                                                <asp:TextBox ID="txtques2" runat="server"
                                                    CssClass="form-control form-control-lg"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-12 form-group" id="question3" runat="server" style="display: none;">
                                                <label class="required">Question 3</label>
                                                <asp:TextBox ID="txtques3" runat="server"
                                                    CssClass="form-control form-control-lg"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-12 form-group" id="question4" runat="server" style="display: none;">
                                                <label class="required">Question 4</label>
                                                <asp:TextBox ID="txtques4" runat="server"
                                                    CssClass="form-control form-control-lg"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-12 form-group" id="question5" runat="server" style="display: none;">
                                                <label class="required">Question 5</label>
                                                <asp:TextBox ID="txtques5" runat="server"
                                                    CssClass="form-control form-control-lg"></asp:TextBox>
                                            </div>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                ...
                                <div class="col-sm-6 form-group">
                                    <label class="required">Mode of Payments</label>
                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                        <ContentTemplate>
                                            <asp:RadioButtonList ID="btlmodeofpayment" runat="server">
                                                <asp:ListItem Text="Online payment" Value="OLP" Selected="True"></asp:ListItem>
                                                <asp:ListItem Text="Payment by Deposit in Bank / DD / Cheque" Value="DDP"></asp:ListItem>
                                                <asp:ListItem Text="Payment by wire Transfer" Value="PWT"></asp:ListItem>
                                            </asp:RadioButtonList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                </div>
                                <div class="col-sm-12 form-group">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                        <ContentTemplate>
                                            <h2 class="priceh2" id="actualtotalamt" runat="server"></h2>
                                            <div class="priceh2" id="actualtotalamt2" runat="server" style="display: none"></div>
                                            <h2 class="priceh1" id="discountper" runat="server"></h2>
                                            <h2 class="priceh3" id="totalamt" runat="server"></h2>
                            ...
                            <div class="mt-3 text-center">
                                ...
                                <asp:Button ID="submit" runat="server" CssClass="kwm-btn-lg" Text="Submit" />
                            </div>
                        </div>
                    </div>
                </div>
