...
public partial class research_tool_any : System.Web.UI.Page
{
    string filt = "";
    string usermail = "";
    string usermail1 = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Ajax.Utility.RegisterTypeForAjax(typeof(research_tool_any));
        if (Session["usermail"] == null || Session["usermail"] == "")
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(research_tool_any), "wq", "window.parent.location.href='login.aspx';", true);
            return;
        }
        ...
        if (!Page.IsPostBack)
        {
            ...
            any.InnerHtml = ds1.Tables[0].Rows[0].ItemArray[5].ToString();
    ...
    [Ajax.AjaxMethod]
    public DataSet search(string rashi1, string house1, string astrolrger, string clgroup, string client, string sv, string svn, string vn)
    {
        DataSet ds = new DataSet();
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            ...
            ASTROLOGY.classesoracle.researchtool country = new ASTROLOGY.classesoracle.researchtool();
                ...
                ds = country.ast_research_tool_any(rashi1, house1, astrolrger, clgroup, client, sv, svn,vn);
    ...
    public DataSet clientinfo(string varga,string astrologer)
    {
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            ...
            //Circulation.classesoracle.agency_mast admast = new Circulation.classesoracle.agency_mast();
            ASTROLOGY.classesoracle.researchtool country = new ASTROLOGY.classesoracle.researchtool();
            ds = country.ast_clientinfoany(varga,astrologer);
        }
        return ds;
