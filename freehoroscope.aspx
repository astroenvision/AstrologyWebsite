<%@ Page Language="C#" AutoEventWireup="true" CodeFile="freehoroscope.aspx.cs" Inherits="freehoroscope" EnableEventValidation="false" %>
...
<head runat="server">
    <title>Free Horoscope Matching, Online Horoscope Matching Software | Astro Envision</title>
    <meta charset="utf-8" />
    ...
    <script type="text/javascript" src="javascript/freehoroscope.js"></script>
            ...
            <div class="container">
                ...
                <div class="container-sec my-2">
                    <div class="content-center">
                        <%-- <h1 class="pageheading">Free Horoscope</h1>--%>
                        <div class="line">
                            <h1 id="heading_div">Free Astro Horoscope Report</h1>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-background_article">
                                <div class="fullarticle">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h2 style="text-align: center;">Free Online Horoscope and Personality report</h2>
                                            <p>In this Free Online Horoscope Report, Astro Envision will provide you Free Predictions about your multiple personality traits and many other important things about your life just free.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="px-3 py-2" style="border: 1px solid #e0e0e0; border-radius: 15px;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 form-group" style="display:none;">
                                            ...
                                            <asp:TextBox ID="txtModileNo" runat="server" MaxLength="12" CssClass="form-control form-control-lg" placeholder="Mobile No" onkeypress="return event.charCode >= 48 && event.charCode <= 57"></asp:TextBox>
                                            <%--<asp:RegularExpressionValidator ID="revMobNo" runat="server" ErrorMessage="Invalid Mobile Number."
                                                ValidationExpression="^([0-9]{10,12})$" ControlToValidate="txtModileNo" ValidationGroup="SaveData"
                                    ...
                                    <div class="text-center">
                                        ...
                                        <asp:Button ID="btnsave" runat="server" CssClass="kwm-btn-lg" Text="View Report" ValidationGroup="SaveData" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 my-4">
                            <div class="form-background_article">
                                <div class="fullarticle">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h2 style="text-align: center; color: red;">Why you should look beyond Free Horoscope report?</h2>
                                            <h2 style="text-align: center; color: red;">The New Way to look at you Online Horoscope and highly accurate Kundli prediction Reports.</h2>
                                            <p>
                                                We, at Astro Envision, the team of expert astrologers lead by Consultant Astrologer Hari Sharma, MBA, 
                                                Jyotish Acharya have made this Software backed by authentic predictions which is based on your Birth Data. 
                                                We cover the important feature of your birth chart about many aspects which have been given in the <a href="https://www.astroenvision.com/">Home page</a>.  
                                                We shall be happy to serve your further to your satisfaction.
                                            </p>
                                        </div>
                                    </div>
                                </div>
