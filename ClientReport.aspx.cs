...
public partial class ClientReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Request.QueryString["cartid"] != null && Request.QueryString["cartid"] != null)
            {
                ...
                dscid = obj_subs.AstGetCommon(cartidval, "", "", "GET_CLIENT_ID_FROM_ASTRO");
    ...
    protected void lnkGenerateWordFile_Click(object sender , EventArgs e)
    {
        DownloadWord(TBL.ToString());
    }
    ...
    protected void BindCharts(string Flag)
    {
        ...
        if (Flag == "ForPage") // HTML
        {
            TBL.Append("<div style='font-size: 1.2em;float: left;padding:0em 0em 0.4em 0em;margin: 0em 0em 0em 0em;width: 100%;text-align: left;color: #007bff;font-weight: bold;border-bottom: 3px solid #007bff;'>Birth Chart</div>");
        }
        else  // PDF
        {
            TBL.Append("<div style='font-size: 1.4em;float: left;padding:0em 0em 0.4em 0em;margin: 0em 0em 0em 0em;width: 100%;text-align: left;color: #007bff;font-weight: bold;border-bottom: 3px solid #007bff;'>Birth Chart</div>");
        }
        ...
        if (Flag == "ForPage")
        {
            TBL.Append("<div style='padding:0em 0em 0.4em 0em;margin: 0em 0em 0.5em 0em;width: 100%;text-align: left;color: #007bff;font-weight: bold;border-bottom: 3px solid #007bff;font-size: 1.1em;'>Your Astro Snapshot</div>");
        ...
        {
            TBL.Append("<div style='padding:0em 0em 0.4em 0em;margin: 0em 0em 0.5em 0em;width: 100%;text-align: left;color: #007bff;font-weight: bold;border-bottom: 3px solid #007bff;font-size: 1.3em;'>Your Astro Snapshot</div>");
        ...
        if (Flag == "ForPage")
        {
            TBL.Append("<div style='float: left;padding:0em 0em 0.4em 0em;margin: 0em 0em 0.5em 0em;width: 100%;text-align: left;font-size: 1.1em;color: #007bff;font-weight: bold;border-bottom: 3px solid #007bff;'>Your Astro Reports</div>");
        }
        else
        {
            TBL.Append("<div style='float: left;padding:0em 0em 0.4em 0em;margin: 0em 0em 0.5em 0em;width: 100%;text-align: left;font-size: 1.4em;color: #007bff;font-weight: bold;border-bottom: 3px solid #007bff;'>Your Astro Reports</div>");
        }
                            ...
                            for (int m = 0; m < ANSWERSplit.Length; m++)
                            {
                                ...
                                else
                                {
                                    if (QUESTIONID == "2064") // Kaal Sarpa Dosha Report
                                    {
                                        ...
                                        {
                                            string DoshaPredictive = dsksdosha.Tables[0].Rows[0]["PREDICTIVE"].ToString().Trim();
                                            //var pattern = @"(?!</?b>)<.*?>";
        ...
        //TBL.Append("</div>");
        ds = obj.ManageMapingDetails("GET_MAPPING_DETAILS", hdnuserid.Value, "", "", "", "", "", "", "");
        if(ds.Tables[0].Rows.Count > 0)
        {
           string Question1 = ds.Tables[0].Rows[0]["QUESTION1"].ToString();
           string Question2 = ds.Tables[0].Rows[0]["QUESTION2"].ToString();
           string Question3 = ds.Tables[0].Rows[0]["QUESTION3"].ToString();
           string Question4 = ds.Tables[0].Rows[0]["QUESTION4"].ToString();
           string Question5 = ds.Tables[0].Rows[0]["QUESTION5"].ToString();

            string ANSWER1 = ds.Tables[0].Rows[0]["ANSWER1"].ToString();
            string ANSWER2 = ds.Tables[0].Rows[0]["ANSWER2"].ToString();
            string ANSWER3 = ds.Tables[0].Rows[0]["ANSWER3"].ToString();
            string ANSWER4 = ds.Tables[0].Rows[0]["ANSWER4"].ToString();
            string ANSWER5 = ds.Tables[0].Rows[0]["ANSWER5"].ToString();

            if(ANSWER1 !="")
            {
                TBL.Append("<strong style='margin-left: 18px;'>Question 1: " + Question1 + "</strong>");
                TBL.Append("<p style='margin-left: 18px;'>Answer 1: " + ANSWER1 + "</p>");
            }

            if (ANSWER2 != "")
            {
                TBL.Append("<strong  style='margin-left: 18px;'>Question 2: " + Question2 + "</strong>");
                TBL.Append("<p style='margin-left: 18px;'>Answer 2: " + ANSWER2 + "</p>");
            }
            if (ANSWER3 != "")
            {
                TBL.Append("<strong  style='margin-left: 18px;'>Question 2: " + Question3 + "</strong>");
                TBL.Append("<p  style='margin-left: 18px;'>Answer 2: " + ANSWER3 + "</p>");
            }
            if (ANSWER4 != "")
            {
                TBL.Append("<strong  style='margin-left: 18px;'>Question 2: " + Question4 + "</strong>");
                TBL.Append("<p  style='margin-left: 18px;'>Answer 2: " + ANSWER4 + "</p>");
            }
            if (ANSWER5 != "")
            {
                TBL.Append("<strong  style='margin-left: 18px;'>Question 2: " + Question5 + "</strong>");
                TBL.Append("<p  style='margin-left: 18px;'>Answer 2: " + ANSWER5 + "</p>");
            }
    ...
    protected void ShowChart(string ChartNo)
    {
        ...
        if (flagForPdf == "ForPage")
        {
            ...
            TBL.Append("</span>");
            TBL.Append("</div>");
            TBL.Append("<div style=\"position:absolute; top:12%; left:16%;width:10%;\">");
            TBL.Append("<span>");
