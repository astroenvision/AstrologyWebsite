<%@ Page Language="C#" AutoEventWireup="true" CodeFile="researchtool_conjunction.aspx.cs" Inherits="researchtool_conjunction" EnableEventValidation="false"%>
...
<script type="text/javascript" language="javascript" src="javascript/researchtool_conjunction.js"></script>
...
<asp:DropDownList ID="grcl"    CssClass="drpo_homenewcl" runat="server" ></asp:DropDownList> 
 ...
 <tr>
  <div class="d_header_3">
    <p>
    Choose  - Conjunction of Chosen Planet’s in Varga’s ( For Individual or Group of chart)</p>
     <p id="ctp" runat="server">
    Explanation : ( In this Research Tool, Astrologer can  choose  - Conjunction of Two or more planets up to 8 Planets in the Vargas mentioned OR in any individual Varga as desired for Individual or a Group of Chart) .</p>
   </div>
 ...
 <td style="padding-left:00px;border:1px ;border-color:#7DAAE3; ">
   <div id="Divgrid1" class="divg" style= "display:none; " >
    ...
    <td runat="server" id="hdsviewgrid" style="width:97%; " align="left"  ></td>
     ...
     <div id="clinetnamediv" runat="server"  style="width:976px; float: left;height: auto; overflow: auto;display:none; margin-left:5px; margin-top:-187px;  background-color: #FFFFFF; border: 1px solid #E3E3E3;  box-shadow: 2px 2px 5px #000000;" >
