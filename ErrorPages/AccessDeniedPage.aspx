<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccessDeniedPage.aspx.cs" Inherits="ErrorPages_AccessDeniedPage" %>
    ...
    <form id="form1" runat="server">
        <div class="mainerror">
            <div class="errorbox">
                ...
                <div class="errttl"><span>403</span>Oops! Access Denied!</div>
