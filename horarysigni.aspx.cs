...
public partial class horarysigni : System.Web.UI.Page
{
    string message = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        Ajax.Utility.RegisterTypeForAjax(typeof(horarysigni));
        ...
        if (!Page.IsPostBack)
        {
            ...
            exte.Attributes.Add("onclick", "javascript:return showext12();");
    ...
    protected void AspNetMessageBox(string strMessage)
    {
        ...
        ScriptManager.RegisterClientScriptBlock(this, typeof(horarysigni), "ShowAlert", strAlert, true);
    }
    ...
    public string save1(string CODE, string KEY_STRING, string DESCCLOB, string BOOK, string PAGE_NO, string HOUSE, string PLANET, string RASHI, string EXTENTIONS)
    {
        try
        {
            ...
            if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
            {
                ...
                ASTROLOGY.classesoracle.Houseposition country = new ASTROLOGY.classesoracle.Houseposition();
                ds = country.save_horary(CODE, KEY_STRING, DESCCLOB, BOOK, PAGE_NO, HOUSE, PLANET, RASHI, EXTENTIONS);
            }
            return "true";
        }
        catch (Exception ex)
    ...
    public DataSet filtergrid1(string comp_code, string house, string rashi, string planet, string textname, string book, string page0, string EXTENTIONS, string extra1)
    {
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            ...
            ASTROLOGY.classesoracle.Houseposition country = new ASTROLOGY.classesoracle.Houseposition();
            ds = country.fillgridh(comp_code, house, rashi, planet, textname, book, page0, EXTENTIONS, extra1);
        }
        return ds;
    ...
    public DataSet update_grid(string key, string key1, string housev)
    {
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            ...
            ASTROLOGY.classesoracle.Houseposition country = new ASTROLOGY.classesoracle.Houseposition();
            ds = country.update_gridencycloh(key, key1, housev);
        }
        return ds;
    ...
    public DataSet delete_grid_row(string key, string housev)
    {
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            ...
            //Circulation.classesoracle.agency_mast admast = new Circulation.classesoracle.agency_mast();
            ASTROLOGY.classesoracle.Houseposition country = new ASTROLOGY.classesoracle.Houseposition();
            ds = country.delete_gridencycloh(key, housev);
        }
        return ds;
    ...
    [Ajax.AjaxMethod]
    public DataSet showextvalue(string exten)
    {
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            ...
            //Circulation.classesoracle.agency_mast admast = new Circulation.classesoracle.agency_mast();
            ASTROLOGY.classesoracle.Houseposition country = new ASTROLOGY.classesoracle.Houseposition();
            ds = country.showextnvalueh(exten);
        }
        return ds;
    ...
    public DataSet chk_encyclo(string key, string housev)
    {
        ...
        if (ConfigurationSettings.AppSettings["ConnectionType"].ToString() == "orcl")
        {
            ...
            //Circulation.classesoracle.agency_mast admast = new Circulation.classesoracle.agency_mast();
            ASTROLOGY.classesoracle.Houseposition country = new ASTROLOGY.classesoracle.Houseposition();
            ds = country.chk_encyclogridh(key, housev);
        }
        return ds;
