<%@ Page Title="" Language="C#" MasterPageFile="~/astroenvision.master" AutoEventWireup="true" CodeFile="freecompatibilitymatchingdetails.aspx.cs" Inherits="freecompatibilitymatchingdetails" %>
    ...
    <div class="container">
        <div class="container-sec">
            ...
            <div class="row justify-content-center">
                <%--<div class="col-sm-12 justify-content-center line">
                    <h1 id="heading_div">Kundli Matching Details</h1>
                </div>--%>
                <div style="clear: both;"></div>
                <div class="col-sm-12 row d-flex justify-content-center">
                    <div class="col-sm-10 my-3">
                        ...
                        <div class="mt-3 text-center">
                            <asp:Button ID="btnproceed" runat="server" class="kwm-btn-lg" Text="Generate Matching Report" OnClick="btnproceed_Click"></asp:Button>
                        </div>
                    </div>
                </div>
            </div>
