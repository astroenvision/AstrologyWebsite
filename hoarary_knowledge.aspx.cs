...
public partial class hoarary_knowledge : System.Web.UI.Page
{
    string usermail = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(hoarary_knowledge), "wq", "window.parent.location.href='login.aspx';", true);
            return;
        } 
        ...
        if (!Page.IsPostBack)
        {
            Ajax.Utility.RegisterTypeForAjax(typeof(hoarary_knowledge));
          ...
          //  tb1.Attributes.Add("onkeyup", "javascript:return myPostBack();");
    ...
    public void bindtree(DataSet pdsUserRights)
    {
        ...
        for (int h = 0; h < dsj.Tables[0].Rows.Count; h++)
        {
            ...
            {
                hdnnl.Value += dsj.Tables[0].Rows[h]["NODE_NAME"].ToString() + "~";
        ...
        TreeView1.NodeStyle.ForeColor = Color.Blue;
    ...
    protected void TreeView1_TreeNodePopulate(object sender, EventArgs e)
    {
        ...
        //DataSet ds = new DataSet();
        //ASTROLOGY.classesoracle.Houseposition country = new ASTROLOGY.classesoracle.Houseposition();
        //ds = country.fetch_treeexplation_hora(t);
    ...
    public void PrintNodesRecursive(TreeNode oMainNode)
    {
        ...
        foreach (TreeNode osubnode in oMainNode.ChildNodes)
        {
            ...
            string v4 = "";
            string c = "";
            if (oMainNode.Text == "Horary Knowledge")
            {
                if (flag == "0")
                {
                    v4 = v3;
        ...
        TreeView1.ParentNodeStyle.Font.Size = 10;
        TreeView1.ParentNodeStyle.ForeColor = Color.Blue;
    ...
    protected void cola_Click(object sender, EventArgs e)
    {
        TreeView1.CollapseAll();
    }
