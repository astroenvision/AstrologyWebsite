<%@ Page Language="C#" AutoEventWireup="true" CodeFile="encyclopaedia.aspx.cs" Inherits="encyclopaedia" %>
...
<head runat="server">
    <title>Encyclopaedia Master</title>
    
     <script type="text/javascript" language="javascript" src="javascript/encyclopaedia.js"></script>
...
<body onload="blankfields();"  id="body"   style="background-color:#f3f6fd;margin:0px 0px 0px 0px"> 
    ...
    <table>
    <tr>
            <td colspan="2"><uc1:topbar id="Topbar1" runat="server" Text="Encyclopaedia Master"></uc1:topbar></td>
    </tr>
    </table>
     ...
     <table id="outertable" width="400px" border="0" cellpadding="0" cellspacing="0">
   	...
   	<tr> <td>   
                  ...
                  <tr>
                     ...
                     <td style="width:150PX;font-family:Verdana;text-align:right;font-size:10px;background-color:#a0bfeb; height:20px;"><b><center> Encyclopaedia Master</center></b></td>
