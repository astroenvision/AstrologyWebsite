...
public partial class AdminLogin_Old : System.Web.UI.Page
{
    #region Declarations
    admin obj = new admin();
    ...
    protected void btnsignin_Click(object sender, EventArgs e)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            else
            {
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(this, typeof(AdminLogin_Old), "js", "alert('Invalid UserName or Password! Try Again !');", true);
                    return;
                }
                else
                {
                    ScriptManager.RegisterClientScriptBlock(this, typeof(AdminLogin_Old), "js", "alert('Not Register User!');", true);
                    return;
                }
            }
        }
