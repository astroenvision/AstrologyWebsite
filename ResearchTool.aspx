<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResearchTool.aspx.cs" Inherits="ResearchTool" EnableEventValidation="false"%>
...
<script type="text/javascript" language="javascript" src="javascript/researchtool.js"></script>
...
<asp:DropDownList ID="grcl"    CssClass="drpo_homenewcl" runat="server" ></asp:DropDownList> 
 ...
 <tr>
  <div class="d_header_3">
    <p>
    Choose Single or Multiple Combinations  - (For Individual or Group of chart)</p>
    <p id="awastha" runat="server">
    Explanation : In this Research Tool, Astrologer  can choose - One Planet or Multiple Planets with combination of one or more Awastha’s as given along with Various set of Vargas or any Individual Vargas for filter the Astro data in Individual Chart or in a Group of Chart)</p>
   </div>
   ...
   <div class="d_header_3">
    <p>Choose :
   <input type="checkbox" ID="own" value="Own" runat="server" class="vargt"/>Own
   <input type="checkbox" ID="fri"  value="Friendly" runat="server" class="vargt" />Friendly
   <input type="checkbox" ID="exal"  value="Exaltation" runat="server" class="vargt" />Exaltation
   <input type="checkbox" ID="enim"  value="Enimical" runat="server" class="vargt" />Enimical
   <input type="checkbox" ID="deb"  value="Deblitaition"  runat="server" class="vargt" />Deblitaition
   <input type="checkbox" ID="neut"  value="Neutral" runat="server" class="vargt" />Neutral
   <input type="checkbox" ID="mootri"  value="Moola Trikona"  runat="server" class="vargt" />Moola Trikona
   ...
   <input type="radio" ID="Radio1" name="vargas" value="Single / Multiple Varga" checked="true" runat="server" class="vargt" />Single / Multiple Varga</p>
 ...
 <td style="padding-left:00px;border:1px ;border-color:#7DAAE3; ">
   <div id="Divgrid1" class="divg" style= "display:none; " >
    ...
    <td runat="server" id="hdsviewgrid" style="width:97%; " align="left"  ></td>
     ...
     <div id="clinetnamediv" runat="server"  style="width:976px; float: left;height: auto; overflow: auto;display:none; margin-left:5px; margin-top:-144px;  background-color: #FFFFFF; border: 1px solid #E3E3E3;  box-shadow: 2px 2px 5px #000000;" >
         <div class="colum-td-head" style="width:97% !important; margin-left: 0px;">
          ...
          <div id="v1" style="width:976px;overflow:auto; margin-left:5px;">
           ...
           <div id="client_id"  style="width:170px; float:left;" font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">Client Id
            ...
            <div id="pl" style="width:170px; float:left;" font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">Planet
            </div>
           <div id="rashi_div" style="width:170px;  float:left;" font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">Awastha
           </div>
           ...
           <div style="width:170px;height:140px; float:left;"><asp:Label ID="cm" runat="server" Text=""></asp:Label></div>
            <div style="width:170px;height:140px; float:left;"><asp:Label ID="pla"  runat="server" Text=""></asp:Label></div>
        ...
        <div style="width:250px;height:140px; float:left;"><asp:Label ID="va" runat="server" Text=""></asp:Label></div>
         ...
         <div  id="Dv1"   style="width:950px; margin-left:5px;  border:1px solid;">
         <div id="Div3"   style="width:170px; float:left;" font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">Planet
           </div>
           <div id="Div4"   style="width:170px; float:left;" font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">Awastha
           </div>
           <div id="Div5"  style="width:170px; float:left;" font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">Total
           </div>
           <div id="Div6"  style="width:170px;float:left;"  font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">Percentage
           </div>
           <div id="Div7"  style="width:250px;float:left;"  font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">Nummber Of Chart
           </div>
           </div>
           <div id="iv1"   style="width:950px; height:130px; overflow:auto; margin-left:5px; margin-top:20px; border:1px solid;">
