<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddAstrologerClient.aspx.cs" Inherits="AddAstrologerClient" EnableEventValidation="false" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="javascript/AddAstrologerClient.js"></script>
                        ...
                        <div class="accntsec">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 form-group">
                                    <label id="lblClientIDVal" runat="server"></label>
                            ...
                            <div class="mt-3 text-center">
                                 <asp:Button ID="btnsave" runat="server" CssClass="kwm-btn-lg" OnClick="btnSave_Click" OnClientClick="cl_dtls();"  Text="Save Details" type="submit" ValidationGroup="SaveData" />
                            </div>
                        </div>
                    </div>
                </div>
