<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GenerateTodayChart.aspx.cs" Inherits="GenerateTodayChart" %>
...
<head runat="server">
    <title>AutoSave Daily Chart | Astro Envision</title>
    ...
    <script type="text/javascript" src="javascript/GenerateTodayChart.js"></script>
    <%--<script src="javascript/popupcalenderlead.js" type="text/javascript"></script>--%>
   <%-- <meta name="description" content="Looking for Free Horoscope Matching? Get online Free Vedic Horoscope and insight into your personality and other free predictions covering important aspects of your life." />
    <meta name="keywords" content="free horoscope report, horoscope online report, free astrology, free horoscope online, free horoscope predictions, free birth chart, Astro Envision" />--%>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <section class="bannerarea">
            ...
            <div class="container">
                ...
                <div class="container-sec my-2">
                    <div class="content-center">
                        <div class="line">
                            <h1 id="heading_div">Daily Chart</h1>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-background_article">
                                <div class="fullarticle">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h2 style="text-align: center;" id="msgid" runat="server">Today Chart is not Saved</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-9">
                                <div class="px-3 py-2" style="border: 1px solid #e0e0e0; border-radius: 15px;">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <asp:TextBox ID="cl_name" disabled="disabled" runat="server" class="form-control form-control-lg" placeholder="Enter full name"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-6 form-group" style="display:none;">
                                            <label class="required">Email ID</label>
                                            <asp:TextBox ID="txtmail" disabled="disabled" runat="server" class="form-control form-control-lg" placeholder="Enter email id"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-6 form-group" style="display:none;">
                                            <label class="required">Mobile No</label>
                                            <asp:TextBox ID="txtModileNo" disabled="disabled" runat="server" MaxLength="12" CssClass="form-control form-control-lg" placeholder="Mobile No" onkeypress="return event.charCode >= 48 && event.charCode <= 57"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label class="required">Gender</label>
                                            <asp:DropDownList ID="ddlgender" disabled="disabled" runat="server" CssClass="form-control form-control-lg">
                                        ...
                                        <div class="col-sm-6 form-group" style="display: none;">
                                            ...
                                            <div class="calicnrgt">
                                                <asp:TextBox ID="dob" disabled="disabled" runat="server" Width="85%" CssClass="form-control form-control-lg form-control-txtmargin" placeholder="dd/mm/yyyy" AutoCompleteType="Disabled" autocomplete="off"></asp:TextBox>
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <div class="calicnrgt">
                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlDate" disabled="disabled" runat="server" Width="25%" CssClass="form-control form-control-lg form-control-dll" AutoPostBack="true">
                                                        </asp:DropDownList>
                                                        <asp:DropDownList ID="ddlMonth" disabled="disabled" runat="server" Width="30%" CssClass="form-control form-control-lg form-control-dll" AutoPostBack="true">
                                                        </asp:DropDownList>
                                                        <asp:DropDownList ID="ddlYear" disabled="disabled" runat="server" Width="30%" CssClass="form-control form-control-lg form-control-dll" AutoPostBack="true">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <div class="calicnrgt">
                                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="hob" disabled="disabled" runat="server" Width="42%" CssClass="form-control form-control-lg form-control-dll" AutoPostBack="true">
                                                        </asp:DropDownList>
                                                        <asp:DropDownList ID="mob" disabled="disabled" runat="server" Width="42%" CssClass="form-control form-control-lg form-control-dll" AutoPostBack="true">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </div>
                                        ...
                                        <div class="col-sm-6 form-group">
                                            ...
                                            <asp:DropDownList ID="ddlCountry" disabled="disabled" runat="server" CssClass="form-control form-control-lg js-example-placeholder-single" Onchange="ddlCountryChange();">
                                            </asp:DropDownList>
                                        </div>

                                        <div class="col-sm-6 form-group">
                                            <label class="required">Birth State</label>
                                            <asp:DropDownList ID="ddlState" disabled="disabled" runat="server" CssClass="form-control form-control-lg js-example-placeholder-single" Onchange="ddlStateChange();">
                                                <asp:ListItem Selected="True" Value="-1">Select State</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-sm-6 form-group">
                                            <label class="required">Birth City</label>
                                            <asp:DropDownList ID="ddlCity" disabled="disabled" runat="server" CssClass="form-control form-control-lg js-example-placeholder-single" AutoPostBack="true">
                                        ...
                                        <div class="col-sm-12 form-group">
                                            <div class="tnc-desc" style="color: red; font-size: 1em;">*&nbsp;<strong>Please Do Not Refresh or close the Current Page..for a while as your Reports are in process.</strong></div>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <asp:Button ID="btnsave" runat="server" CssClass="kwm-btn-lg" Text="Automatic Save Chart" ValidationGroup="SaveData" />
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <asp:HiddenField ID="hfmatchwithid" runat="server" />
        ...
        <input type="hidden" runat="server" id="hdnCityID" />
        ...
        <input type="hidden" runat="server" id="hdncountrycode" />
                 <input type="hidden" runat="server" id="hdnCurrentDate" />
    </form>
</body>
</html>
