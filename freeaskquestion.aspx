<%@ Page Language="C#" AutoEventWireup="true" CodeFile="freeaskquestion.aspx.cs" Inherits="freeaskquestion" %>
...
<head runat="server">
    <title>Ask One Question | Astro Envision</title>
    <meta charset="utf-8" />
    ...
    <script type="text/javascript" src="javascript/freeaskquestion.js"></script>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="container-sec my-2">
                    <div class="content-center">
                        <div class="line">
                            <h1 id="heading_div">Online Free Astro Consultancy</h1>
                        </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-background_article">
                                <div class="fullarticle">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h2 style="text-align: center;">Ask One Question</h2>
                                            <p style="font-size: 1.2rem; font-weight: bold; color: blue;">In this Online Free Astro Consultancy, Astro Envision will provide you Free Online Predictions about your specific query.</p>
                                            <h1 style="text-align: center;"><a href="<%=ResolveUrl("~/my-answers.html") %>" rel="noopener noreferrer nofollow" title="Your Answers"><i class="fa fa-file" aria-hidden="true"></i>Your Answers</a></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="px-3 py-2" style="border: 1px solid #e0e0e0; border-radius: 15px;">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="reqQuestion" runat="server" ControlToValidate="txtQuestion" CssClass="validator" Display="Dynamic"
                                                ErrorMessage="Enter Question" SetFocusOnError="True" ValidationGroup="SaveData"></asp:RequiredFieldValidator>
                                        </div>
                                        ...
                                        <div class="col-sm-12 form-group">
                                            ...
                                            <div class="tnc-desc" style="color: red; font-size: 1em;">*&nbsp;<strong>Please Do Not Refresh or close the Current Page.</strong></div>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <asp:Button ID="btnsave" runat="server" CssClass="kwm-btn-lg" Text="Submit" ValidationGroup="SaveData" />
                                    </div>
                                </div>
                            </div>
                        </div>
