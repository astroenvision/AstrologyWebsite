...
public partial class freecompatibilitymatching : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            Ajax.Utility.RegisterTypeForAjax(typeof(freecompatibilitymatching));
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["flag"] != null)
                {
                    if (Request.QueryString["matchwith"] != null)
                    {
                        ...
                        ddlgender.SelectedValue = Request.QueryString["flag"].ToString().Trim();
                    ...
                    else
                    {
                        ...
                        if (Request.QueryString["flag"].Trim() == "M")
                        {
                            ...
                            submit.Text = "Enter the Birth Details of Girl >>";
                        }
                        if (Request.QueryString["flag"].Trim() == "F")
                        {
                            headingh1.InnerText = "Enter Your Birth Details as - Girl";
                            submit.Text = "Enter the Birth Details of Boy >>";
                        }
                    }
                }
                else
