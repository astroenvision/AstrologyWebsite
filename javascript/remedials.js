...
function bindddrop() {
    ...
    var res = remedials.fetchdata(maindrop);
       
    var ds = res.value;
    var edtn = $("subfilter");
    edtn.options.length = 1;
    edtn.options[0] = new Option("----Select Sub Remedies---", "0");
    
    if (ds != null && typeof (ds) == "object" && ds.Tables[0].Rows.length > 0) {
        for (var i = 0; i < ds.Tables[0].Rows.length; i++) {
            edtn.options[edtn.options.length] = new Option(ds.Tables[0].Rows[i].SUB_REMEDIAL, ds.Tables[0].Rows[i].SUB_REMEDIAL)
            edtn.options.length;
        }
    }
    return false;
...
function bindlagna() {
    ...
    var maindrop = document.getElementById('remedies').value;
    var res = remedials.fetchdata2(maindrop);

    var ds = res.value;
    var edtn = $("lagna");
    edtn.options.length = 1;
    edtn.options[0] = new Option("----Select Lagna---", "0");

    if (ds != null && typeof (ds) == "object" && ds.Tables[0].Rows.length > 0) {
        for (var i = 0; i < ds.Tables[0].Rows.length; i++) {
            edtn.options[edtn.options.length] = new Option(ds.Tables[0].Rows[i].KEY_STRING, ds.Tables[0].Rows[i].KEY_STRING)
            edtn.options.length;
        }
    }
    return false;
...
function bindremedies() {
    ...
    var maindrop = document.getElementById('subfilter').value;
    var res = remedials.fetchdata1(maindrop);

    var ds = res.value;
    var edtn = $("remedies");
    edtn.options.length = 1;
    edtn.options[0] = new Option("----Select Remedies---", "0");

    if (ds != null && typeof (ds) == "object" && ds.Tables[0].Rows.length > 0) {
        for (var i = 0; i < ds.Tables[0].Rows.length; i++) {
            edtn.options[edtn.options.length] = new Option(ds.Tables[0].Rows[i].SUB_SUB_REMEDIAL, ds.Tables[0].Rows[i].SUB_SUB_REMEDIAL)
            edtn.options.length;
        }
    }
    return false;
...
if(document.getElementById('lagna').selectedIndex=='0')
{
alert('Please select the Lagna');
return false;
}
    document.getElementById('hdsviewgrid2').innerHTML = "";
    document.getElementById('Divgrid2').style.display = "none";
  ...
  //remedials.showyogas(lagnarashi, degree, house, degreesecond, menuitemsvalus, rashie, retro);
  for_s();
...
{
alert('Please select the Main Filter');
return false;
}
    document.getElementById('hdsviewgrid2').innerHTML = "";
    document.getElementById('Divgrid2').style.display = "none";
...
function for_m() {
    ...
    if (astrologer == 'ASTROLOGY' || astrologer == 'astrology' || astrologer == 'hshoradm@horary.com') {
        var res = remedials.get_alldata_datam(combination, lagnarashi, mainfilerdrop, astrologer, callback_fillgrid);
        return false;
    }
    else
    {
        var res = remedials.get_alldata_datam(combination, lagnarashi, mainfilerdrop, astrologer, callback_fillgriduser);
    return false;
    }
}
...
function for_s() {
    ...
    var combination = document.getElementById('Hs').value;
    var lagnarashi = document.getElementById('Hlagnarashi').value;
    var mainfilerdrop = document.getElementById('remedies').value;
    var subfilterdrop = document.getElementById('lagna').value;
    var astrologer = document.getElementById('Hidden9').value;

    if (astrologer == 'ASTROLOGY' || astrologer == 'astrology' || astrologer == 'hshoradm@horary.com') {
        var res = remedials.get_alldata_data(combination, lagnarashi, mainfilerdrop, subfilterdrop, astrologer, callback_fillgrid);
        return false;
    }
    else
    {
        var res = remedials.get_alldata_data(combination, lagnarashi, mainfilerdrop, subfilterdrop, astrologer, callback_fillgriduser);
    return false;
    }
}
...
function callback_fillgrid(res) {
    ...
    document.getElementById('Divgrid1').style.display = "none";
       ...
       document.getElementById('hdsviewgrid').style.display = "block";
        ...
        if (document.getElementById("hdsviewgrid").innerHTML.indexOf("width:395px;display:block") <= 0) {
            aa = document.getElementById("hdsviewgrid").innerHTML.replace("</TBODY>", "")//</TABLE>","")
        }
        buf2 = "";
        buf2 += "<table  id='Divgrid1' runat='server' align='left' Width='399px' height='0px' style='border:1px;; solid #7DAAE3; cellpadding='0' cellspacing='0'>"//<tr>"
        buf2 += "<tr>"
        buf2 += "<td class='colum-td-heada'>" + "DESCRIPTION" + "</td>"
        buf2 += "<td class='colum-td-heada'>" + "DESCCLOB" + "</td>"
    ...
    document.getElementById('Divgrid2').style.display = "none";
        ...
        if (document.getElementById("hdsviewgrid2").innerHTML.indexOf("width:550px;display:block") <= 0) {
            aa = document.getElementById("hdsviewgrid2").innerHTML.replace("</TBODY>", "")//</TABLE>","")
        }
        buf2 = "";
        buf2 += "<table  id='Divgrid2' runat='server' align='left' Width='550px' height='0px' style='border:1px;; solid #7DAAE3; cellpadding='0' cellspacing='0'>"//<tr>"
        buf2 += "<tr>"
...
if (exec_data.Tables[0].Rows.length > 0) {
    ...
    document.getElementById('Divgrid1').style.display = "none";
        ...
        buf2 += "<td class='colum-td-head_new'>" + "DESCCLOB" + "</td>"
...
remedials.vargasvalue(vargas, callback_vargas);
return false;
}
