...
function BindNoOfQuestions()
{
 var n=document.getElementById('ddlnoofquestions').value;
 for (var i = 1; i <= 5; i++) {
         var questionno="question" + i;
          document.getElementById(questionno).value="";
           document.getElementById(questionno).style.visibility = 'hidden';
           document.getElementById(questionno).style.display = 'none';
        }
  for (var i = 1; i <= n; i++) {
         var questionno="question" + i;
           document.getElementById(questionno).style.visibility = 'visible';
           document.getElementById(questionno).style.display = 'table-row';
        }
    
 return false;
}

function BindGroupsNames()
{
    if (document.getElementById('DropDownList2').value.toUpperCase()=="HORARY") {
      document.getElementById('cat').value="AEHC";
      document.getElementById('question1').style.visibility = 'visible';  //visible
      document.getElementById('question2').style.visibility = 'visible';  //hidden
    ...
    if (document.getElementById('DropDownList2').value.toUpperCase()=="NATAL") {
      document.getElementById('cat').value="AENC";
      document.getElementById('question1').style.visibility = 'visible';  //visible
      document.getElementById('question2').style.visibility = 'visible';  //hidden
      ...
      document.getElementById('question3').style.display = 'table-row';
      document.getElementById('question4').style.display = 'table-row';
      document.getElementById('question5').style.display = 'table-row';
    }
    return false;
}
...
//    }
//    else {
//        res = addtoconsult.searchuser(astrologer, document.getElementById('DropDownList2').value);
//        callback_drp1(res);
//        return false;
//    }
//    return false;
...
//    }
//    else {
//        res = addtoconsult.searchuser(astrologer, document.getElementById('cat_grp').options[document.getElementById('cat_grp').selectedIndex].text);
//        callback_drp1(res);
//    }
//}
...
function callback_drp1(res) {
    var ds = res.value;
    var edtn = document.getElementById('cat').value;
...
function cl_dtls() 
{
    ...
    mno = trim(document.getElementById('mn').value);
    ...
    document.getElementById('hdngroup_u').value = document.getElementById('DropDownList2').options[document.getElementById('DropDownList2').selectedIndex].text;
    ...
    var isdres = addtoconsult.istfind(ist3, tob, dateob);
    var ds = isdres.value;
...
function update_cl_dtls() {
    ...
    if (document.getElementById('hdnuser').value != "" || document.getElementById('hdnuser').value != null) {
        astrologer = document.getElementById('hdnuser').value
        astro_dtls = document.getElementById('username').value
        res1 = addtoconsult.update_client(astro_dtls, name, profession, age, sex, astrologer, email, cat_id, mno, cat_grp);
   ...
   if (event.keyCode == 38 || event.keyCode == 40) {
    ...
    if (document.activeElement.id == 'ddlstat') {
        ...
        if (filter == "0") {
            ...
            var res = addtoconsult.state(filter, drop_down, exec_gridcall);
            return false;
        }
    }
    return false;
...
function districtt(event) {
    ...
    if (document.activeElement.id == 'district') {
        ...
        if (filter == "0") {
            ...
            var res = addtoconsult.districtt(drop_down, state,filter, exec_gridcall);
            return false;
        }
    }
    return false;
    ...
    if (document.activeElement.id == 'city') {
       var city = document.getElementById('city').value
        if (filter == "0") {
            ...
            var res = addtoconsult.citys(con, state, district, city, exec_gridcall);
            return false;
        }
    }
    return false;
...
function insert_data(id) {
    ...
    if (id == 'ddlCity') {
        ...
        var res = addtoconsult.latlng(con, state, district, city);
        var ds=res.value;
                      ...
                      var res = addtoconsult.timezone(tzid, dob1);
                        var ds1=res.value;
    ...
    {                  document.getElementById('tz').value = stz1[0];
                    ...
                    var res = addtoconsult.getsunsetsunrise(document.getElementById('lat').value, document.getElementById('lng').value, document.getElementById('username').value, d1[1]+'/'+d1[0]+'/'+d1[2] + ' ' + '1:00:42 AM')

                    var sssr = res.value;
                    var srss1 = sssr.split('\r\n')
                    var sr = srss1[0];
                    var ss = srss1[1];
                    var res = addtoconsult.getsunsetsunrisea(sr, document.getElementById('hdntz').value, ss,d1[1]+'/'+d1[0]+'/'+d1[2] + ' ' + '1:00:42 AM')
                    ...
                    var res = addtoconsult.getsunsetsunrise1(document.getElementById('lat').value, document.getElementById('lng').value, document.getElementById('username').value, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
                    ...
                    var res = addtoconsult.getsunsetsunriseanext(sr, document.getElementById('hdntz').value, ss,d1[1]+'/'+d1[0]+'/'+d1[2] + ' ' + '1:00:42 AM')
                    var actsrss = res.value;
                    var sunrisenextday = actsrss.Tables[0].Rows[0].IDOB;
                    hoursob = trim(document.getElementById('hob').value);
                    document.getElementById('hdsunrisenext').value=sunrisenextday;

                    var res = addtoconsult.getsunsetsunrise2(document.getElementById('lat').value, document.getElementById('lng').value, document.getElementById('username').value, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
                    var ssopd = res.value;
                    var ssopd1 = ssopd.split('\r\n')
                    var sr = ssopd1[0];
                    var ss = ssopd1[1];
                    
                    var res = addtoconsult.getsunsetsunriseapre(sr, document.getElementById('hdntz').value, ss,d1[1]+'/'+d1[0]+'/'+d1[2] + ' ' + '1:00:42 AM')
                    var actsrss = res.value;
                    ...
                    resprobable = addtoconsult.getdinrat(sunset, sunrise, sunrisenextday, tob, user)
...
function searchclientid()
  ...
  var exec = addtoconsult.searchclientid(clientname, astroname, astid1, document.getElementById('hdngroup').value, document.getElementById('hdngroup_u').value,'');
  var ds=exec.value;
...
function grid() {
 ...
 function makebc() {
      ...
      var exea = addtoconsult.Cal_Ascendant_Gulika(hdnmocval,dobval,dateob,monthob,yearob,timeob,hourob,hdnimob,longitudeval,latitudeval,sunsetpre,sunrise,sunset,sunrisenext,tzval);
      ...
      var exec = addtoconsult.makebirthchart(dob, tzon, tzon, parseFloat(ascnd_val),parseFloat(gulika_val));
...
function bindrashi(res) {
    ...
    var vishu = "";
    var res1 = addtoconsult.bindrashi(vishu);
    var ds = res1.value;
...
function bindhouse(res) {
    if (res == "house_0") {
        ...
        var vishu = "";
        var res1 = addtoconsult.bindhouse(vishu);
        var ds = res1.value;
        //var drop_id=
        document.getElementById(res).options.length =0;
...
function binddegree(res) {
    ...
    var vishu = "";
    var res1 = addtoconsult.binddegree(vishu);
    var ds = res1.value;
...
function bindminutes(res) {
    ...
    var vishu = "";
    var res1 = addtoconsult.bindminutes(vishu);
    var ds = res1.value;
...
function bindseconds(res) {
    ...
    var vishu = "";
    var res1 = addtoconsult.bindseconds(vishu);
    var ds = res1.value;
...
function bindretrograde(res) {
    ...
    var vishu = "";
    var res1 = addtoconsult.bindretrograde(vishu);
    var ds = res1.value;
...
function bindconstelation(res) {
    ...
    var vishu = "";
    var res1 = addtoconsult.bindconstelation(vishu);
    var ds = res1.value;
...
function callback_drp1(res) {
     var ds = res.value;
     var edtn = document.getElementById('groupdrop_final').value;
     edtn.options.length = 1;
     edtn.options[0] = new Option("General", "0");
     if (ds != null && typeof (ds) == "object" && ds.Tables[1].Rows.length > 0) {
         for (var i = 0; i < ds.Tables[1].Rows.length; i++) {
...
function vargas()
 {
    ...
    addtoconsult.vargasvalue(vargas,callback_vargas);
    return false;
}
...
var sunrisenext = document.getElementById('hdsunrisenext').value;
 ...
 var dsdob = addtoconsult.GetDayOfBirth(document.getElementById('hdndob').value);
 ...
 var dsval = addtoconsult.GetRashi_Constellation(document.getElementById('CVal').value);
...
var dsdnd = addtoconsult.GetDayNightDuration(sunrise,sunset,sunrisenext);
...
var nightduration_val= document.getElementById('hdnnightduration').value;
 ...
 var dsbdval = addtoconsult.GetBalance_Dasha(document.getElementById('BalanceDashaVal').value);
...
var astid=document.getElementById('astid').innerHTML;
 ...
 var pwdval=document.getElementById('txtpwd').value;
  ...
  if (client == "" || clientid == "") {
   ...
   var res = addtoconsult.chechduplicacy(astid, astname, client, clientid, document.getElementById("hdngroup").value, document.getElementById("hdngroup_u").value);
   var ds=res.value;
   if(ds.Tables[0].Rows.length > 0)
   {
       ...
       document.getElementById('clinetnamediv').style.display = 'block';
       var astrologer = astid
       res = addtoconsult.searchuser(astrologer, document.getElementById('hdngroup_u').value);
       callback_drp1(res)
       return false;
   }
   else
   {
         ...
         var matchwithval = "0";
         var UserType = "3";  //This ID used For Consult User
       ...
       //Code end for lagna/moon//venus chart
         ...
         if(document.getElementById('txtques1').value=="")
         {
             document.getElementById('loadingimg').style.display = 'none';
              alert("Please Enter at lease one Question!");
              return false;   
         }
        ...
        //window.open('astro_client_details.aspx?clientemailid=' + clientid + '');
         ...
         if(document.getElementById('txtques3').value!="")
         {
            questionval=document.getElementById('txtques3').value;
            ds = addtoconsult.AddToConsult(gallmaxid, cartid, document.getElementById('hdnclientemailid').value, categoryid, categotyname, questionid, questionval, totalques, "", TotalAmount, usertype, groupid);
            var dsval = ds.value;
            if (dsval != null && dsval.Tables[0].Rows.length > 0) 
            {
         ...
         if(document.getElementById('txtques4').value!="")
         {
            questionval=document.getElementById('txtques4').value;
            ds = addtoconsult.AddToConsult(gallmaxid, cartid, document.getElementById('hdnclientemailid').value, categoryid, categotyname, questionid, questionval, totalques, "", TotalAmount, usertype, groupid);
            var dsval = ds.value;
            if (dsval != null && dsval.Tables[0].Rows.length > 0) 
            {
         ...
         if(document.getElementById('txtques5').value!="")
         {
            questionval=document.getElementById('txtques5').value;
            ds = addtoconsult.AddToConsult(gallmaxid, cartid, document.getElementById('hdnclientemailid').value, categoryid, categotyname, questionid, questionval, totalques, "", TotalAmount, usertype, groupid);
            var dsval = ds.value;
            if (dsval != null && dsval.Tables[0].Rows.length > 0) 
            {
        ...
        var btlmodeofpaymentval = document.getElementsByName('btlmodeofpayment');
        for (var i = 0; i < btlmodeofpaymentval.length; i++)
        {
            if (btlmodeofpaymentval[i].checked)
            {
                var ClientEmailID = document.getElementById('hdnRegUserEmailId').value;
                var ClientID = document.getElementById('hdnRegUserId').value;
                 btlmodeofpaymentval=btlmodeofpaymentval[i].value;
                 var dsbilling = addtoconsult.AddToConsultBilling(0, cartid, TotalAmount, groupid, "F", btlmodeofpaymentval, "SAVEBILLING", ClientEmailID, ClientID);
                 var dsbillingval = dsbilling.value;
                 if (dsbillingval != null && dsbillingval.Tables[0].Rows.length > 0) 
                 {
                 }
            }
        }
        
        //alert(document.getElementById("hdncountrycode").value);
        // alert(document.getElementById("hdncartid").value);
        //  alert(document.getElementById("TotalAmounts").value);
        //   alert(document.getElementById("hdngroup_u").value);
       //    alert(document.getElementById("txtmail").value);

       if(document.getElementById("hdncountrycode").value.toUpperCase()=="IN")
       {
           var ClientRegisteredID = document.getElementById('hdnRegUserEmailId').value;
          //window.open('auto_ccavenue.aspx?member='+ document.getElementById('hdncartid').value + '&amount=' + document.getElementById('TotalAmounts').value + '&clientemailid=' + clientid + '&group=' + document.getElementById('hdngroup_u').value.toUpperCase() + '','_self');
           window.open('auto_razorpay.aspx?member=' + document.getElementById('hdncartid').value + '&amount=' + document.getElementById('TotalAmounts').value + '&clientemailid=' + ClientRegisteredID + '&group=' + document.getElementById("hdngroup_u").value.toUpperCase() + '&PaymentFor=CONSULT_ASTROLOGER', "_self");
       }
       else
       {
       ...
       document.getElementById('lng').value="";
       document.getElementById('tz').value="";
       document.getElementById('txtques1').value="";
       document.getElementById('txtques2').value="";
       document.getElementById('txtques3').value="";
       document.getElementById('txtques4').value="";
       document.getElementById('txtques5').value="";
...
////        }
  ...
  function GetAllHoraryQuestion(chartdetails,lagnarashi_final,astid,clientid) 
  {
       ...
       for (var i = 1; i < rowCount; i++) 
       {
         ...
         res = addtoconsult.get_allhorarynatal_question(cartid,"","HORARY","","GETALLHORARYQUESTIONS");
         var dsh = res.value;
         if (dsh != null && dsh.Tables[0].Rows.length > 0) 
         {
              for (var j = 0; j < dsh.Tables[0].Rows.length; j++) 
              {
               ...
               var resr = addtoconsult.get_horaryquestion_ans(chartdetails, lagnarashi_final, mainfilerdrop, subfilterdrop,astid,clientid);
               //var res = addtoconsult.get_horaryquestion_ans(combination, lagnarashi_final, mainfilerdrop, subfilterdrop,callback_fillgrid);
                ...
                if (exec_data.Tables[0].Rows.length > 0)
                {
                    for (var k = 0; k< exec_data.Tables[0].Rows.length; k++) 
                    {
                      ...
                      addtoconsult.update_horaryquestion_ans(Autoid,Questionid,Answer,"");
                    }
                }
              }
         }
