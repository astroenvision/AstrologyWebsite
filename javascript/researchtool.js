...
//document.getElementById('clientid').innerHTML =document.getElementById('Hclmail').value;
 ...
 //document.getElementById('grcl').style.display = 'none';
grid();
accountuser(); 
 ...
 function search1()
     ...
     var planet1 = planet.slice(0, -1);
        ...
        if (document.getElementById('own').checked == true) {
            ...
            rashi = document.getElementById('own').value + ',' + rashi;
          }
          ...
          if(document.getElementById('fri').checked == true){
              ...
              rashi = document.getElementById('fri').value + ',' + rashi;
          }
          
          if(document.getElementById('exal').checked == true){

              rashi = document.getElementById('exal').value + ',' + rashi;
          }
          
          
           if(document.getElementById('enim').checked == true){

               rashi = document.getElementById('enim').value + ',' + rashi;
          }
         
         if(document.getElementById('deb').checked == true){

             rashi = document.getElementById('deb').value + ',' + rashi;
          }
          
         if(document.getElementById('neut').checked == true){

             rashi = document.getElementById('neut').value + ',' + rashi;
          }
          if(document.getElementById('mootri').checked == true){

              rashi = document.getElementById('mootri').value + ',' + rashi;
          } 
                 var rashi1=rashi.slice(0,-1);
                  
                  if(find_flag==1)
                    {
                 if(rashi1=="" || document.getElementById('clgroup').value=="0" || sv=="")
                 {
                 ...
                 {
                 if(rashi1=="" || document.getElementById('clgroup').value=="0" )
                 {
                 alert('Pls select Group name or Rashi or Varga');
                 return false;
                 }
         ...
         var query = p + ' are in ' + r + ' Awastha in ' + ch + ' in ' + document.getElementById('clgroup').options[document.getElementById('clgroup').selectedIndex].text + ' Group '
         document.getElementById('qry').innerHTML = query;
         sv = sv.slice(0, -1);
         var res = ResearchTool.search(planet1, rashi1, astrolrger, document.getElementById('clgroup').options[document.getElementById('clgroup').selectedIndex].text, flag, client, sv, svn);
      var ds=res.value;
      var inc=1;
      var dec=0;
...
document.getElementById('d60_'+0).value=""
 ...
 var varga = '';
 var rashi2= ''
// var res = ResearchTool.clientinfoall();
// var ds = res.value;
...
{  document.getElementById('clinetnamediv').style.display = 'block';
    ...
    var res = ResearchTool.clientinfo(varga,astrologer);
    var ds=res.value;
       // document.getElementById('pl').innerHTML=planet.slice(0,-1);
...
// alert('you are admin');
 ...
 return false;
     ...
     var grp_cat = 'Natal';
     res = ResearchTool.searchuser(astrologer, grp_cat);
...
function grcli() {
    ...
    if (document.getElementById('clgroup').options[document.getElementById('clgroup').selectedIndex].text == 'General') {
        ...
        res = ResearchTool.searchclient(astrologer, document.getElementById('clgroup').options[document.getElementById('clgroup').selectedIndex].text,'Natal');
        callback_drp2(res);
    }
     else{
