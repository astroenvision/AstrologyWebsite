...
function bindrashi(res) {
    ...
    var vishu = "";
    var res1 = ClientReport.bindrashi(vishu);
    var ds = res1.value;
...
function bindhouse(res) {
    if (res == "house_0") {
        ...
        var vishu = "";
        var res1 = ClientReport.bindhouse(vishu);
        var ds = res1.value;
        //var drop_id=
        document.getElementById(res).options.length = 0;
...
function binddegree(res) {
    ...
    var vishu = "";
    var res1 = ClientReport.binddegree(vishu);
    var ds = res1.value;
...
function bindminutes(res) {
    ...
    var vishu = "";
    var res1 = ClientReport.bindminutes(vishu);
    var ds = res1.value;
...
function bindseconds(res) {
    ...
    var vishu = "";
    var res1 = ClientReport.bindseconds(vishu);
    var ds = res1.value;
...
function bindretrograde(res) {
    ...
    var vishu = "";
    var res1 = ClientReport.bindretrograde(vishu);
    var ds = res1.value;
...
function bindconstelation(res) {
    ...
    var vishu = "";
    var res1 = ClientReport.bindconstelation(vishu);
    var ds = res1.value;
...
function searchclientid() {
    ...
    var exec = ClientReport.searchclientid(clientname, astroname, astid1, document.getElementById('hdngroup').value, document.getElementById('hdngroup_u').value, document.getElementById('hdnuserid').value);
    var ds = exec.value;
...
function vargasotherchart() {
    ...
    ClientReport.vargasvalue(vargasfinal, callback_vargas);
