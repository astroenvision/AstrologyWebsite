...
astro_calculation.vargasvalue(vargas,callback_vargas);
return false;
}
...
if (exec_data.Tables[0].Rows.length > 0)
 {
    ...
    document.getElementById('Divgrid1').style.display = "none";
        ...
        if (document.getElementById("hdsviewgrid").innerHTML.indexOf("width:465px;display:block") <= 0) 
        {
            aa = document.getElementById("hdsviewgrid").innerHTML.replace("</TBODY>", "")//</TABLE>","")
        }
        buf2 = "";
        buf2 += "<table  id='Divgrid1' runat='server' align='left' Width='465px' height='0px' style='border:1px;; solid #7DAAE3; cellpadding='0' cellspacing='0'>"//<tr>"
        buf2 += "<tr>"

if(document.getElementById('mainfilter').value=='Paap Samya')
                {
                  buf2 += "<td class='colum-td-head_new'>" + "Paap Samya" + "</td>"
                }
                else if (document.getElementById('mainfilter').value != 'Pushkar Navamsha' && document.getElementById('mainfilter').value != 'Manglik Dosha' && document.getElementById('mainfilter').value != '22nd Drekkana' && document.getElementById('mainfilter').value != '64th Navamsha')
                {

                buf2 += "<td class='colum-td-head_new'>" + "Predictive"+ "</td>"
                buf2 += "<td class='colum-td-head_new'>" + "Rashi Result" + "</td>"
                buf2 += "<td class='colum-td-head_new'>" + "Navamsha Result" + "</td>"

            }
            else if (document.getElementById('mainfilter').value == '22nd Drekkana' || document.getElementById('mainfilter').value == '64th Navamsha') {
            if (document.getElementById('mainfilter').value == '22nd Drekkana') 
            {
                document.getElementById('qry').innerHTML = document.getElementById('hdn22nd').value;
                buf2 += "<td class='colum-td-head_new'>" + "Planet" + "</td>"
                buf2 += "<td class='colum-td-head_new'>" + "22nd Dreshkon Rashi" + "</td>"
                buf2 += "<td class='colum-td-head_new'>" + "22nd Dreshkon Lord" + "</td>"
            }
            if (document.getElementById('mainfilter').value == '64th Navamsha') {
                document.getElementById('qry').innerHTML = document.getElementById('hdn64th').value;;
                buf2 += "<td class='colum-td-head_new'>" + "Planet" + "</td>"
                buf2 += "<td class='colum-td-head_new'>" + "64th Navamsha Rashi" + "</td>"
                buf2 += "<td class='colum-td-head_new'>" + "64th Navamsha Lord" + "</td>"
            } 
...
if(document.getElementById('mainfilter').value=='kshetra sphuta(Female)')
 { 
                if(dsgrid.Tables[0].Rows[i]['DESCCLOB']=='EVEN' && dsgrid.Tables[0].Rows[i]['KEY_STRING']=='EVEN')
                {
                    buf2 += "<td class='colum-td-newhc'>"
                buf2 += "<font class='f' >"+ 'It is Positive Kshetra Sphuta for this Chart and there is no Problem on part of this Female chart for Progeny' + "</font>"
                buf2 += "<input type='hidden' id=maj_" + i + "  value =" + 'It is Positive Kshetra Sphuta for this Chart and there is no Problem on part of this Female chart for Progeny' + "> "
                buf2 += "</td>"
                
                }

if(dsgrid.Tables[0].Rows[i]['DESCCLOB']=='EVEN' && dsgrid.Tables[0].Rows[i]['KEY_STRING']=='ODD')
                {
    buf2 += "<td class='colum-td-newhc'>"
                buf2 += "<font class='f' >"+ 'It is a Negative Kshetra Sphuta for this Chart and there are greater probem on part of this Female chart for Progeny. Requies Major efforts to turn it into positive results.' + "</font>"
                buf2 += "<input type='hidden' id=maj_" + i + "  value =" + 'It is a Negative Kshetra Sphuta for this Chart and there are greater probem on part of this Female chart for Progeny. Requies Major efforts to turn it into positive results.' + "> "
                buf2 += "</td>"
                
                }
                
if(dsgrid.Tables[0].Rows[i]['DESCCLOB']=='ODD' && dsgrid.Tables[0].Rows[i]['KEY_STRING']=='EVEN')
                {
    buf2 += "<td class='colum-td-newhc'>"
                buf2 += "<font class='f' >"+ 'It is a Curable Kshetra Sphuta for this Chart and there are good chances to get this cured for the Problems on part of this Female chart for Progeny. Requies medical intervation for turning into positive' + "</font>"
                buf2 += "<input type='hidden' id=maj_" + i + "  value =" + 'It is a Curable Kshetra Sphuta for this Chart and there are good chances to get this cured for the Problems on part of this Female chart for Progeny. Requies medical intervation for turning into positive' + "> "
                buf2 += "</td>"
                
                }
                           
if(dsgrid.Tables[0].Rows[i]['DESCCLOB']=='ODD' && dsgrid.Tables[0].Rows[i]['KEY_STRING']=='ODD')
                {
    buf2 += "<td class='colum-td-newhc'>"
                buf2 += "<font class='f' >"+ 'It is a Negative & doubtful Kshetra Sphuta for this Chart and there are hardly any possibilites to get this cured for the Problems on part of this Female chart for Progeny.' + "</font>"
                buf2 += "<input type='hidden' id=maj_" + i + "  value =" + 'It is a Negative & doubtful Kshetra Sphuta for this Chart and there are hardly any possibilites to get this cured for the Problems on part of this Female chart for Progeny.' + "> "
                buf2 += "</td>"
...
if(document.getElementById('mainfilter').value=='Beeja sphuta(Male)')
 { 
                if(dsgrid.Tables[0].Rows[i]['DESCCLOB']=='EVEN' && dsgrid.Tables[0].Rows[i]['KEY_STRING']=='EVEN')
                {
                    buf2 += "<td class='colum-td-newhc'>"
                buf2 += "<font class='f' >"+ 'It is a Negative & Doubtful Beej Sphuta for this Chart and there are hardly any possibilites to get this cured for the Problems on part of this Male chart for Progeny.' + "</font>"
                buf2 += "<input type='hidden' id=maj_" + i + "  value =" + 'It is a Negative & Doubtful Beej Sphuta for this Chart and there are hardly any possibilites to get this cured for the Problems on part of this Male chart for Progeny.' + "> "
                buf2 += "</td>"
...
if(dsgrid.Tables[0].Rows[i]['DESCCLOB']=='EVEN' && dsgrid.Tables[0].Rows[i]['KEY_STRING']=='ODD')
                {
    buf2 += "<td class='colum-td-newhc'>"
                buf2 += "<font class='f' >"+ 'It is a Curable Beej Sphuta for this Chart and there are good chances to get this cured for the Problems on part of this Male chart for Progeny. Requies medical intervation for turning into positive' + "</font>"
                buf2 += "<input type='hidden' id=maj_" + i + "  value =" + 'It is a Curable Beej Sphuta for this Chart and there are good chances to get this cured for the Problems on part of this Male chart for Progeny. Requies medical intervation for turning into positive' + "> "
                buf2 += "</td>"
...
if(dsgrid.Tables[0].Rows[i]['DESCCLOB']=='ODD' && dsgrid.Tables[0].Rows[i]['KEY_STRING']=='EVEN')
                {
    buf2 += "<td class='colum-td-newhc'>"
                buf2 += "<font class='f' >"+ 'It is a Negative Beej Sphuta for this Chart and there are greater probem on part of this Male chart for Progeny. Requies Major efforts to turn it into positive results.' + "</font>"
                buf2 += "<input type='hidden' id=maj_" + i + "  value =" + 'It is a Negative Beej Sphuta for this Chart and there are greater probem on part of this Male chart for Progeny. Requies Major efforts to turn it into positive results.' + "> "
                buf2 += "</td>"
...
if(dsgrid.Tables[0].Rows[i]['DESCCLOB']=='ODD' && dsgrid.Tables[0].Rows[i]['KEY_STRING']=='ODD')
                {
    buf2 += "<td class='colum-td-newhc'>"
                buf2 += "<font class='f' >"+ 'It is Positive Beej Sphuta for this Chart and there is no Problem on part of this Male chart for Progeny' + "</font>"
                buf2 += "<input type='hidden' id=maj_" + i + "  value =" + 'It is Positive Beej Sphuta for this Chart and there is no Problem on part of this Male chart for Progeny' + "> "
                buf2 += "</td>"
            ...
            if (document.getElementById('mainfilter').value == '64th Navamsha') {
                buf2 += "<td class='colum-td-newhc'>"
                buf2 += "<font class='f' >" + (dsgrid.Tables[0].Rows[i]['PLANET']) + "</font>"
                buf2 += "<input type='hidden' id=pla_" + i + "  value =" + (dsgrid.Tables[0].Rows[i]['PLANET']) + "> "
                buf2 += "</td>"

                buf2 += "<td class='colum-td-newhc'>"
                buf2 += "<font class='f' >" + (dsgrid.Tables[0].Rows[i]['DESCRIPTION']) + "</font>"
                buf2 += "<input type='hidden' id=des_" + i + "  value =" + (dsgrid.Tables[0].Rows[i]['DESCRIPTION']) + "> "
                buf2 += "</td>"
                ...
                buf2 += "<input type='hidden' id=key_" + i + "  value =" + (dsgrid.Tables[0].Rows[i]['KEY_STRING']) + "> "
                buf2 += "</td>"
            ...
            if (document.getElementById('mainfilter').value != 'Paap Samya' && document.getElementById('mainfilter').value != '22nd Drekkana' && document.getElementById('mainfilter').value != '64th Navamsha')
{
                buf2 += "<td class='colum-td-newhc'>"
...
{
 if(dsgrid.Tables[0].Rows[i]['DESCCLOB']=='TOTAL')
{   
     buf2 += "<td class='colum-td-newhc'>"
                buf2 += "<font class='f' >" + (dsgrid.Tables[0].Rows[i]['KEY_STRING']) + "</font>"
                buf2 += "<input type='hidden' id=key_" + i + "  value =" + (dsgrid.Tables[0].Rows[i]['KEY_STRING']) + "> "
...
function callback_fillgridastro(res)
 {
var exec_data = res.value;
if (exec_data.Tables[0].Rows.length > 0)
 {
    ...
    document.getElementById('Divgrid1').style.display = "none";
        ...
        if (document.getElementById("hdsviewgrid").innerHTML.indexOf("width:550px;display:block") <= 0) 
        {
            aa = document.getElementById("hdsviewgrid").innerHTML.replace("</TBODY>", "")//</TABLE>","")
        }
        buf2 = "";
        buf2 += "<table  id='Divgrid1' runat='server' align='left' Width='550px' height='0px' style='border:1px;; solid #7DAAE3; cellpadding='0' cellspacing='0'>"//<tr>"
        buf2 += "<tr>"
if(document.getElementById('mainfilter').value=='Paap Samya')
                {
                buf2 += "<td class='colum-td-head_new'>" + "Planet" + "</td>"
                buf2 += "<td class='colum-td-head_new'>" + "Paap Samya Lagna" + "</td>"
                buf2 += "<td class='colum-td-head_new'>" + "Paap Samya Moon" + "</td>"
                buf2 += "<td class='colum-td-head_new'>" + "Paap Samya Venus" + "</td>"
                }

                else if (document.getElementById('mainfilter').value != 'Pushkar Navamsha' && document.getElementById('mainfilter').value != 'Manglik Dosha' && document.getElementById('mainfilter').value != '22nd Drekkana' && document.getElementById('mainfilter').value != '64th Navamsha')
                {
                //buf2 += "<td class='colum-td-head_new'>" + "Logic" + "</td>"
                buf2 += "<td class='colum-td-head_new'>" + "Predictive"+ "</td>"
                buf2 += "<td class='colum-td-head_new'>" + "Rashi Result" + "</td>"
                buf2 += "<td class='colum-td-head_new'>" + "Navamsha Result" + "</td>"
        ...
        if (dsgrid.Tables[0].Rows.length > 0)
         {
            ...
            for (i = 0; i < dsgrid.Tables[0].Rows.length; ++i) 
            {
                ...
                buf2 += "<tr>"
                if (document.getElementById('mainfilter').value != 'Paap Samya' && document.getElementById('mainfilter').value != 'kshetra sphuta(Female)' && document.getElementById('mainfilter').value != 'Beeja sphuta(Male)' && document.getElementById('mainfilter').value != '22nd Drekkana' && document.getElementById('mainfilter').value != '64th Navamsha')
{
                buf2 += "<td class='colum-td-newhc'>"
                buf2 += "<font class='f' >" + (dsgrid.Tables[0].Rows[i]['DESCRIPTION']) + "</font>"
                buf2 += "<input type='hidden' id=descr_" + i + "  value =" + (dsgrid.Tables[0].Rows[i]['DESCRIPTION']) + "> "
                buf2 += "</td>"
}
...
else
{
    if (document.getElementById('mainfilter').value == 'Paap Samya') {
        ...
        buf2 += "<td class='colum-td-newhc'>"
        buf2 += "<font class='f' >" + (dsgrid.Tables[0].Rows[i]['PLANET']) + "</font>"
        buf2 += "<input type='hidden' id=key_" + i + "  value =" + (dsgrid.Tables[0].Rows[i]['PLANET']) + "> "
        buf2 += "</td>"

        buf2 += "<td class='colum-td-newhc'>"
        buf2 += "<font class='f' >" + (dsgrid.Tables[0].Rows[i]['CHART_NO']) + "</font>"
        buf2 += "<input type='hidden' id=key_" + i + "  value =" + (dsgrid.Tables[0].Rows[i]['CHART_NO']) + "> "
        buf2 += "</td>"
    }
                }
...
//                buf2 += "</td>"
              ...
              buf2 += "</td>"
                ...
                buf2 += "<td  class='colum-td-new1' >"
               buf2 += "<font width='90px'>" +(vds.Tables[0].Rows[i]['MOON_HOUSE']) + "</font>"
               buf2 +="<input type='hidden' id=moonhouse_" + i + "  value =" + (vds.Tables[0].Rows[i]['MOON_HOUSE'])+">"
              buf2 += "</td>"
                   buf2 += "<td  class='colum-td-new1' >"
               buf2 += "<font width='90px'>" +(vds.Tables[0].Rows[i]['MOON_RASHI']) + "</font>"
               buf2 +="<input type='hidden' id=moonrashi_" + i + "  value =" + (vds.Tables[0].Rows[i]['MOON_RASHI'])+">"
              buf2 += "</td>"
              
                buf2 += "<td  class='colum-td-new1' >"
               buf2 += "<font width='90px'>" +(vds.Tables[0].Rows[i]['VENUS_HOUSE']) + "</font>"
               buf2 +="<input type='hidden' id=venushouse_" + i + "  value =" + (vds.Tables[0].Rows[i]['VENUS_HOUSE'])+">"
              buf2 += "</td>"
                   buf2 += "<td  class='colum-td-new1' >"
               buf2 += "<font width='90px'>" +(vds.Tables[0].Rows[i]['VENUS_RASHI']) + "</font>"
               buf2 +="<input type='hidden' id=venusrashi_" + i + "  value =" + (vds.Tables[0].Rows[i]['VENUS_RASHI'])+">"
              buf2 += "</td>"
...
var main=document.getElementById('mainfilter').value;
if(document.getElementById('hdnuser').value=='hshoradm@horary.com')
{
astro_calculation.pn(main,document.getElementById('Hs').value,document.getElementById('Hm').value,document.getElementById('Hv').value,document.getElementById('hdnuser').value,callback_fillgridastro);
}
else
{
astro_calculation.pn(main,document.getElementById('Hs').value,document.getElementById('Hm').value,document.getElementById('Hv').value,document.getElementById('hdnuser').value,callback_fillgriduser);
}
return false;
}