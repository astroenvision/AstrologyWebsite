...
function group_bind() {
    ...
    if (astrologer == 'astrology' || astrologer == 'ASTROLOGY' || astrologer == "") {
        ...
        res = most_important_planet.searchuser(astrologer, document.getElementById('DropDownList2').value);
...
function cl_dtls() {
    ...
    //Deepak Nirwal Commented Following Mobile Validation Code On 13-08-2020 Start Here
    //if (document.getElementById('txtModileNo').value == "") {
    //    //alert("Please enter Modile No.");
    //    document.form1.txtModileNo.focus();
    //    return false;
    //}
    //Deepak Nirwal Commented Following Mobile Validation Code On 13-08-2020 End Here
    ...
    var isdres = most_important_planet.istfind(ist3, tob, dateob);
    var ds = isdres.value;
...
function SavePaymentDetails(ClientID ,ClientEmailID)
{
    try
    {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: "{ 'Flag': '" + "INSERT_PAYMENT_IN_TEMP" + "', 'CartId': '" + document.getElementById("hdncartid").value + "',  'RegUserID': '" + document.getElementById("hdnUserID").value + "', 'RegEmailId': '" + document.getElementById("hdnUserEmailID").value + "' , 'PayableAmount': '" + document.getElementById("hdnPayableAmount").value + "', 'Discount': '" + document.getElementById("hdnDiscount").value + "' , 'DiscountAmount': '" + document.getElementById("hdnDiscountAmount").value + "'  , 'ActualAmount': '" + document.getElementById("hdnActualAmount").value + "'   , 'AmountType': '" + "INR" + "'  , 'AstrologerID': '" + "0" + "'  , 'Name': '" + "" + "' , 'LangType': '" + "" + "' , 'ConsultationType': '" + "" + "' , 'Question1': '" + "" + "' , 'Question2': '" + "" + "' , 'NoOfMin': '" + "" + "', 'Question3': '" + "" + "' , 'Question4': '" + "" + "' ,'Question5': '" + "" + "' ,'PayFor': '" + document.getElementById("hdnPaymentFor").value + "' ,'ClientID': '" + ClientID + "'  ,'ClientEmailID': '" + ClientEmailID + "' }",
...
function update_cl_dtls() {
    ...
    if (document.getElementById('hdnuser').value != "" || document.getElementById('hdnuser').value != null) {
        astrologer = document.getElementById('hdnuser').value
        astro_dtls = document.getElementById('username').value
        res1 = most_important_planet.update_client(astro_dtls, name, profession, age, sex, astrologer, email, cat_id, mno, cat_grp);
...
function state(event) {
    ...
    if (document.activeElement.id == 'ddlstat') {
        ...
        if (filter == "0") {
            ...
            var res = most_important_planet.state(filter, drop_down, exec_gridcall);
            return false;
        }
    }
    return false;
...
function districtt(event) {
    ...
    if (document.activeElement.id == 'district') {
        ...
        if (filter == "0") {
            ...
            var res = most_important_planet.districtt(drop_down, state, filter, exec_gridcall);
            return false;
        }
    }
    return false;
...
function openroot(event) {
    ...
    if (document.activeElement.id == 'city') {
        ...
        if (filter == "0") {
            ...
            var res = most_important_planet.citys(con, state, district, city, exec_gridcall);
            return false;
        }
    }
    return false;
...
function insert_data(id) {
    if (id == 'ddlCity') {
        ...
        var res = most_important_planet.latlng(con, state, district, city);
        var ds = res.value;
        ...
        var res = most_important_planet.timezone(tzid, dob1);
        var ds1 = res.value;
        ...
        var res = most_important_planet.getsunsetsunrise(document.getElementById('lat').value, document.getElementById('lng').value, document.getElementById('username').value, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')

        var sssr = res.value;
        var srss1 = sssr.split('\r\n')
        var sr = srss1[0];
        var ss = srss1[1];
        var res = most_important_planet.getsunsetsunrisea(sr, document.getElementById('hdntz').value, ss, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        ...
        var res = most_important_planet.getsunsetsunrise1(document.getElementById('lat').value, document.getElementById('lng').value, document.getElementById('username').value, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        ...
        var res = most_important_planet.getsunsetsunriseanext(sr, document.getElementById('hdntz').value, ss, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        var actsrss = res.value;
        var sunrisenextday = actsrss.Tables[0].Rows[0].IDOB;
        hoursob = trim(document.getElementById('hob').value);
        document.getElementById('hdsunrisenext').value = sunrisenextday;

        var res = most_important_planet.getsunsetsunrise2(document.getElementById('lat').value, document.getElementById('lng').value, document.getElementById('username').value, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        var ssopd = res.value;
        var ssopd1 = ssopd.split('\r\n')
        var sr = ssopd1[0];
        var ss = ssopd1[1];

        var res = most_important_planet.getsunsetsunriseapre(sr, document.getElementById('hdntz').value, ss, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        var actsrss = res.value;
        ...
        resprobable = most_important_planet.getdinrat(sunset, sunrise, sunrisenextday, tob, user)
...
function searchclientid() {
    ...
    var exec = most_important_planet.searchclientid(clientname, astroname, astid1, document.getElementById('hdngroup').value, document.getElementById('hdngroup_u').value, '');
    var ds = exec.value;
...
function makebc() {
    ...
    var exea = most_important_planet.Cal_Ascendant_Gulika(hdnmocval, dobval, dateob, monthob, yearob, timeob, hourob, hdnimob, longitudeval, latitudeval, sunsetpre, sunrise, sunset, sunrisenext, tzval);
    //alert(exea.value); //deepak
    ...
    var exec = most_important_planet.makebirthchart(dob, tob, tzon, parseFloat(ascnd_val), parseFloat(gulika_val));
...
function bindrashi(res) {
    ...
    var vishu = "";
    var res1 = most_important_planet.bindrashi(vishu);
    var ds = res1.value;
...
function bindhouse(res) {
    if (res == "house_0") {
        ...
        var vishu = "";
        var res1 = most_important_planet.bindhouse(vishu);
        var ds = res1.value;
        //var drop_id=
        document.getElementById(res).options.length = 0;
...
function binddegree(res) {
    ...
    var vishu = "";
    var res1 = most_important_planet.binddegree(vishu);
    var ds = res1.value;
...
function bindminutes(res) {
    ...
    var vishu = "";
    var res1 = most_important_planet.bindminutes(vishu);
    var ds = res1.value;
...
function bindseconds(res) {
    ...
    var vishu = "";
    var res1 = most_important_planet.bindseconds(vishu);
    var ds = res1.value;
...
function bindretrograde(res) {
    ...
    var vishu = "";
    var res1 = most_important_planet.bindretrograde(vishu);
    var ds = res1.value;
...
function bindconstelation(res) {
    ...
    var vishu = "";
    var res1 = most_important_planet.bindconstelation(vishu);
    var ds = res1.value;
...
function group_bind() {
    ...
    if (astrologer == 'astrology' || astrologer == 'ASTROLOGY' || astrologer == "") {
        ...
        res = most_important_planet.searchuser(astrologer, document.getElementById('cat_grp').options[document.getElementById('cat_grp').selectedIndex].text);
        callback_drp1(res);
    }
}
...
function vargas() {
    ...
    most_important_planet.vargasvalue(vargas, callback_vargas);
    return false;
}
...
function savegrid() {
    ...
    var dsdob = most_important_planet.GetDayOfBirth(document.getElementById('hdndob').value);
    ...
    var dsval = most_important_planet.GetRashi_Constellation(document.getElementById('CVal').value);
    ...
    var dsdnd = most_important_planet.GetDayNightDuration(sunrise, sunset, sunrisenext);
    ...
    var dsbdval = most_important_planet.GetBalance_Dasha(document.getElementById('BalanceDashaVal').value);
    ...
    //var res = most_important_planet.chechduplicacy(astid, astname, client, clientid, document.getElementById("hdngroup").value, document.getElementById("hdngroup_u").value);
    //var ds = res.value;
    ...
    //    document.getElementById('clinetnamediv').style.display = 'block';
    //    var astrologer = astid
    //    res = most_important_planet.searchuser(astrologer, document.getElementById('hdngroup_u').value);
    //    callback_drp1(res)
    //    return false;
    //}
    ...
    if (1 > 1) {
        ...
        var matchwithval = document.getElementById('hfmatchwithid').value;
        var UserType = document.getElementById('hdnUserType').value; // For User Type
        var FlagVal = document.getElementById('hdnflagval').value;
        ...
        var AstrologerIdVal = "";
        var resid = most_important_planet.savecharts_enduser(d01, d02, d03, d04, d05, d06, d07, d08, d09, d10, d11, d12, d16, d20, d24, d27, d30, d40, d45, d60, kl, astid, astname, client, clientid, dasha, document.getElementById("hdndob").value, document.getElementById("hdntob").value, document.getElementById("hdncountry").value, document.getElementById("hdnstate").value, document.getElementById("hdndist").value, document.getElementById("hdncity").value, document.getElementById("hdngroup").value, document.getElementById("hdngroup_u").value, document.getElementById("hdnprof").value, document.getElementById("hdnsex").value, document.getElementById("txtModileNo").value, sunsetpre, sunrise, sunset, sunrisenext, dayofbirth_val, rashi_val, constellation_val, longitude_val, latitude_val, timezone_val, dayduration_val, nightduration_val, balancedasha_val, document.getElementById('hdnclientemailid').value, pwdval, lagnarashi_final, chartdetails, matchwithval, lagnastr, moonstr, venusstr, UserType, document.getElementById("hdnUserID").value, document.getElementById("hdnUserEmailID").value, "", AstrologerIdVal);
        var dsid = resid.value;
        var CID = "", CEMAILID = "";
        if (dsid.Tables[0].Rows.length > 0) {
            CID = dsid.Tables[0].Rows[0]['CLIENTID'];
            CEMAILID = dsid.Tables[0].Rows[0]['CLIENTEMAILID'];
            USER_ACCESS = dsid.Tables[0].Rows[0]['USER_ACCESS'];
            SavePaymentDetails(CID, CEMAILID);
            var Result = dsid.Tables[0].Rows[0]['RESULT'];
           
            if (Result == 'ALREADY_EXISTS') {
                alert('You have already see your free astro report!!');
                ...
                if (FlagVal == "single") {
                    window.location.href = pageUrl + '/single-most-important-planet-for-you.html';
                }
                else if (FlagVal == "two")
                {
                    window.location.href = pageUrl + '/two-most-important-planet-for-you.html';
                }
                else
                {
                    window.location.href = pageUrl + '/three-most-important-planet-for-you.html';
                }
            } else
            {
            ...
            //alert(s);
                ...
                if (USER_ACCESS == "FREE") {
                    window.open('most_important_planet_report.aspx?userid=' + CID + '&useremailid=' + CEMAILID + '&flag=' + FlagVal + '', "_self");
                }
                else
                {
                    window.open('auto_razorpay.aspx?member=' + document.getElementById('hdncartid').value + '&amount=' + document.getElementById('hdnPayableAmount').value + '&clientemailid=' + document.getElementById("hdnUserEmailID").value + '&group=' + document.getElementById("hdngroup").value.toUpperCase() + '&PaymentFor=' + document.getElementById("hdnPaymentFor").value, "_self");
            ...
            //////var resupdateid = most_important_planet.UpdateToCartBilling_UserId(CID,Cartid);
            //////var dsupdateid = resupdateid.value;
            //document.getElementById('loading').style.display = 'none';
            //if (document.getElementById("hdnsex").value=="M")cl_dtls
            //{
            //    var url = window.location.href;
            //    if (url.indexOf("matchwith") > -1) {
            //        window.open('compatibilitymatchingdetails.aspx?userid=' + CID + '', "_self");
            //    }
            //    else
            //    {
            //        window.open('compatibilitymatching.aspx?flag=F&matchwith=' + CID + '', "_self");
            //    }
            //}
            //if (document.getElementById("hdnsex").value == "F") {
            //    var url = window.location.href;
            //    if (url.indexOf("matchwith") > -1) {
            //        window.open('compatibilitymatchingdetails.aspx?userid=' + CID + '', "_self");
            //    }
            //    else {
            //        window.open('compatibilitymatching.aspx?flag=M&matchwith=' + CID + '', "_self");
            //    }
                //}
            }
        }
...
function GetAllNatalQuestion() {
    ...
    //            alert(GroupType);
    //            alert(Category);
    res = most_important_planet.get_allhorarynatal_question(cartid, "", "NATAL", "", "GETALLNATALQUESTIONS");
    var dsn = res.value;
    if (dsn != null && dsn.Tables[0].Rows.length > 0) {
        for (var j = 0; j < dsn.Tables[0].Rows.length; j++) {
            ...
            var resds = most_important_planet.get_natal_questions_substring(CatId, Questionid, Question, "NATAL");
            dsqsub = resds.value;
            ...
            if (CatId == "10")  //This Condition for Manglik Dosha
            {
                ...
                var respaap = most_important_planet.pn("Paap Samya", document.getElementById('Hs').value, document.getElementById('Hm').value, document.getElementById('Hv').value, astmail);
                ...
                if (respaapds.Tables[0].Rows.length > 0) {
                    for (var p = 0; p < respaapds.Tables[0].Rows.length; p++) {
                        if (respaapds.Tables[0].Rows[p]['DESCCLOB'] == "MARS") {
                            ...
                            var mdr = most_important_planet.Get_Manglik_Dosha_Result("MARS", "LAGNA", "MOON", "VENUS", lagnapoint, moonpoint, venuspoint, "ManglikDosha", "", "");
                            var mdrds = mdr.value;
                            var manglik_result = "";
                            if (mdrds.Tables[0].Rows.length > 0) {
                                ...
                                if (Questionid == "1268") {
                                    ...
                                    most_important_planet.update_natalquestion_ans(Autoid, Questionid, manglik_result, "");
                                }
            ...
            else if (CatId == "24")  //This Condition for Dosha Samya
            {
                ...
                document.getElementById('Hm').value = moonstr;
                document.getElementById('Hv').value = venusstr;
                var dsds = most_important_planet.pn("Paap Samya", document.getElementById('Hs').value, document.getElementById('Hm').value, document.getElementById('Hv').value, astmail);
                ...
                var dsr = "";
                if (Questionid == "1273") {
                    dsr = most_important_planet.Get_Dosha_Samya_Result("ALL", "ALL", "ALL", "ALL", "", "", "", "DoshaSamya", "Y", "");
                }
                else if (Questionid == "1274")  // What is Dosha- Samya
                {
                    dsr = most_important_planet.Get_Dosha_Samya_Result("ALL", "ALL", "ALL", "ALL", "", "", "", "DoshaSamya", "D", "");
                }
                else if (Questionid == "1275") // Final Dosha Samya Result
                {
                    dsr = most_important_planet.Get_Dosha_Samya_Result("ALL", "ALL", "ALL", "ALL", "", "", "", "DoshaSamya", "F", "");
                }
                else if (Questionid == "1276") // Expert's advice on Result of Dosha Samay
                {
                    dsr = most_important_planet.Get_Dosha_Samya_Result("ALL", "ALL", "ALL", "ALL", "", "", "", "DoshaSamya", "R", "");
                }
                ...
                if (dsrval.Tables[0].Rows.length > 0) {
                    ...
                    most_important_planet.update_natalquestion_ans(Autoid, Questionid, doshasamya_result, "");
                ...
                kk = kk.replace("'", "''");
                if (executepro == "N") {
                    var resans = most_important_planet.get_natalquestion_ans(s, ss, kk, rashi, key, planets, chart, astmail);
                }
                else {
                    var resans = most_important_planet.get_natalquestion_ans_temp(s, ss, kk, rashi, key, planets, chart, astmail, sessionid, "GETQUESTIONANSWER");
                }
                ...
                if (dsnans != null) {
                    if (dsnans.Tables[0].Rows.length > 0) {
                        ...
                        most_important_planet.update_natalquestion_ans(Autoid, Questionid, Answer, "");
                    }
                }
            }
        }
    }
    var resans = most_important_planet.get_natalquestion_ans_temp('', '', '', '', '', '', '', '', sessionid, "DELETESESSION");
    var dsnans = resans.value;
    if (dsnans != null) {
        if (dsnans.Tables[0].Rows.length > 0) {
            return;
...
function GetAllHoraryQuestion(chartdetails, lagnarashi_final, astid, clientid) {
    ...
    for (var i = 1; i < rowCount; i++) {
        ...
        res = most_important_planet.get_allhorarynatal_question(cartid, "", "HORARY", "", "GETALLHORARYQUESTIONS");
        var dsh = res.value;
        if (dsh != null && dsh.Tables[0].Rows.length > 0) {
            for (var j = 0; j < dsh.Tables[0].Rows.length; j++) {
                ...
                var resr = most_important_planet.get_horaryquestion_ans(chartdetails, lagnarashi_final, mainfilerdrop, subfilterdrop, astid, clientid);
                //var res = most_important_planet.get_horaryquestion_ans(combination, lagnarashi_final, mainfilerdrop, subfilterdrop,callback_fillgrid);
                var exec_data = resr.value;
                if (exec_data.Tables[0].Rows.length > 0) {
                    for (var k = 0; k < exec_data.Tables[0].Rows.length; k++) {
                        var Answer = exec_data.Tables[0].Rows[k]['DESCCLOB'];
                        most_important_planet.update_horaryquestion_ans(Autoid, Questionid, Answer, "");
                    }
                }
            }
        }
