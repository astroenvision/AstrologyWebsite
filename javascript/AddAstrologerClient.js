...
function group_bind() {
    ...
    if (astrologer == 'astrology' || astrologer == 'ASTROLOGY' || astrologer == "") {
        ...
        res = AddAstrologerClient.searchuser(astrologer, document.getElementById('DropDownList2').value);
        callback_drp1(res);
        return false;
    }
    return false;
...
// Form Controls Validations Start Code Here

//class="needs-validation" novalidate add in form tags.
(function () {
    'use strict';
...
// Form Controls Validations End Code Here
...
function cl_dtls() {
    ...
    //Deepak Nirwal Commented Following Email Validation Code On 13-08-2020 Start Here
    //var re = "";
    //var re1 = "";
    ...
    //    }
    //}
    //Deepak Nirwal Commented Following Email Validation Code On 13-08-2020 End Here

    if (document.getElementById('ddlDate').value == "" || document.getElementById('ddlDate').value == "-1") {
        //alert("Please enter Date Of Birth.");
        document.form1.ddlDate.focus();
        return false;
    }

    if (document.getElementById('ddlMonth').value == "" || document.getElementById('ddlMonth').value == "-1") {
        //alert("Please enter Month Of Birth.");
        document.form1.ddlMonth.focus();
        return false;
    }

    if (document.getElementById('ddlYear').value == "" || document.getElementById('ddlYear').value == "-1") {
        //alert("Please enter Year Of Birth.");
        document.form1.ddlYear.focus();
        return false;
    }

    if (document.getElementById('hob').value == "" || document.getElementById('hob').value == "-1") {
        //alert("Please enter Hour Of Birth.");
        document.form1.hob.focus();
        return false;
    }

    if (document.getElementById('mob').value == "" || document.getElementById('mob').value == "-1") {
        //alert("Please enter Minute Of Birth.");
        document.form1.mob.focus();
        return false;
    }

    if (document.getElementById('ddlgender').value == "" || document.getElementById('ddlgender').value == "-1") {
    ...
    if (document.getElementById('ddlCountry').value == "" || document.getElementById('ddlCountry').value == "-1") {
        //alert("Please enter Country Name.");
        document.form1.ddlCountry.focus();
        return false;
    }

    if (document.getElementById('ddlState').value == "" || document.getElementById('ddlState').value == "-1") {
        //alert("Please enter State Name.");
        document.form1.ddlState.focus();
        return false;
    }

    if (document.getElementById('ddlCity').value == "" || document.getElementById('ddlCity').value == "-1") {
    ...
    document.getElementById('dob').value = trim(document.getElementById('ddlDate').value) + '/' + trim(document.getElementById('ddlMonth').value) + '/' + trim(document.getElementById('ddlYear').value);
    ...
    conob = document.getElementById('ddlCountry').options[document.getElementById('ddlCountry').selectedIndex].text;
    statob = document.getElementById('ddlState').options[document.getElementById('ddlState').selectedIndex].text;
    distob = ""; //trim(document.getElementById('district').value);
    cityob = trim(document.getElementById('ddlCity').value);
    ...
    sex = trim(document.getElementById('ddlgender').value);
    //if (document.getElementById('ddlgender').checked == true) {
    //    sex = "M"
    //}
    //else { sex = "F" }
    ...
    var isdres = AddAstrologerClient.istfind(ist3, tob, dateob);
    var ds = isdres.value;
...
function update_cl_dtls() {
    ...
    if (document.getElementById('hdnuser').value != "" || document.getElementById('hdnuser').value != null) {
        astrologer = document.getElementById('hdnuser').value
        astro_dtls = document.getElementById('username').value
        res1 = AddAstrologerClient.update_client(astro_dtls, name, profession, age, sex, astrologer, email, cat_id, mno, cat_grp);
...
function state(event) {
    ...
    if (document.activeElement.id == 'ddlstat') {
        ...
        if (filter == "0") {
            ...
            var res = AddAstrologerClient.state(filter, drop_down, exec_gridcall);
            return false;
        }
    }
    return false;
...
function districtt(event) {
    ...
    if (document.activeElement.id == 'district') {
        ...
        if (filter == "0") {
            ...
            var res = AddAstrologerClient.districtt(drop_down, state, filter, exec_gridcall);
            return false;
        }
    }
    return false;
...
function openroot(event) {
    ...
    if (document.activeElement.id == 'city') {
        ...
        if (filter == "0") {
            ...
            var res = AddAstrologerClient.citys(con, state, district, city, exec_gridcall);
            return false;
        }
    }
    return false;
...
function insert_data(id) {
    if (id == 'ddlCity') {
        ...
        var con = document.getElementById('ddlCountry').value;

        var city = document.getElementById('ddlCity').value;

        var res = AddAstrologerClient.latlng(con, state, district, city);
        var ds = res.value;
        ...
        var res = AddAstrologerClient.timezone(tzid, dob1);
        var ds1 = res.value;
        ...
        var res = AddAstrologerClient.getsunsetsunrise(document.getElementById('lat').value, document.getElementById('lng').value, document.getElementById('username').value, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')

        var sssr = res.value;
        var srss1 = sssr.split('\r\n')
        var sr = srss1[0];
        var ss = srss1[1];
        var res = AddAstrologerClient.getsunsetsunrisea(sr, document.getElementById('hdntz').value, ss, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        ...
        var res = AddAstrologerClient.getsunsetsunrise1(document.getElementById('lat').value, document.getElementById('lng').value, document.getElementById('username').value, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        ...
        var res = AddAstrologerClient.getsunsetsunriseanext(sr, document.getElementById('hdntz').value, ss, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        var actsrss = res.value;
        var sunrisenextday = actsrss.Tables[0].Rows[0].IDOB;
        hoursob = trim(document.getElementById('hob').value);
        document.getElementById('hdsunrisenext').value = sunrisenextday;

        var res = AddAstrologerClient.getsunsetsunrise2(document.getElementById('lat').value, document.getElementById('lng').value, document.getElementById('username').value, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        var ssopd = res.value;
        var ssopd1 = ssopd.split('\r\n')
        var sr = ssopd1[0];
        var ss = ssopd1[1];

        var res = AddAstrologerClient.getsunsetsunriseapre(sr, document.getElementById('hdntz').value, ss, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        var actsrss = res.value;
        ...
        resprobable = AddAstrologerClient.getdinrat(sunset, sunrise, sunrisenextday, tob, user)
...
function searchclientid() {
    ...
    var exec = AddAstrologerClient.searchclientid(clientname, astroname, astid1, document.getElementById('hdngroup').value, document.getElementById('hdngroup_u').value, '');
    var ds = exec.value;
...
function makebc() {
    ...
    var exea = AddAstrologerClient.Cal_Ascendant_Gulika(hdnmocval, dobval, dateob, monthob, yearob, timeob, hourob, hdnimob, longitudeval, latitudeval, sunsetpre, sunrise, sunset, sunrisenext, tzval);
    ...
    var exec = AddAstrologerClient.makebirthchart(dob, tob, tzon, parseFloat(ascnd_val), parseFloat(gulika_val));
...
function bindrashi(res) {
    ...
    var vishu = "";
    var res1 = AddAstrologerClient.bindrashi(vishu);
    var ds = res1.value;
...
function bindhouse(res) {
    if (res == "house_0") {
        ...
        var vishu = "";
        var res1 = AddAstrologerClient.bindhouse(vishu);
        var ds = res1.value;
        //var drop_id=
        document.getElementById(res).options.length = 0;
...
function binddegree(res) {
    ...
    var vishu = "";
    var res1 = AddAstrologerClient.binddegree(vishu);
    var ds = res1.value;
...
function bindminutes(res) {
    ...
    var vishu = "";
    var res1 = AddAstrologerClient.bindminutes(vishu);
    var ds = res1.value;
...
function bindseconds(res) {
    ...
    var vishu = "";
    var res1 = AddAstrologerClient.bindseconds(vishu);
    var ds = res1.value;
...
function bindretrograde(res) {
    ...
    var vishu = "";
    var res1 = AddAstrologerClient.bindretrograde(vishu);
    var ds = res1.value;
...
function bindconstelation(res) {
    ...
    var vishu = "";
    var res1 = AddAstrologerClient.bindconstelation(vishu);
    var ds = res1.value;
...
function group_bind() {
    ...
    if (astrologer == 'astrology' || astrologer == 'ASTROLOGY' || astrologer == "") {
        ...
        res = AddAstrologerClient.searchuser(astrologer, document.getElementById('cat_grp').options[document.getElementById('cat_grp').selectedIndex].text);
        callback_drp1(res);
    }
}
...
function callback_drp1(res) {
    var ds = res.value;
    var edtn = document.getElementById('groupdrop_final').value; //$("groupdrop_final");
    edtn.options.length = 1;
    edtn.options[0] = new Option("General", "0");
    if (ds != null && typeof (ds) == "object" && ds.Tables[1].Rows.length > 0) {
        for (var i = 0; i < ds.Tables[1].Rows.length; i++) {
...
function vargas() {
    ...
    AddAstrologerClient.vargasvalue(vargas, callback_vargas);
    return false;
}
...
function savegrid() {
    ...
    var dsdob = AddAstrologerClient.GetDayOfBirth(document.getElementById('hdndob').value);
    ...
    var dsval = AddAstrologerClient.GetRashi_Constellation(document.getElementById('CVal').value);
    ...
    var dsdnd = AddAstrologerClient.GetDayNightDuration(sunrise, sunset, sunrisenext);
    ...
    var dsbdval = AddAstrologerClient.GetBalance_Dasha(document.getElementById('BalanceDashaVal').value);
    ...
    var astname = document.getElementById('hdnAstrologerName').value; //document.getElementById('astname').innerHTML;
    var astid = document.getElementById('hdnAstrologerID').value; //document.getElementById('astid').innerHTML;
    ...
    //Deepak Nirwal Commented Following Code on 27-07-2020 Start Here
    //if (client == "" || clientid == "") {
    ...
    //var res = AddAstrologerClient.chechduplicacy(astid, astname, client, clientid, document.getElementById("hdngroup").value, document.getElementById("hdngroup_u").value);
    //var ds = res.value;
    //if (ds.Tables[0].Rows.length > 5) //0
    //{
    //    alert('client Horoscope already saved in this group')
    //    document.getElementById('clinetnamediv').style.display = 'block';
    //    var astrologer = astid
    //    res = AddAstrologerClient.searchuser(astrologer, document.getElementById('hdngroup_u').value);
    //    callback_drp1(res)
    //    return false;
    //}
    //Deepak Nirwal Commented Following Code on 27-07-2020 End Here
    ...
    if (1 > 1) {
        ...
        var matchwithval = "0";
        var UserType = document.getElementById('hdnUserType').value;  // for End User
        ...
        var RegUserId = document.getElementById("hdnRegUserId").value;
        var RegUserEmailId = document.getElementById("hdnRegUserEmailId").value;
        var AstrologerIdVal = document.getElementById('hdnAstrologerIdVal').value;
        var resid = AddAstrologerClient.savecharts_enduser(d01, d02, d03, d04, d05, d06, d07, d08, d09, d10, d11, d12, d16, d20, d24, d27, d30, d40, d45, d60, kl, astid, astname, client, clientid, dasha, document.getElementById("hdndob").value, document.getElementById("hdntob").value, document.getElementById("hdncountry").value, document.getElementById("hdnstate").value, document.getElementById("hdndist").value, document.getElementById("hdncity").value, document.getElementById("hdngroup").value, document.getElementById("hdngroup_u").value, document.getElementById("hdnprof").value, document.getElementById("hdnsex").value, document.getElementById("hdnmobile").value, sunsetpre, sunrise, sunset, sunrisenext, dayofbirth_val, rashi_val, constellation_val, longitude_val, latitude_val, timezone_val, dayduration_val, nightduration_val, balancedasha_val, document.getElementById('hdnclientemailid').value, pwdval, lagnarashi_final, chartdetails, matchwithval, lagnastr, moonstr, venusstr, UserType, RegUserId, RegUserEmailId, document.getElementById("hdncartid").value, AstrologerIdVal);
        var dsid = resid.value;
        var CID = "", USER_ACCESS = "";
        if (dsid.Tables[0].Rows.length > 0) {
            CID = dsid.Tables[0].Rows[0]['CLIENTID'];
            USER_ACCESS = dsid.Tables[0].Rows[0]['USER_ACCESS'];
            window.open('~/admin/astrologerclientlist.aspx?clientid=' + CID + '', "_self");
        }
        ...
        //***********Deepak Comment Following 3 Lines on 20 November 2019***********
        //if (document.getElementById("hdngroup_u").value.toUpperCase() == "HORARY") {
        ...
        //    var dsfplist = AddAstrologerClient.GetFinalPrice(document.getElementById('hdncartid').value, document.getElementById("hdnPaymentFor").value, document.getElementById("hdnRegUserId").value.toUpperCase());
        //    var dsfp = dsfplist.value;
        //    var totalprice = "";
        //    if (dsfp.Tables[0].Rows.length > 0) {
        //        totalprice = dsfp.Tables[0].Rows[0]['TOTAL_PRICE'];
        //        ////window.open('thankyou_ccavenue.aspx?cartid=' + document.getElementById('hdncartid').value + '&clientid=' + RegUserId + '&clientemailid=' + RegUserEmailId + '&group=' + document.getElementById("hdngroup_u").value.toUpperCase() + '', "_self");
        //        //window.open('auto_ccavenue.aspx?member=' + document.getElementById('hdncartid').value + '&amount=' + totalprice + '&clientemailid=' + RegUserEmailId + '&group=' + document.getElementById("hdngroup_u").value.toUpperCase() + '', "_self");
        //        //alert(USER_ACCESS);
        //        //alert(document.getElementById("hdnPaymentFor").value.toUpperCase());
        //        if (USER_ACCESS == "FREE") {
        //            if (document.getElementById("hdnPaymentFor").value.toUpperCase() == "NATAL_CATEGORY") {
        //                window.open('thankyou_ccavenue.aspx?cartid=' + document.getElementById('hdncartid').value + '&group=NATAL', "_self");
        //            }
        //            if (document.getElementById("hdnPaymentFor").value.toUpperCase() == "TALK_TO_ASTROLOGER") {
        //                window.open('thankyou.html', "_self");
        //            }
        //            if (document.getElementById("hdnPaymentFor").value.toUpperCase() == "CONSULT_AN_ASTROLOGER") {
        //                window.open('thankyou.html', "_self");
        //            }
        //            if (document.getElementById("hdnPaymentFor").value.toUpperCase() == "PERSONAL_MEETING") {
        //                window.open('thankyou.html', "_self");
        //            }
        //        }
        //        else {
        //            window.open('auto_razorpay.aspx?member=' + document.getElementById('hdncartid').value + '&amount=' + totalprice + '&clientemailid=' + RegUserEmailId + '&group=' + document.getElementById("hdngroup_u").value.toUpperCase() + '&PaymentFor=' + document.getElementById("hdnPaymentFor").value.toUpperCase(), "_self");
        //        }
        //    }
        //}
        //else {
        //    //window.open('thankyou_ccavenue.aspx?cartid=' + document.getElementById('hdncartid').value + '&clientid=' + RegUserId + '&clientemailid=' + RegUserEmailId + '&group=' + document.getElementById("hdngroup_u").value.toUpperCase() + '', "_self");
        //    //window.open('auto_ccavenue.aspx?member=' + document.getElementById('hdncartid').value + '&amount=' + totalprice + '&clientemailid=' + RegUserEmailId + '&group=' + document.getElementById("hdngroup_u").value.toUpperCase() + '', "_self");
        //    window.open('auto_razorpay.aspx?member=' + document.getElementById('hdncartid').value + '&amount=' + totalprice + '&clientemailid=' + RegUserEmailId + '&group=' + document.getElementById("hdngroup_u").value.toUpperCase() + '&PaymentFor=NATAL_CATEGORY', "_self");
        //}
...
function GetAllNatalQuestion(UserId) {
    ...
    for (var i = 0; i < 11; i++) {
        ...
        if (chart == 'D01') {
            ...
            var sYoga = sYoga + document.getElementById('planets_' + i).value + "~" + document.getElementById('rashi_' + i).value + "~" + document.getElementById('house_' + i).value + "$";
        }
        if (chart == 'D09') {
    ...
    //            alert(GroupType);
    //            alert(Category);
    res = AddAstrologerClient.get_allhorarynatal_question(cartid, "", "NATAL", "", "GETALLNATALQUESTIONS");
    var dsn = res.value;
    if (dsn != null && dsn.Tables[0].Rows.length > 0) {
        for (var j = 0; j < dsn.Tables[0].Rows.length; j++) {
            ...
            //alert(Questionid + '-' + CatId);
            var Question = dsn.Tables[0].Rows[j]['QUESTION'];
            var resds = AddAstrologerClient.get_natal_questions_substring(CatId, Questionid, Question, "NATAL");
            dsqsub = resds.value;
            ...
            if (CatId == "10")  //This Condition for Manglik Dosha
            {
                ...
                var resmd = AddAstrologerClient.GetManglikDosha(UserId, "GET_MANGLIK_DOSHA");
                var resmdds = resmd.value;
                if (resmdds.Tables[0].Rows.length > 0) {
                    var ChartName = "", LagnaHouse = "", MoonHouse = "", VenusHouse = "", ManglikResult = "";
                    var Point = "", PointPer = "", House = "", LagnaPoint = "", MoonPoint = "", VenusPoint = "";
                    var LagnaPoint_Per = "", MoonPoint_Per = "", VenusPoint_Per = "", FinalPoint_Per = "";
                    for (var p = 0; p < resmdds.Tables[0].Rows.length; p++) {
                        Point = "";
                        ChartName = resmdds.Tables[0].Rows[p]['CHART_NO'];
                        Point = resmdds.Tables[0].Rows[p]['POINT'];
                        PointPer = resmdds.Tables[0].Rows[p]['POINT_PERCENTAGE'];
                        FinalPoint_Per = resmdds.Tables[0].Rows[p]['MARS_POINT_PERCENTAGE_AVG'];
                        House = resmdds.Tables[0].Rows[p]['HOUSE'];
                        if (ChartName == "LAGNA") {
                            LagnaPoint = Point;
                            LagnaHouse = House;
                            LagnaPoint_Per = PointPer;
                        }
                        if (ChartName == "MOON") {
                            MoonPoint = Point;
                            MoonHouse = House;
                            MoonPoint_Per = PointPer;
                        }
                        if (ChartName == "VENUS") {
                            VenusPoint = Point;
                            VenusHouse = House;
                            VenusPoint_Per = PointPer;
                        }
                    }
                }

                //var respaap = AddAstrologerClient.pn("Paap Samya", document.getElementById('Hs').value, document.getElementById('Hm').value, document.getElementById('Hv').value, astmail);
                ...
                var mdr = AddAstrologerClient.Get_Manglik_Dosha_Result("MARS", "LAGNA", "MOON", "VENUS", LagnaPoint, MoonPoint, VenusPoint, "ManglikDosha", "", "");
                var mdrds = mdr.value;
                var manglik_result = "";
                if (mdrds.Tables[0].Rows.length > 0) {

                    if (Questionid == "1269") { // Manglik Dosha - Result
                        ...
                        if (mdrds.Tables[3].Rows.length > 0) {
                            ...
                            final_result = final_result.replace("XX.XX", FinalPoint_Per);
                        }

                        manglik_result = lagna_result + '' + moon_result + '' + venus_result + '' + final_result;

                        AddAstrologerClient.update_natalquestion_ans(Autoid, Questionid, manglik_result, "");
                    }
                    if (Questionid == "1268") { // What is Manglik Dosha or Kuja Dosha ?
                        manglik_result = "";
                    ...
                    if (Questionid == "1272") {  //Expert's advice on Result of Manglik Dosha
                        manglik_result = "";
            ...
            else if (CatId == "24")  //This Condition for Dosha Samya
            {
                ...
                //document.getElementById('Hm').value = moonstr;
                //document.getElementById('Hv').value = venusstr;
                //var dsds = AddAstrologerClient.pn("Paap Samya", document.getElementById('Hs').value, document.getElementById('Hm').value, document.getElementById('Hv').value, astmail);
                //var dsdsval = dsds.value;

                var dsr = "";

                if (Questionid == "1273") {  // Maleficence by Planets
                    dsr = AddAstrologerClient.Get_Dosha_Samya_Result("ALL", "ALL", "ALL", "ALL", "", "", "", "DoshaSamya", "Y", "");
                }
                else if (Questionid == "1274")  // What is Dosha- Samya
                {
                    dsr = AddAstrologerClient.Get_Dosha_Samya_Result("ALL", "ALL", "ALL", "ALL", "", "", "", "DoshaSamya", "D", "");
                }
                else if (Questionid == "1275") // Final Dosha Samya Result
                {
                    dsr = AddAstrologerClient.Get_Dosha_Samya_Result("ALL", "ALL", "ALL", "ALL", "", "", "", "DoshaSamya", "F", "");
                }
                else if (Questionid == "1276") // Expert's advice on Result of Dosha Samay
                {
                    dsr = AddAstrologerClient.Get_Dosha_Samya_Result("ALL", "ALL", "ALL", "ALL", "", "", "", "DoshaSamya", "R", "");
                }
                    ...
                    for (var p = 0; p < dsrval.Tables[0].Rows.length; p++) {
                        if (Questionid == "1273")  // Maleficence by Planets
                        {
                            if (p == 0) {
                                var resmd = AddAstrologerClient.GetManglikDosha(UserId, "GET_MANGLIK_DOSHA");
                                var resmdds = resmd.value;
                                if (resmdds.Tables[1].Rows.length > 0) {
                                    for (var q = 0; q < resmdds.Tables[1].Rows.length; q++) {
                                        dsresult = dsrval.Tables[0].Rows[0]['DESCCLOB'];
                                        palnetname = resmdds.Tables[1].Rows[q]['PLANET'];
                                        totalpercentage = resmdds.Tables[1].Rows[q]['POINT_PERCENTAGE_AVG'];
                                        ...
                                        doshasamya_result = doshasamya_result + dsresult;
                                    }
                                }
                                AddAstrologerClient.update_natalquestion_ans(Autoid, Questionid, doshasamya_result, "");
                            }
                        }
                        else if (Questionid == "1274")  // What is Dosha- Samya
                        {
                        ...
                        else if (Questionid == "1275") // Final Dosha Samya Result
                        {
                            ...
                            var resmdds = resmd.value;
                            totalpercentage = "";
                            if (resmdds.Tables[2].Rows.length > 0) {
                                for (var m = 0; m < resmdds.Tables[2].Rows.length; m++) {
                                    dsresult = dsrval.Tables[0].Rows[0]['DESCCLOB'];
                                    totalpercentage = resmdds.Tables[2].Rows[m]['FINAL_PERCENTAGE_AVG'];
                                    ///dsresult = dsresult.replace("XX.XX", "<font color='#F4600A'><b>XX.XX</b></font>");
                                    dsresult = dsresult.replace("XX.XX", totalpercentage);
                                    doshasamya_result = dsresult;
                                }
                        ...
                        {
                            doshasamya_result = dsrval.Tables[0].Rows[0]['DESCCLOB'];
                            AddAstrologerClient.update_natalquestion_ans(Autoid, Questionid, doshasamya_result, "");
                        }
                    }
                }
            ...
            else if (CatId == "26") // This Condition for Astro Yoga - Positives / Raj Yoga 
            {
                if (sYoga != "") {
                    sYoga = sYoga.slice(0, -1);
                }
                var resyoga = AddAstrologerClient.get_natal_yoga(sYoga, "0");
                dsyoga = resyoga.value;
                var AnswerYoga = "";
                if (dsyoga != null) {
                    if (dsyoga != null && typeof (dsyoga) == "object" && dsyoga.Tables[0].Rows.length > 0) {
                        for (var i = 0; i < dsyoga.Tables[0].Rows.length; i++) {
                            //predictivetype = dsyoga.Tables[0].Rows[i]['PREDICTIVE_TYPE'];
                            //AnswerYoga = AnswerYoga + "#" + predictivetype + dsyoga.Tables[0].Rows[i]['DESCCLOB'] + "$";
                            AnswerYoga = AnswerYoga + "<b>" + dsyoga.Tables[0].Rows[i]['YOGA'] + "&nbsp;:-&nbsp;</b><br />" + dsyoga.Tables[0].Rows[i]['DESCCLOB'] + "$";
                        }
                        if (AnswerYoga != "") {
                            AnswerYoga = AnswerYoga.slice(0, -1);
                        }
                        AddAstrologerClient.update_natalquestion_ans(Autoid, Questionid, AnswerYoga, "");
                    }
                }
            }
            else if (CatId == "27") // This Condition for Astro Yoga - Negatives
            {
                if (sYoga != "") {
                    sYoga = sYoga.slice(0, -1);
                }
                ...
                //else if (CatId == "29") // This Condition for Kaal Sarpa Dosha
                //{
                //    var reskaal = AddAstrologerClient.Get_Kaal_Sarpa_Dosha("5", "6", "");
                //}
            else {
                ...
                kk = kk.replace("'", "''");
                if (executepro == "N") {
                    var resans = AddAstrologerClient.get_natalquestion_ans(s, ss, kk, rashi, key, planets, chart, astmail);
                }
                else {
                    var resans = AddAstrologerClient.get_natalquestion_ans_temp(s, ss, kk, rashi, key, planets, chart, astmail, sessionid, "GETQUESTIONANSWER");
                }
                ...
                if (dsnans != null) {
                    if (dsnans.Tables[0].Rows.length > 0) {
                        ...
                        AddAstrologerClient.update_natalquestion_ans(Autoid, Questionid, Answer, "");
                    }
                }
            }
        }
    }
    var resans = AddAstrologerClient.get_natalquestion_ans_temp('', '', '', '', '', '', '', '', sessionid, "DELETESESSION");
    var dsnans = resans.value;
    if (dsnans != null) {
        if (dsnans.Tables[0].Rows.length > 0) {
            return;
...
function GetAllHoraryQuestion(chartdetails, lagnarashi_final, astid, clientid) {
    ...
    for (var i = 1; i < rowCount; i++) {
        ...
        res = AddAstrologerClient.get_allhorarynatal_question(cartid, "", "HORARY", "", "GETALLHORARYQUESTIONS");
        var dsh = res.value;
        if (dsh != null && dsh.Tables[0].Rows.length > 0) {
            for (var j = 0; j < dsh.Tables[0].Rows.length; j++) {
                ...
                var resr = AddAstrologerClient.get_horaryquestion_ans(chartdetails, lagnarashi_final, mainfilerdrop, subfilterdrop, astid, clientid);
                //var res = AddAstrologerClient.get_horaryquestion_ans(combination, lagnarashi_final, mainfilerdrop, subfilterdrop,callback_fillgrid);
                var exec_data = resr.value;
                if (exec_data.Tables[0].Rows.length > 0) {
                    for (var k = 0; k < exec_data.Tables[0].Rows.length; k++) {
                        var Answer = exec_data.Tables[0].Rows[k]['DESCCLOB'];
                        AddAstrologerClient.update_horaryquestion_ans(Autoid, Questionid, Answer, "");
                    }
                }
            }
        }
...
function BindState(ds) {
    try {
        var objadscat = document.getElementById("ddlState");
...
function BindCity(dsCity) {
    try {
        var objadscat = document.getElementById("ddlCity");
        objadscat.options.length = 0;
        if (dsCity.length > 0) {
