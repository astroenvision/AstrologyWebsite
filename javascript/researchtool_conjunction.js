         ...
         if(document.getElementById('cve').checked == true){
          ...
          if(document.getElementById('csa').checked == true){
           ...
           if(document.getElementById('cke').checked == true){
             ...
             var query = p + ' are Together ' + ' in ' + document.getElementById('clgroup').options[document.getElementById('clgroup').selectedIndex].text + ' Group '
             document.getElementById('qry').innerHTML = query;
             sv = sv.slice(0, -1);
             var res = researchtool_conjunction.search(planet1, astrolrger, document.getElementById('clgroup').options[document.getElementById('clgroup').selectedIndex].text, client, sv, svn);
      var ds=res.value;
      var inc=1;
      var dec=0;
...
{  
    ...
    var astrologer = document.getElementById('Hastmail').value;
     ...
     var res = researchtool_conjunction.clientinfo(varga,astrologer);
      var ds=res.value;
...
// alert('you are admin');
 ...
 return false;
     ...
     var grp_cat = 'Natal';
     res = researchtool_conjunction.searchuser(astrologer, grp_cat);
...
function grcli() {
    ...
    if (document.getElementById('clgroup').options[document.getElementById('clgroup').selectedIndex].text == 'General') {
        ...
        res = researchtool_conjunction.searchclient(astrologer, document.getElementById('clgroup').options[document.getElementById('clgroup').selectedIndex].text, 'Natal');
        callback_drp2(res);
    }
    else {
