	...
	*/
	...
	var imgDir = "/astrology/javascript/icons/"			// directory for images ... e.g. var imgDir="/img/"   //For Local Setup
    //var imgDir = "/javascript/icons/"    ////For Live Setup
    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div onclick='bShow=true' id='calendar' style='z-index:+999;position:absolute;visibility:hidden;left: 1100px !important;'><table width="+((showWeekDecimal==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#F4600A;font-family:arial; font-size:11px}'><tr bgcolor='#F2F2F2'><td><table width='"+((showWeekDecimal==1)?248:218)+"'><tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='white'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='Close the Calendar'></a></td></tr></table></td></tr><tr><td style='padding:5px' bgcolor=#F8F8F8><span id='content'></span></td></tr>")
		...
		if (showToday==1)
		{
			document.write ("<tr bgcolor=#f0f0f0><td style='padding:5px' align=right><span id='lblToday' style='color: #F4600A;font-family: sans-serif;'></span></td></tr>")
		}
	...
	function constructMonth() {
		...
		if (!monthConstructed) {
			...
			document.getElementById("selectMonth").innerHTML = "<table width=70	style='font-family:arial; font-size:11px; border-width:1; border-style:solid; border-color:#F4600A;' bgcolor='#eeeeee' cellspacing=0 onmouseover='clearTimeout(timeoutID1)'	onmouseout='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"popDownMonth()\",100);event.cancelBubble=true'>" +	sHTML +	"</table>"
...
//				crossobj.top = fixedY==-1 ?	ctl.offsetTop +	toppos + ctl.offsetHeight +	2 +"px" :	fixedY+"px"
            	...
            	crossobj.left =	fixedX==-1 ? ctl.offsetLeft	+ leftpos-80 +"px" :	fixedX+"px"
...
function calltravel()
{
    url = document.getElementById('hdn_urlpath').value;
//window.open(url+"?password="+pas+"&qbc="+qbc_branch+"&center="+center+"&username="+document.getElementById('hiddenuserid').value+"&refid="+at_flag+"&bookid="+bookingid+"&ins="+insid+"&adty="+ad_type);
