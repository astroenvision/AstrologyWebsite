...
function bindrashi(res) {
    ...
    var vishu = "";
    var res1 = most_important_planet_report.bindrashi(vishu);
    var ds = res1.value;
...
function bindhouse(res) {
    if (res == "house_0") {
        ...
        var vishu = "";
        var res1 = most_important_planet_report.bindhouse(vishu);
        var ds = res1.value;
        //var drop_id=
        document.getElementById(res).options.length = 0;
...
function binddegree(res) {
    ...
    var vishu = "";
    var res1 = most_important_planet_report.binddegree(vishu);
    var ds = res1.value;
...
function bindminutes(res) {
    ...
    var vishu = "";
    var res1 = most_important_planet_report.bindminutes(vishu);
    var ds = res1.value;
...
function bindseconds(res) {
    ...
    var vishu = "";
    var res1 = most_important_planet_report.bindseconds(vishu);
    var ds = res1.value;
...
function bindretrograde(res) {
    ...
    var vishu = "";
    var res1 = most_important_planet_report.bindretrograde(vishu);
    var ds = res1.value;
...
function bindconstelation(res) {
    ...
    var vishu = "";
    var res1 = most_important_planet_report.bindconstelation(vishu);
    var ds = res1.value;
...
function searchclientid() {
    ...
    var exec = most_important_planet_report.searchclientid(clientname, astroname, astid1, document.getElementById('hdngroup').value, document.getElementById('hdngroup_u').value, document.getElementById('hdnuserid').value);
    var ds = exec.value;
...
function vargasotherchart() {
    ...
    most_important_planet_report.vargasvalue(vargasfinal, callback_vargas);
