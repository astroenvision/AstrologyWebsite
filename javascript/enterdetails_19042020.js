...
function savegrid() {
    ...
    var astname = "Astroenvision Natal Admin"; //document.getElementById('astname').innerHTML;
    var astid = "nataladmin@astroenvision.com"; //document.getElementById('astid').innerHTML;
    ...
    if (ds.Tables[0].Rows.length > 2) //0
    {
        ...
        if (dsid.Tables[0].Rows.length > 0) {
            ...
            var resupdateid = enterdetails.UpdateToCartBilling_UserId(CID, Cartid);
        ...
        if (document.getElementById("hdncountrycode").value.toUpperCase() == "IN") {
            var dsfplist = enterdetails.GetFinalPrice(document.getElementById('hdncartid').value);
