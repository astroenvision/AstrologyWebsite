...
function group_bind() {
    ...
    if (astrologer == 'astrology' || astrologer == 'ASTROLOGY' || astrologer == "") {
        ...
        res = enterdetails.searchuser(astrologer, document.getElementById('DropDownList2').value);
        callback_drp1(res);
        return false;
    }
    return false;
...
function cl_dtls() {
    ...
    var isdres = enterdetails.istfind(ist3, tob, dateob);
    var ds = isdres.value;
...
function update_cl_dtls() {
    ...
    if (document.getElementById('hdnuser').value != "" || document.getElementById('hdnuser').value != null) {
        astrologer = document.getElementById('hdnuser').value
        astro_dtls = document.getElementById('username').value
        res1 = enterdetails.update_client(astro_dtls, name, profession, age, sex, astrologer, email, cat_id, mno, cat_grp);
...
function state(event) {
    ...
    if (document.activeElement.id == 'ddlstat') {
        ...
        if (filter == "0") {
            ...
            var res = enterdetails.state(filter, drop_down, exec_gridcall);
            return false;
        }
    }
    return false;
...
function districtt(event) {
    ...
    if (document.activeElement.id == 'district') {
        ...
        if (filter == "0") {
            ...
            var res = enterdetails.districtt(drop_down, state, filter, exec_gridcall);
            return false;
        }
    }
    return false;
...
function openroot(event) {
    ...
    if (document.activeElement.id == 'city') {
        ...
        if (filter == "0") {
            ...
            var res = enterdetails.citys(con, state, district, city, exec_gridcall);
            return false;
        }
    }
    return false;
...
function insert_data(id) {
    if (id == 'ddlCity') {
        ...
        var res = enterdetails.latlng(con, state, district, city);
        var ds = res.value;
        ...
        var res = enterdetails.timezone(tzid, dob1);
        var ds1 = res.value;
        ...
        var res = enterdetails.getsunsetsunrise(document.getElementById('lat').value, document.getElementById('lng').value, document.getElementById('username').value, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')

        var sssr = res.value;
        var srss1 = sssr.split('\r\n')
        var sr = srss1[0];
        var ss = srss1[1];
        var res = enterdetails.getsunsetsunrisea(sr, document.getElementById('hdntz').value, ss, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        ...
        var res = enterdetails.getsunsetsunrise1(document.getElementById('lat').value, document.getElementById('lng').value, document.getElementById('username').value, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        ...
        var res = enterdetails.getsunsetsunriseanext(sr, document.getElementById('hdntz').value, ss, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        var actsrss = res.value;
        var sunrisenextday = actsrss.Tables[0].Rows[0].IDOB;
        hoursob = trim(document.getElementById('hob').value);
        document.getElementById('hdsunrisenext').value = sunrisenextday;

        var res = enterdetails.getsunsetsunrise2(document.getElementById('lat').value, document.getElementById('lng').value, document.getElementById('username').value, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        var ssopd = res.value;
        var ssopd1 = ssopd.split('\r\n')
        var sr = ssopd1[0];
        var ss = ssopd1[1];

        var res = enterdetails.getsunsetsunriseapre(sr, document.getElementById('hdntz').value, ss, d1[1] + '/' + d1[0] + '/' + d1[2] + ' ' + '1:00:42 AM')
        var actsrss = res.value;
        ...
        resprobable = enterdetails.getdinrat(sunset, sunrise, sunrisenextday, tob, user)
...
function searchclientid() {
    ...
    var exec = enterdetails.searchclientid(clientname, astroname, astid1, document.getElementById('hdngroup').value, document.getElementById('hdngroup_u').value, '');
    var ds = exec.value;
...
function makebc() {
    ...
    var exea = enterdetails.Cal_Ascendant_Gulika(hdnmocval, dobval, dateob, monthob, yearob, timeob, hourob, hdnimob, longitudeval, latitudeval, sunsetpre, sunrise, sunset, sunrisenext, tzval);
    ...
    var exec = enterdetails.makebirthchart(dob, tob, tzon, parseFloat(ascnd_val), parseFloat(gulika_val));
...
function bindrashi(res) {
    ...
    var vishu = "";
    var res1 = enterdetails.bindrashi(vishu);
    var ds = res1.value;
...
function bindhouse(res) {
    if (res == "house_0") {
        ...
        var vishu = "";
        var res1 = enterdetails.bindhouse(vishu);
        var ds = res1.value;
        //var drop_id=
        document.getElementById(res).options.length = 0;
...
function binddegree(res) {
    ...
    var vishu = "";
    var res1 = enterdetails.binddegree(vishu);
    var ds = res1.value;
...
function bindminutes(res) {
    ...
    var vishu = "";
    var res1 = enterdetails.bindminutes(vishu);
    var ds = res1.value;
...
function bindseconds(res) {
    ...
    var vishu = "";
    var res1 = enterdetails.bindseconds(vishu);
    var ds = res1.value;
...
function bindretrograde(res) {
    ...
    var vishu = "";
    var res1 = enterdetails.bindretrograde(vishu);
    var ds = res1.value;
...
function bindconstelation(res) {
    ...
    var vishu = "";
    var res1 = enterdetails.bindconstelation(vishu);
    var ds = res1.value;
...
function group_bind() {
    ...
    if (astrologer == 'astrology' || astrologer == 'ASTROLOGY' || astrologer == "") {
        ...
        res = enterdetails.searchuser(astrologer, document.getElementById('cat_grp').options[document.getElementById('cat_grp').selectedIndex].text);
        callback_drp1(res);
    }
}
...
function vargas() {
    ...
    enterdetails.vargasvalue(vargas, callback_vargas);
    return false;
}
...
function savegrid() {
    ...
    var dsdob = enterdetails.GetDayOfBirth(document.getElementById('hdndob').value);
    ...
    var dsval = enterdetails.GetRashi_Constellation(document.getElementById('CVal').value);
    ...
    var dsdnd = enterdetails.GetDayNightDuration(sunrise, sunset, sunrisenext);
    ...
    var dsbdval = enterdetails.GetBalance_Dasha(document.getElementById('BalanceDashaVal').value);
    ...
    //var res = enterdetails.chechduplicacy(astid, astname, client, clientid, document.getElementById("hdngroup").value, document.getElementById("hdngroup_u").value);
    //var ds = res.value;
    ...
    //    document.getElementById('clinetnamediv').style.display = 'block';
    //    var astrologer = astid
    //    res = enterdetails.searchuser(astrologer, document.getElementById('hdngroup_u').value);
    //    callback_drp1(res)
    //    return false;
    //}
    ...
    if (1 > 1) {
        ...
        if (dsid.Tables[0].Rows.length > 0) {
            ...
            var resupdateid = enterdetails.UpdateToCartBilling_UserId(CID, Cartid, document.getElementById("hdnPaymentFor").value, document.getElementById("hdnRegUserId").value);
        ...
        if (document.getElementById("hdncountrycode").value.toUpperCase() == "IN") {
            var dsfplist = enterdetails.GetFinalPrice(document.getElementById('hdncartid').value, document.getElementById("hdnPaymentFor").value, document.getElementById("hdnRegUserId").value.toUpperCase());
...
function GetAllNatalQuestion(UserId) {
    ...
    //            alert(GroupType);
    //            alert(Category);
    res = enterdetails.get_allhorarynatal_question(cartid, "", "NATAL", "", "GETALLNATALQUESTIONS");
    var dsn = res.value;
    if (dsn != null && dsn.Tables[0].Rows.length > 0) {
        for (var j = 0; j < dsn.Tables[0].Rows.length; j++) {
            ...
            var resds = enterdetails.get_natal_questions_substring(CatId, Questionid, Question, "NATAL");
            dsqsub = resds.value;
            ...
            if (CatId == "10")  //This Condition for Manglik Dosha
            {
                ...
                var resmd = enterdetails.GetManglikDosha(UserId, "GET_MANGLIK_DOSHA");
                ...
                //var respaap = enterdetails.pn("Paap Samya", document.getElementById('Hs').value, document.getElementById('Hm').value, document.getElementById('Hv').value, astmail);
                ...
                //if (respaapds.Tables[0].Rows.length > 0) {
                    //for (var p = 0; p < respaapds.Tables[0].Rows.length; p++) {
                        //if (respaapds.Tables[0].Rows[p]['DESCCLOB'] == "MARS") {
                            ...
                            var mdr = enterdetails.Get_Manglik_Dosha_Result("MARS", "LAGNA", "MOON", "VENUS", LagnaPoint, MoonPoint, VenusPoint, "ManglikDosha", "", "");
                            var mdrds = mdr.value;
                            var manglik_result = "";
                            if (mdrds.Tables[0].Rows.length > 0) {
                             ...
                             if (Questionid == "1269") { // Manglik Dosha - Result
                                ...
                                if (mdrds.Tables[3].Rows.length > 0) {
                                 ...
                                 enterdetails.update_natalquestion_ans(Autoid, Questionid, manglik_result, "");
                                }
            ...
            else if (CatId == "24")  //This Condition for Dosha Samya
            {
                ...
                //document.getElementById('Hm').value = moonstr;
                //document.getElementById('Hv').value = venusstr;
                //var dsds = enterdetails.pn("Paap Samya", document.getElementById('Hs').value, document.getElementById('Hm').value, document.getElementById('Hv').value, astmail);
                //var dsdsval = dsds.value;

                var dsr = "";
                
                if (Questionid == "1273") {  // Maleficence by Planets
                    dsr = enterdetails.Get_Dosha_Samya_Result("ALL", "ALL", "ALL", "ALL", "", "", "", "DoshaSamya", "Y", "");
                }
                else if (Questionid == "1274")  // What is Dosha- Samya
                {
                    dsr = enterdetails.Get_Dosha_Samya_Result("ALL", "ALL", "ALL", "ALL", "", "", "", "DoshaSamya", "D", "");
                }
                else if (Questionid == "1275") // Final Dosha Samya Result
                {
                    dsr = enterdetails.Get_Dosha_Samya_Result("ALL", "ALL", "ALL", "ALL", "", "", "", "DoshaSamya", "F", "");
                }
                else if (Questionid == "1276") // Expert's advice on Result of Dosha Samay
                {
                    dsr = enterdetails.Get_Dosha_Samya_Result("ALL", "ALL", "ALL", "ALL", "", "", "", "DoshaSamya", "R", "");
                }
                    ...
                    for (var p = 0; p < dsrval.Tables[0].Rows.length; p++) {
                        if (Questionid == "1273")  // Maleficence by Planets
                        {
                            if(p == 0)
                            {
                                ...
                                enterdetails.update_natalquestion_ans(Autoid, Questionid, doshasamya_result, "");
                            }
                        }
                        else if (Questionid == "1274")  // What is Dosha- Samya
                        {
            ...
            else if (CatId == "26") // This Condition for Astro Yoga - Positives / Raj Yoga 
            {
                ...
                var resyoga = enterdetails.get_natal_yoga(sYoga, "0");
                ...
                if (dsyoga != null)
                {
                    if (dsyoga != null && typeof (dsyoga) == "object" && dsyoga.Tables[0].Rows.length > 0) {
                        ...
                        enterdetails.update_natalquestion_ans(Autoid, Questionid, AnswerYoga, "");
                    }
                }
            }
            ...
            //{
            //    var reskaal = enterdetails.Get_Kaal_Sarpa_Dosha("5", "6", "");
            //}
            else {
                ...
                kk = kk.replace("'", "''");
                if (executepro == "N") {
                    var resans = enterdetails.get_natalquestion_ans(s, ss, kk, rashi, key, planets, chart, astmail);
                }
                else {
                    var resans = enterdetails.get_natalquestion_ans_temp(s, ss, kk, rashi, key, planets, chart, astmail, sessionid, "GETQUESTIONANSWER");
                }
                ...
                if (dsnans != null) {
                    if (dsnans.Tables[0].Rows.length > 0) {
                        ...
                        enterdetails.update_natalquestion_ans(Autoid, Questionid, Answer, "");
                    }
                }
            }
        }
    }
    var resans = enterdetails.get_natalquestion_ans_temp('', '', '', '', '', '', '', '', sessionid, "DELETESESSION");
    var dsnans = resans.value;
    if (dsnans != null) {
        if (dsnans.Tables[0].Rows.length > 0) {
            return;
...
function GetAllHoraryQuestion(chartdetails, lagnarashi_final, astid, clientid) {
    ...
    for (var i = 1; i < rowCount; i++) {
        ...
        res = enterdetails.get_allhorarynatal_question(cartid, "", "HORARY", "", "GETALLHORARYQUESTIONS");
        var dsh = res.value;
        if (dsh != null && dsh.Tables[0].Rows.length > 0) {
            for (var j = 0; j < dsh.Tables[0].Rows.length; j++) {
                ...
                var resr = enterdetails.get_horaryquestion_ans(chartdetails, lagnarashi_final, mainfilerdrop, subfilterdrop, astid, clientid);
                //var res = enterdetails.get_horaryquestion_ans(combination, lagnarashi_final, mainfilerdrop, subfilterdrop,callback_fillgrid);
                var exec_data = resr.value;
                if (exec_data.Tables[0].Rows.length > 0) {
                    for (var k = 0; k < exec_data.Tables[0].Rows.length; k++) {
                        var Answer = exec_data.Tables[0].Rows[k]['DESCCLOB'];
                        enterdetails.update_horaryquestion_ans(Autoid, Questionid, Answer, "");
                    }
                }
            }
        }
