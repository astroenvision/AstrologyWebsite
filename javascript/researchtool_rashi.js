...
//    
    ...
    buf1 += "<td id='ari' class='colum-td-head-chart'>" + "Ari" + "</td>"
    buf1 += "<td id='tau' class='colum-td-head-chart'>" + "Tau" + "</td>"
    buf1 += "<td id='gem' class='colum-td-head-chart'>" + "Gem " + "</td>"
    buf1 += "<td id='can' class='colum-td-head-chart'>" + "Can" + "</td>"
buf1 += "<td id='leo' class='colum-td-head-chart'>" + "Leo" + "</td>"
buf1 += "<td id='vir' class='colum-td-head-chart'>" + "Vir" + "</td>"
buf1 += "<td id='lib' class='colum-td-head-chart'>" + "Lib" + "</td>"
buf1 += "<td id='sco' class='colum-td-head-chart'>" + "Sco" + "</td>"
buf1 += "<td id='sag' class='colum-td-head-chart'>" + "Sag" + "</td>"
buf1 += "<td id='cap' class='colum-td-head-chart'>" + "Cap" + "</td>"
buf1 += "<td id='aqu' class='colum-td-head-chart'>" + "Aqu" + "</td>"
buf1 += "<td id='pis' class='colum-td-head-chart'>" + "Pis" + "</td>"
buf1 += "<td id='h1' class='colum-td-head-chart'>" + "H1" + "</td>"
buf1 += "<td id='h2' class='colum-td-head-chart'>" + "H2" + "</td>"
buf1 += "<td id='h3' class='colum-td-head-chart'>" + "H3" + "</td>"
buf1 += "<td id='h4' class='colum-td-head-chart'>" + "H4" + "</td>"
buf1 += "<td id='h5' class='colum-td-head-chart'>" + "H5" + "</td>"
buf1 += "<td id='h6' class='colum-td-head-chart'>" + "H6" + "</td>"
buf1 += "<td id='h7' class='colum-td-head-chart'>" + "H7" + "</td>"
buf1 += "<td id='h8' class='colum-td-head-chart'>" + "H8" + "</td>"
buf1 += "<td id='h9' class='colum-td-head-chart'>" + "H9" + "</td>"
buf1 += "<td id='h10' class='colum-td-head-chart'>" + "H10" + "</td>"
buf1 += "<td id='h11' class='colum-td-head-chart'>" + "H11" + "</td>"
buf1 += "<td id='h12' class='colum-td-head-chart'>" + "H12" + "</td>"
...
for (var i = 0; i <= 7; i++) 
{
    ...
    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;' BackColor='white'; class='dropdown_large_corr' ; align='center' AutoPostBack='true'  id='ari_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;' BackColor='white';  class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='tau_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='gem_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='can_" + i + "' >"
    buf1 += "</td>"


   buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;' BackColor='white';  class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='leo_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='vir_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='lib_" + i + "' >"
    buf1 += "</td>"
    
    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='sco_" + i + "' >"
    buf1 += "</td>"
    
    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='sag_" + i + "' >"
    buf1 += "</td>"
    
    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='cap_" + i + "' >"
    buf1 += "</td>"
    
    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='aqu_" + i + "' >"
    buf1 += "</td>"
    
    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='pis_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='h1_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='h2_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='h3_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='h4_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='h5_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='h6_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='h7_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='h8_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='h9_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='h10_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='h11_" + i + "' >"
    buf1 += "</td>"

    buf1 += "<td class='colum-td-chart'>"
    buf1 += "<input type='checkbox'  style='width:20px;'class='dropdown_large_corr'; align='center' AutoPostBack='true'  id='h12_" + i + "' >"
    buf1 += "</td>"
  ...
  buf1 += "</table>"
    ...
    document.getElementById('ari_7').style.display='none';
    document.getElementById('tau_7').style.display='none';
    document.getElementById('gem_7').style.display='none';
    document.getElementById('can_7').style.display='none';
    document.getElementById('leo_7').style.display='none';
    document.getElementById('vir_7').style.display='none';
     document.getElementById('lib_7').style.display='none';
    document.getElementById('sco_7').style.display='none';
    document.getElementById('sag_7').style.display='none';
    document.getElementById('cap_7').style.display='none';
    document.getElementById('aqu_7').style.display='none';
    document.getElementById('pis_7').style.display='none';
    ...
    document.getElementById('h1_7').style.display = 'none';
    document.getElementById('h2_7').style.display = 'none';
    document.getElementById('h3_7').style.display = 'none';
    document.getElementById('h4_7').style.display = 'none';
    document.getElementById('h5_7').style.display = 'none';
    document.getElementById('h6_7').style.display = 'none';
    document.getElementById('h7_7').style.display = 'none';
    document.getElementById('h8_7').style.display = 'none';
    document.getElementById('h9_7').style.display = 'none';
    document.getElementById('h10_7').style.display = 'none';
    document.getElementById('h11_7').style.display = 'none';
    document.getElementById('h12_7').style.display = 'none';
...
//    }
 ...
 function search(id)
     ...
     var split1 = split[1];
        ...
        var rashi ="";
          if(document.getElementById('ari_'+split1).checked == true){
         ...
         rashi= 'Aries'+','+rashi;
          ...
          if(document.getElementById('tau_'+split1).checked == true){
          
           rashi='Taurus'+','+rashi;
          }
          
          if(document.getElementById('gem_'+split1).checked == true){
          
         rashi='Gemini'+','+rashi;
          }
          
          
           if(document.getElementById('can_'+split1).checked == true){
          
         rashi='Cancer'+','+rashi;
          }
         
         if(document.getElementById('leo_'+split1).checked == true){
          
          rashi= 'Leo'+','+rashi;
          }
          
         if(document.getElementById('vir_'+split1).checked == true){
          
          rashi= 'Virgo'+','+rashi;
          }
          if(document.getElementById('lib_'+split1).checked == true){
          
          rashi= 'Libra'+','+rashi;
          } 
           if(document.getElementById('sco_'+split1).checked == true){
          
          rashi= 'Scorpio'+','+rashi;
          } 
           if(document.getElementById('sag_'+split1).checked == true){
          
          rashi= 'Sagittarius'+','+rashi;
          } 
           if(document.getElementById('cap_'+split1).checked == true){
          
          rashi= 'Capricorn'+','+rashi;
          } 
           if(document.getElementById('aqu_'+split1).checked == true){
          
          rashi= 'Aquarius'+','+rashi;
          } 
           if(document.getElementById('pis_'+split1).checked == true){
          ...
          rashi= 'Pisces'+','+rashi;
                 ...
                 var house = "";
                 if (document.getElementById('h1_' + split1).checked == true) {
                 ...
                 if (document.getElementById('h2_' + split1).checked == true) {

                     house = 'HOUSE2' + ',' + house;
                 }

                 if (document.getElementById('h3_' + split1).checked == true) {

                     house = 'HOUSE3' + ',' + house;
                 }


                 if (document.getElementById('h4_' + split1).checked == true) {

                     house = 'HOUSE4' + ',' + house;
                 }

                 if (document.getElementById('h5_' + split1).checked == true) {

                     house = 'HOUSE5' + ',' + house;
                 }

                 if (document.getElementById('h6_' + split1).checked == true) {

                     house = 'HOUSE6' + ',' + house;
                 }
                 if (document.getElementById('h7_' + split1).checked == true) {

                     house = 'HOUSE7' + ',' + house;
                 }
                 if (document.getElementById('h8_' + split1).checked == true) {

                     house = 'HOUSE8' + ',' + house;
                 }
                 if (document.getElementById('h9_' + split1).checked == true) {

                     house = 'HOUSE9' + ',' + house;
                 }
                 if (document.getElementById('h10_' + split1).checked == true) {

                     house = 'HOUSE10' + ',' + house;
                 }
                 if (document.getElementById('h11_' + split1).checked == true) {

                     house = 'HOUSE11' + ',' + house;
                 }
                 if (document.getElementById('h12_' + split1).checked == true) {
                 ...
                 return false;
                  ...
                  var res = researchtool_rashi.search(planet, rashi1, astrolrger, document.getElementById('clgroup').options[document.getElementById('clgroup').selectedIndex].text, house1);
      var ds=res.value;
      var inc=1;
      var dec=0;
...
{  document.getElementById('clinetnamediv').style.display = 'block';
    ...
    var rashi="";
    var rashi2="";
    if(document.getElementById('ari_'+spl1[1]).checked==true)
    {
    rashi='Aries'+', '+rashi;
    }
    if(document.getElementById('tau_'+spl1[1]).checked==true)
    {
    rashi='Taurus'+', '+rashi;
    }
    if(document.getElementById('gem_'+spl1[1]).checked==true)
    {
    rashi='Gemini'+', '+rashi;
    }
    if(document.getElementById('can_'+spl1[1]).checked==true)
    {
    rashi='Cancer'+', '+rashi;
    }
   if(document.getElementById('leo_'+spl1[1]).checked==true)
    {
    rashi='Leo'+', '+rashi;
    }
   if(document.getElementById('vir_'+spl1[1]).checked==true)
    {
    rashi='Virgo'+', '+rashi;
    }
   if(document.getElementById('lib_'+spl1[1]).checked==true)
    {
    rashi='Libra'+', '+rashi;
    }
    if(document.getElementById('sco_'+spl1[1]).checked==true)
    {
    rashi='Scorpio'+', '+rashi;
    }
    if(document.getElementById('sag_'+spl1[1]).checked==true)
    {
    rashi='Sagittarius'+', '+rashi;
    }
    if(document.getElementById('cap_'+spl1[1]).checked==true)
    {
    rashi='Capricorn'+', '+rashi;
    }
    if(document.getElementById('aqu_'+spl1[1]).checked==true)
    {
    rashi='Aquarius'+', '+rashi;
    }
    if(document.getElementById('pis_'+spl1[1]).checked==true)
    {
    rashi='Pisces'+', '+rashi;
    }
    ...
    var house = "";
    var house2 = "";
    if (document.getElementById('h1_' + spl1[1]).checked == true) {
        house = 'HOUSE1' + ', ' + house;
    }
    if (document.getElementById('h2_' + spl1[1]).checked == true) {
        house = 'HOUSE2' + ', ' + house;
    }
    if (document.getElementById('h3_' + spl1[1]).checked == true) {
        house = 'HOUSE3' + ', ' + house;
    }
    if (document.getElementById('h4_' + spl1[1]).checked == true) {
        house = 'HOUSE4' + ', ' + house;
    }
    if (document.getElementById('h5_' + spl1[1]).checked == true) {
        house = 'HOUSE5' + ', ' + house;
    }
    if (document.getElementById('h6_' + spl1[1]).checked == true) {
        house = 'HOUSE6' + ', ' + house;
    }
    if (document.getElementById('h7_' + spl1[1]).checked == true) {
        house = 'HOUSE7' + ', ' + house;
    }
    if (document.getElementById('h8_' + spl1[1]).checked == true) {
        house = 'HOUSE8' + ', ' + house;
    }
    if (document.getElementById('h9_' + spl1[1]).checked == true) {
        house = 'HOUSE9' + ', ' + house;
    }
    if (document.getElementById('h10_' + spl1[1]).checked == true) {
        house = 'HOUSE10' + ', ' + house;
    }
    if (document.getElementById('h11_' + spl1[1]).checked == true) {
        house = 'HOUSE11' + ', ' + house;
    }
    if (document.getElementById('h12_' + spl1[1]).checked == true) {
        house = 'HOUSE12' + ', ' + house;
    }
    //var rashi2=rashi.slice(0,-1);
    var astrologer = document.getElementById('Hastmail').value;
     var res = researchtool_rashi.clientinfo(varga,astrologer);
      var ds=res.value;
...
document.getElementById('ha').innerHTML = house2;
...
// alert('you are admin');
 ...
 return false;
     ...
     var grp_cat = 'Natal';
     res = researchtool_rashi.searchuser(astrologer, grp_cat);
