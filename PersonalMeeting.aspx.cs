...
public partial class PersonalMeeting : System.Web.UI.Page
{
    ...
    protected void BindAstrologers()
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                dsAs = obj.ManageAstrologerPrice("GET_PRICE_DETAILS", "", ds.Tables[0].Rows[i]["USER_ID"].ToString(), "", "", "", "", "", "", "", "", "", "PERSONAL_MEETING", "");
                strhtml.Append("<li>");
                strhtml.Append("<div class='row'>");
                strhtml.Append("<div class='col-xl-3 col-4'>");
                strhtml.Append("<div class='astprofpix'>");
                ...
                //strhtml.Append("</div>");
                strhtml.Append("<div class='tstdtl'><p>Consultancy in Person Your efforts to meet your Astrologer in person is always the most valuable and effective way of communication. No doubt it is more convenient to get consultancy over email, talk on video. Still, face - to - face meeting develops a higher clarity, transparency and trust as part of stable relations with your Astrologer about much insights of your Birth Chart than through talks / video conferencing as the interaction flows naturally in a personal meeting.</p><p>You can meet our Best Astrologer in person at our office (AstroEnvision), or a convenient place mutually agreed.</p><br><p style='color:#f25e0a;'><strong>For Personal Appointment Contact + 955600111, 9555700111 </strong></p><br><p>Sector II B, 58, Vaishali, Ghaziabad - 201010</p></div>");
