<%@ Page Language="C#" AutoEventWireup="true" CodeFile="most_important_planet.aspx.cs" Inherits="most_important_planet" %>
...
<head runat="server">
    <title>Online Astrology and Consultancy, Prashna(Horary) Astrology | Astro Envision</title>
    <meta charset="utf-8" />
    ...
    <script type="text/javascript" src="javascript/most_important_planet.js"></script>
</head>
<body>
    <form id="form1" runat="server">
            ...
            <div class="container">
                ...
                <div class="container-sec my-2">
                    <div class="content-center">
                        ...
                        <div class="line">
                            <h1 id="heading_div" runat="server"></h1>
                        </div>
                        ...
                        <div class="col-sm-12" style="display: none;">
                            <div class="form-background_article">
                                <div class="fullarticle">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h2 style="text-align: center;">Free Online Vedic Horoscope and Personality report</h2>
                                            <p>In this Free Online Vedic Horoscope Report, Astro Envision will provide you Free Predictions about your multiple personality traits and many other important things about your life just free.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <input type="hidden" runat="server" id="hdnflagval" />
        <input type="hidden" runat="server" id="hdnUserID" />
        <input type="hidden" runat="server" id="hdnUserEmailID" />
       <input type="hidden" runat="server" id="hdnActualAmount" />
        <input type="hidden" runat="server" id="hdnDiscount" />
        <input type="hidden" runat="server" id="hdnDiscountAmount" />
 
        <input type="hidden" runat="server" id="hdnPayableAmount" />
