...
public partial class astrologerclientreport : System.Web.UI.Page
{
    #region Declarations
    ...
    {
        Ajax.Utility.RegisterTypeForAjax(typeof(astrologerclientreport));
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["ClientID"] != null && Request.QueryString["ClientID"] != null)
            {
