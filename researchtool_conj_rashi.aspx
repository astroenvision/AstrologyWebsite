<%@ Page Language="C#" AutoEventWireup="true" CodeFile="researchtool_conj_rashi.aspx.cs" Inherits="researchtool_conj_rashi" EnableEventValidation="false"%>
...
<script type="text/javascript" language="javascript" src="javascript/researchtool_conj_rashi.js"></script>
...
<asp:DropDownList ID="grcl"    CssClass="drpo_homenewcl" runat="server" ></asp:DropDownList> 
 ...
 <tr>
  <div id="e1" runat="server" class="d_header_3">
    <p>
    Choose  - combination of position of Planet’s / Rashi’s and House in Various Vargas  ( For Individual or Group of chart)</p>
     <p id="rh" runat="server">
 ...
 <asp:LinkButton ID="cal" class="per_btn"   runat="server"  Text="Calculate" />
    ...
    <table>
           ...
           <div id="rashi_div" style="width:170px;  float:left;" font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">Posited
           </div>
        ...
        <div style="width:250px;height:140px; float:left;"><asp:Label ID="va" runat="server" Text=""></asp:Label></div>
         ...
         <div id="Div4"   style="width:170px; float:left;" font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">Planet
           ...
           <div id="Div5"   style="width:170px; float:left;" font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">Posited
           </div>
