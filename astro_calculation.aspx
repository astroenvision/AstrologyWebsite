<%@ Page Language="C#" AutoEventWireup="true" CodeFile="astro_calculation.aspx.cs" Inherits="astro_calculation" %>
...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.6.2/jquery.min.js"></script>
 <script type="text/javascript" language="javascript" src="javascript/astrocalculation.js"></script>
...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
	...
	<div class="menu" id="nav">
    	<ul>
           ...
           <ul>
             ...
             <li id="Li4" runat="server"><a class="menu_Selact">Natal Calculation</a></li>
 ...
 <div class="mid_over">
  ...
  <span class="filterss">
   ...
   <div id="whitediv" class="div_curve_combi">
  
   <div class="hc">
   <table>
   <tr><td> <asp:Label id="Label1"  Text="Main Filter" runat="server" ></asp:Label>
   <asp:DropDownList ID="mainfilter" CssClass="drpo_homenew" runat="server">
       <asp:ListItem>Select</asp:ListItem>
       <asp:ListItem>Pushkar Navamsha</asp:ListItem>
       <asp:ListItem>kshetra sphuta(Female)</asp:ListItem>
       <asp:ListItem>Beeja sphuta(Male)</asp:ListItem>
       <asp:ListItem>Manglik Dosha</asp:ListItem>
       <asp:ListItem>Paap Samya</asp:ListItem>
       <asp:ListItem>22nd Drekkana</asp:ListItem>
       <asp:ListItem>64th Navamsha</asp:ListItem>
       </asp:DropDownList> 
   </td>
   <td>
   <asp:LinkButton ID="som" class="per_btn" runat="server" style="width:120px;">Search On Main</asp:LinkButton>
   </td>
 <td style="display:none">
<asp:Label ID="labchart" runat="server" Text="Chart"></asp:Label>
</td><td style="display:none">
<asp:DropDownList ID="chart" CssClass="drpo_homenew" runat="server"></asp:DropDownList>        
 </td>
 ...
 <div  style="width:976px;height:auto; text-align:center;color:#034A86;">
           <asp:Label ID="qry" runat="server" Text="" font-color="#034A86" font-weight="600" font-family="Open Sans" font-size="13px" ></asp:Label></div>

 <div class="divhorary" >
    <div class="loadingimage" id="img1"  runat ="server"  style=" display:none;">
    <img src="Image/preloader_transparent.gif" alt="hello"/>
 </div>  
    <div id="Divgrid1" class="horary_combination_css" style="border: 1px solid #7DAAE3;" >
    <table >
    <tr>
    <td runat="server" id="hdsviewgrid" style="width:468px;" align="left"></td>
    </tr>
    </table></div>
    
    
    <span id="Label6" style="color: Black; font-size: small; font-weight: bold; width: 34px; margin:5px; margin-left: 180px;"></span>
     <div id="Divgrid2" class="horary_combination_css" style="border: 1px solid #7DAAE3;" >
    <table >
    <tr>
...
<div id="vargasdiv" runat="server" style="float:left; width:50%;" >

 <div class="columnd01hc" id="rashiidd01" >
...
<%--   <div class="menu_mainf"  >
   ...
   <input type="hidden" runat="server" id="Hiddencons" />
    <input type="hidden" runat="server" id="Hidden5d01" />
        <input type="hidden" runat="server" id="hdn22nd" />
        <input type="hidden" runat="server" id="hdn64th" />
    </form>
</body>
</html>
