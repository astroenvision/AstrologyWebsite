<%@ Page Language="C#" AutoEventWireup="true" CodeFile="compatibilitymatching.aspx.cs" Inherits="compatibilitymatching" EnableEventValidation="false" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="javascript/compatibilitymatching.js"></script>
                    ...
                    <div class="col-sm-9">
                        <div class="accntsec">
                            <header class="section-header">
                                <h3 id="headingh1" runat="server">Enter Birth Details</h3>
                            </header>
                            <div class="row">
                                ...
                                <div class="col-sm-12 form-group">
                                    ...
                                    <div class="tnc-desc" style="color: red; font-size: 1.2em;">*&nbsp;Please Do Not Refresh or close the Current Page..for a while as your Reports are in process.</div>
                                </div>
                            ...
                            <div class="mt-3 text-center">
                                ...
                                <asp:Button ID="submit" runat="server" CssClass="kwm-btn-lg" Text="Next >>" />
                            </div>
                        </div>
                    </div>
                </div>
