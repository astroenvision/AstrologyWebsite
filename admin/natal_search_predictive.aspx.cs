...
public partial class admin_natal_search_predictive : System.Web.UI.Page
{
    ...
    protected void grdviews_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                btnedit.NavigateUrl = ResolveUrl("~/admin/natal_update_predictive.aspx?table=" + TableName + "&autoid=" + lblautoid.Text.Trim() + "");
