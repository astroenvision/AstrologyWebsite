...
public partial class admin_AstrologerDetails : System.Web.UI.Page
{
    ...
    protected void btnsendmail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["Curtbl"] != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (result == "SENT")
                    {
                        ScriptManager.RegisterClientScriptBlock(this, typeof(admin_AstrologerDetails), "wq", "alert('Mail has been sent successfully.');", true);
                        return;
                    }
                    else
                    {
                        ScriptManager.RegisterClientScriptBlock(this, typeof(admin_AstrologerDetails), "wq", "alert('Mail has not been sent successfully. Try Again');", true);
                        return;
                    }
                }
            }
        ...
        catch (Exception ex)
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, typeof(admin_AstrologerDetails), "wq", "alert('Failure sending mail. Try Again');", true);
            return;
        }
    }
    void bind_userdetails()
    {
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                int iEndRecord = grdviews.PageSize * (grdviews.PageIndex + 1);
                int iStartsRecods = iEndRecord - grdviews.PageSize;
                ...
                divTotalRcords.InnerHtml = " <font color=\"#495057\" >Records <font size=\"3\" color=\"red\">" + iStartsRecods + "</font> TO <font size=\"3\" color=\"red\">" + iEndRecord.ToString() + "</font> Of <font size=\"3\" color=\"red\">" + iTotalRecords.ToString() + "</font> .</font>";
            ...
            {
                divTotalRcords.InnerHtml = "Search Found  <font size=\"3\" color=\"red\">0</font> result(s).";
                ds = null;
                grdviews.DataSource = ds;
                grdviews.DataBind();
            }
    ...
    protected void grdviews_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        if (Validity_Val == "0")
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(admin_AstrologerDetails), "wq", "alert('Please select any validity!');", true);
            return;
        }
        if (Status_Val == "0")
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(admin_AstrologerDetails), "wq", "alert('Please select any status!');", true);
            return;
        }
