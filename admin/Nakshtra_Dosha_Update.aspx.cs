...
public partial class admin_Nakshtra_Dosha_Update : System.Web.UI.Page
{
    #region Declarations
    admin obj = new admin();
    ...
    protected void LoadData(string Id)
    {
        ...
        ds = obj.GetAshtakootPredictive("Nakashtra_Dosha", Id, "", "");
    ...
    protected void btnUpdate_click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Nakshtra_Dosha_Update), "wq", "alert('Enter Predictive!');", true);
            return;
        }
        ds = obj.UpdateNakashtraDosha("Update_Nakashtra_Dosha", lblID.Text, fckPredictive.Value, fckRemedial.Value , rteDefinition.Value, fckExpertOpinion.Value,
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (STATUS == "1")
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Nakshtra_Dosha_Update), "wq", "alert(' " + Message + "');", true);
                LoadData(lblID.Text);
            }
            else
            {
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Nakshtra_Dosha_Update), "wq", "alert('Some Error Occured');", true);
            }
        }
        else
        {
