<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Manglik_Dosha_Update.aspx.cs" Inherits="admin_Manglik_Dosha_Update" %>
     ...
     <div class="right_col" role="main">
        <div class="page-title">
            <div class="title_left">
                <h3>Update Manglik Dosha Predictive</h3>
            </div>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Manglik Dosha Boy</label>
                            <asp:Label ID="lblID" runat="server" Visible="false"></asp:Label>
                            <asp:TextBox runat="server" ID="txtManglikDoshaBoy" CssClass="form-control" Enabled="false" ></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Manglik Dosha Girl</label>
                            <asp:TextBox runat="server" ID="txtManglikDoshaGirl" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Predictive For</label>
                            <asp:TextBox runat="server" ID="txtPredictiveFor" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Manglik Dosha For</label>
                            <asp:TextBox runat="server" ID="txtManglikDoshaFor" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                          <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Predictive Type</label>
                            <asp:TextBox runat="server" ID="txtPredictiveType" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                           <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Is Match</label>
                            <asp:TextBox runat="server" ID="txtIsMatch" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                         <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Chart No</label>
                            <asp:TextBox runat="server" ID="txtChartNo" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                        ...
                        <div class="col-md-12  form-group has-feedback">
                            ...
                            <FCKeditorV2:FCKeditor ID="rteQuestion" runat="server" BasePath="~/fckeditor/" Height="300"></FCKeditorV2:FCKeditor>
                        </div>
                        <div class="col-md-12  form-group has-feedback">
