<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Nakshtra27th_Dosha_Update.aspx.cs" Inherits="admin_Nakshtra27th_Dosha_Update" %>
      ...
      <div class="right_col" role="main">
        <div class="page-title">
            <div class="title_left">
                <h3>Update Nakshtra 27th Dosha</h3>
            </div>
            ...
            <div class="col-md-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Girl Rashi</label>
                            <asp:TextBox runat="server" ID="txtGirlRashi" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Boy Rashi</label>
                            <asp:TextBox runat="server" ID="txtBoyRashi" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
