<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Dashamsha_Search.aspx.cs" Inherits="admin_Dashamsha_Search" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Dashamsha Predictive<small></small></h3>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="DEITY" HeaderText="DEITY" HeaderStyle-Width="115" />
                                              <asp:TemplateField HeaderText="PRE PREDICTIVE" Visible="true">
                                                ...
                                                <asp:BoundField DataField="DIRECTION" HeaderText="DIRECTION" HeaderStyle-Width="115" />
                                                <asp:BoundField DataField="RULING_PLANET" HeaderText="RULING PLANET" HeaderStyle-Width="115" />
                                                ...
                                                <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Dashamsha_Update.aspx?q=" + Eval("AUTO_ID") %>'
