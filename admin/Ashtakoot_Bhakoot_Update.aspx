<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Ashtakoot_Bhakoot_Update.aspx.cs" Inherits="admin_Ashtakoot_Bhakoot_Update" %>
     ...
     <div class="right_col" role="main">
        <div class="page-title">
            <div class="title_left">
                <h3>Update Bhakoot Predictive</h3>
            </div>
            ...
            <div class="col-md-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Rashi Difference</label>
                            <asp:TextBox runat="server" ID="txtRashiDiff" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Bhakoot Type</label>
                            <asp:TextBox runat="server" ID="txtBhakootType" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                         <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Bhakoot Description</label>
                            <asp:TextBox runat="server" ID="txtBhakootDescription" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
