...
public partial class admin_TestimonialsList : System.Web.UI.Page
{
    #region Declarations
    admin obj = new admin();
    ...
    protected void BindGrid()
    {
        ...
        ds = obj.GetDashboardDetailsNew("GET_TESTIMONIALS", txtUserName.Text, "", "", "",ddlSortColumn.SelectedValue,ddlSortBy.SelectedValue,"", Month);
