...
public partial class admin_Ashtakoot_Gana_Update : System.Web.UI.Page
{
    #region Declarations
    admin obj = new admin();
    ...
    protected void LoadData(string Id)
    {
        ...
        ds = obj.GetAshtakootPredictive("Gaana_Predictive", Id,"","");
        if (ds.Tables[0].Rows.Count > 0)
        {
            txtGanaPoints.Text = ds.Tables[0].Rows[0]["GANA_POINT"].ToString();
            ...
            txtGanaPointException.Text = ds.Tables[0].Rows[0]["GANA_POINT_EXCEPTION"].ToString();
    ...
    protected void btnUpdate_click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Gana_Update), "wq", "alert('Enter Predictive!');", true);
            return;
        }
        ds = obj.UpdateGanaPredictive("Update_Gana_Predictive", lblID.Text, rteDefinition.Value, fckPredictive.Value, fckRemedial.Value ,fckExpertOpinion.Value , 
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (STATUS == "1")
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Gana_Update), "wq", "alert(' " + Message + "');", true);
                LoadData(lblID.Text);
            }
            else
            {
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Gana_Update), "wq", "alert('Some Error Occured');", true);
            }
        }
        else
        {
