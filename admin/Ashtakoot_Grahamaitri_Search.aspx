<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Ashtakoot_Grahamaitri_Search.aspx.cs" Inherits="admin_Ashtakoot_Grahamaitri_Search" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Grahamaitri Predictive<small></small></h3>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True"  AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="GRAHAMAITRI_POINT" HeaderText="GRAHAMAITRI POINT" HeaderStyle-Width="130" />
                                                 ...
                                                 <asp:BoundField DataField="POINT_EXCEPTION" HeaderText="POINT EXCEPTION" HeaderStyle-Width="200" />
                                                 ...
                                                 <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Ashtakoot_Grahamaitri_Update.aspx?q=" + Eval("ID") %>'
