<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Ashtakoot_Bhakoot_Search.aspx.cs" Inherits="admin_Ashtakoot_Bhakoot_Search" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Bhakoot Predictive<small></small></h3>
                        </div>
                    </div>
                    ...
                    <div class="row" style="display: block;">
                        ...
                        <div class="col-md-12 col-sm-12  ">
                            <div class="x_panel">
                                 <div class="x_title">
                                     <div class="col-md-4">
                                        <asp:dropdownlist ID="ddlBhakootType" runat="server" CssClass="form-control">  
                                            <asp:ListItem Value="-1" Selected="True">Select Bhakoot Type</asp:ListItem>
                                        </asp:dropdownlist>
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True"  AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="GIRLRASHI" HeaderText="GIRL RASHI" />
                                                <asp:BoundField DataField="BoyRashi" HeaderText="BOY RASHI" />
                                                 <asp:BoundField DataField="POINTS" HeaderText="POINTS" />
                                                 <asp:BoundField DataField="RASHI_DIFF" HeaderText="RASHI DIFFERENCE" />
                                                 <asp:BoundField DataField="BHAKOOT_DESC" HeaderText="BHAKOOT DESCRIPTION" />
                                                 ...
                                                 <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Ashtakoot_Bhakoot_Update.aspx?q=" + Eval("ID") %>'
