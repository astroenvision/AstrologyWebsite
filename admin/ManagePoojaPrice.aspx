<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="ManagePoojaPrice.aspx.cs" Inherits="admin_ManagePoojaPrice" %>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <label class="required" style="font-size: 14px; color: #555; font-weight: bold;">No Of Pandit</label>
                                    <asp:TextBox runat="server" ID="txtNoOfPandit" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqNoOfPandit" runat="server" ControlToValidate="txtNoOfPandit" CssClass="validator" Display="Dynamic"
                                        ErrorMessage="Enter No Of Pandit" SetFocusOnError="True" ValidationGroup="save"></asp:RequiredFieldValidator>
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <asp:GridView ID="grdData" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging" OnRowCommand="grdData_RowCommand"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="ID" Visible="false">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Server.HtmlEncode(DataBinder.Eval (Container.DataItem, "POOJA_PRICE_ID").ToString()) %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="NO_OF_PANDIT" HeaderText="NO OF PANDIT" />
                                            <asp:BoundField DataField="POOJA_PRICE_INR" HeaderText="PRICE INR" />
                                            ...
                                            <asp:BoundField DataField="POOJA_PRICE_USD" HeaderText="PRICE USD" />
                                            ...
                                            <asp:BoundField DataField="TOTAL_AMOUNT_USD" HeaderText="FINAL PRICE USD" />
                                              <asp:BoundField DataField="PRIORITY" HeaderText="PRIORITY" />
                                               <asp:TemplateField HeaderText="&nbsp; <span class='fa fa-wrench'></span>">
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEdit" runat="server"  title="Edit" CommandName="EditPrice" Style="line-height: 0.65;"
                                                        CommandArgument='<%# Bind("POOJA_PRICE_ID") %>'><i  class="fa fa-pencil-square-o" aria-hidden="true"></i></asp:LinkButton>
