<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Nakshtra_Dosha_Update.aspx.cs" Inherits="admin_Nakshtra_Dosha_Update" %>
     ...
     <div class="right_col" role="main">
        <div class="page-title">
            <div class="title_left">
                <h3>Update Nakshtra Dosha Predictive</h3>
            </div>
                    ...
                    <div class="x_content">
                        ...
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                         ...
                         <div class="col-md-2 col-sm-6  form-group has-feedback">
                            ...
                            <asp:TextBox runat="server" ID="txtStatus" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                           <div class="col-md-2 col-sm-6  form-group has-feedback">
