<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="FreeUserList.aspx.cs" Inherits="admin_FreeUserList" EnableEventValidation="false" ValidateRequest="false" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Free User List<small></small></h3>
                        </div>
                    </div>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            CssClass="table table-striped jambo_table bulk_action" HeaderStyle-CssClass="headings"  OnRowCommand="grdData_RowCommand"
                                            HeaderStyle-BackColor="#f25e0a" HeaderStyle-ForeColor="White" PageSize="30">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="<span><i class='fa fa-eye' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkViewReport" runat="server" NavigateUrl='<%# "~/freehoroscope_report.aspx?userid=" + Eval("ID") + "&useremailid=" + Eval("EMAILID") + "&flag=vargas"  %>'
                                                            title="View Report" Target="_blank" Font-Size="1.4em"><i  class="fa fa-eye" aria-hidden="true"></i></asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Show Chart</span>">
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="15"></HeaderStyle>
                                                    <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center"></ItemStyle>
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkallchart" runat="server" NavigateUrl='<%# "~/AllDynamicCharts.aspx?userid=" + Eval("ID") + "&useremailid=" + Eval("EMAILID") + "&flag=vargas"  %>'
                                                            title="View Chart" Target="_blank" Font-Size="1.4em"><i  class="fa fa-eye" aria-hidden="true"></i></asp:HyperLink>
                                                        <asp:HyperLink ID="lnkvargas" runat="server" NavigateUrl='<%# "~/Test.aspx?userid=" + Eval("ID") + "&useremailid=" + Eval("EMAILID") + "&flag=vargas"  %>'
                                                            title="View Chart" Target="_blank" Font-Size="1.2em">Vargas</asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
