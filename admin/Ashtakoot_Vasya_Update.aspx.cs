...
public partial class admin_Ashtakoot_Vasya_Update : System.Web.UI.Page
{
    #region Declarations
    admin obj = new admin();
    ...
    protected void LoadData(string Id)
    {
        ...
        ds = obj.GetAshtakootPredictive("Vasya_Predictive", Id,"","");
        if (ds.Tables[0].Rows.Count > 0)
        {
            txtVasyaPoints.Text = ds.Tables[0].Rows[0]["VASYA_POINT"].ToString();
            ...
            txtVasyaPointException.Text = ds.Tables[0].Rows[0]["VASYA_POINT_EXCEPTION"].ToString();
    ...
    protected void btnUpdate_click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Vasya_Update), "wq", "alert('Enter Predictive!');", true);
            return;
        }
        ds = obj.UpdateVasyaPredictive("Update_Vasya_Predictive", lblID.Text, rteDefinition.Value, fckPredictive.Value, fckRemedial.Value, fckExpertOpinion.Value,
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (STATUS == "1")
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Vasya_Update), "wq", "alert(' " + Message + "');", true);
                LoadData(lblID.Text);
            }
            else
            {
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Vasya_Update), "wq", "alert('Some Error Occured');", true);
            }
        }
        else
        {
