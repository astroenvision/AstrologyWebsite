<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Ashtakoot_Varna_Search.aspx.cs" Inherits="admin_Ashtakoot_Varna_Search" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Varna Predictive<small></small></h3>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True"  AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="VARNA_POINT" HeaderText="VARNA POINT" HeaderStyle-Width="130" />
                                                 ...
                                                 <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Ashtakoot_Varna_Update.aspx?q=" + Eval("ID") %>'
