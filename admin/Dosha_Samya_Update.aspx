<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Dosha_Samya_Update.aspx.cs" Inherits="admin_Dosha_Samya_Update" %>
     ...
     <div class="right_col" role="main">
        <div class="page-title">
            <div class="title_left">
                <h3>Update Dosha Samya Predictive</h3>
            </div>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Dosha Samya Boy</label>
                            <asp:Label ID="lblID" runat="server" Visible="false"></asp:Label>
                            <asp:TextBox runat="server" ID="txtDoshaSamyaBoy" CssClass="form-control" Enabled="false" ></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Dosha Samya Girl</label>
                            <asp:TextBox runat="server" ID="txtDoshaSamyaGirl" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                        ...
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Dosha Samya For</label>
                            <asp:TextBox runat="server" ID="txtDoshaSamyaFor" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                          <div class="col-md-2 col-sm-6  form-group has-feedback">
