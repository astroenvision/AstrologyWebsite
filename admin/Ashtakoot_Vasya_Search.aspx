<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Ashtakoot_Vasya_Search.aspx.cs" Inherits="admin_Ashtakoot_Vasya_Search" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Vasya Predictive<small></small></h3>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True"  AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="VASYA_POINT" HeaderText="VASYA POINT" HeaderStyle-Width="130" />
                                                 ...
                                                 <asp:BoundField DataField="VASYA_POINT_EXCEPTION" HeaderText="VASYA POINT EXCEPTION" HeaderStyle-Width="200" />
                                                 ...
                                                 <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Ashtakoot_Vasya_Update.aspx?q=" + Eval("ID") %>'
