...
public partial class admin_Ashtakoot_Yoni_Update : System.Web.UI.Page
{
    #region Declarations
    admin obj = new admin();
    ...
    protected void LoadData(string Id)
    {
        ...
        ds = obj.GetAshtakootPredictive("Yoni_Predictive", Id,"","");
        if (ds.Tables[0].Rows.Count > 0)
        {
            txtYoniPoints.Text = ds.Tables[0].Rows[0]["YONI_POINT"].ToString();
            ...
            txtYoniPointException.Text = ds.Tables[0].Rows[0]["YONI_POINT_EXCEPTION"].ToString();
    ...
    protected void btnUpdate_click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Yoni_Update), "wq", "alert('Enter Predictive!');", true);
            return;
        }
        ds = obj.UpdateYoniPredictive("Update_Yoni_Predictive", lblID.Text, rteDefinition.Value, fckPredictive.Value , fckRemedial.Value , fckExpertOpinion.Value , 
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (STATUS == "1")
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Yoni_Update), "wq", "alert(' " + Message + "');", true);
                LoadData(lblID.Text);
            }
            else
            {
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Yoni_Update), "wq", "alert('Some Error Occured');", true);
            }
        }
        else
        {
