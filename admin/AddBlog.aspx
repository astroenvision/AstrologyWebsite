<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="AddBlog.aspx.cs" Inherits="admin_AddBlog" EnableEventValidation="false" ValidateRequest="false" %>
                        ...
                        <div class="x_content">
                            <div class="form-label-left input_mask">
                                ...
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <asp:Label runat="server" ID="lblBlogID" Visible="false"></asp:Label>
                                   ...
                                   <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <label class="required" style="font-size: 14px; color: #555; font-weight: bold;">Heading</label>
                                    <asp:TextBox runat="server" ID="txtHeading" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqHeading" runat="server" ControlToValidate="txtHeading" CssClass="validator" Display="Dynamic"
                                        ErrorMessage="Enter Heading" SetFocusOnError="True" ValidationGroup="save"></asp:RequiredFieldValidator>
                                </div>
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                ...
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <label style="font-size: 14px; color: #555; font-weight: bold;">Sub Title</label>
                                    <asp:TextBox runat="server" ID="txtSubTitle" CssClass="form-control"></asp:TextBox>
                               </div>

                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <label class="required" style="font-size: 14px; color: #555; font-weight: bold;">Summary</label>
                                    <asp:TextBox runat="server" ID="txtSummary" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqSummary" runat="server" ControlToValidate="txtSummary" CssClass="validator" Display="Dynamic"
                                        ErrorMessage="Enter Summary" SetFocusOnError="True" ValidationGroup="save"></asp:RequiredFieldValidator>
                                </div>
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                ...
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <label class="required" style="font-size: 14px; color: #555; font-weight: bold;">Written By</label>
                                    <asp:TextBox runat="server" ID="txtWrittenBy" CssClass="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqWrittenBy" runat="server" ControlToValidate="txtWrittenBy" CssClass="validator" Display="Dynamic"
                                        ErrorMessage="Enter Written By" SetFocusOnError="True" ValidationGroup="save"></asp:RequiredFieldValidator>
                                </div>
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                    <label class="required" style="font-size: 14px; color: #555; font-weight: bold;">Blog URL</label>
                                    <asp:TextBox runat="server" ID="txtBlogURL" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtBlogURL_TextChanged"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqBlogURL" runat="server" ControlToValidate="txtBlogURL" CssClass="validator" Display="Dynamic"
                                        ErrorMessage="Enter Blog URL" SetFocusOnError="True" ValidationGroup="save"></asp:RequiredFieldValidator>
                                </div>
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                ...
                                <div class="col-md-12 col-sm-12 form-group">
                                    ...
                                    <FCKeditorV2:FCKeditor ID="fckDesc" runat="server" BasePath="~/fckeditor/" Height="400"></FCKeditorV2:FCKeditor>
                                    <%--      <asp:RequiredFieldValidator ID="reqDescription" runat="server" ControlToValidate="fckDesc" CssClass="validator" Display="Dynamic"
                                      ErrorMessage="Enter Description" SetFocusOnError="True" ValidationGroup="save"></asp:RequiredFieldValidator>--%>
                                </div>
