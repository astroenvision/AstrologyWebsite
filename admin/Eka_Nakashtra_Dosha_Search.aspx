<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Eka_Nakashtra_Dosha_Search.aspx.cs" Inherits="admin_Eka_Nakashtra_Dosha_Search" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Eka Nakashtra Dosha Predictive<small></small></h3>
                        </div>
                    </div>
                                        ...
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True"  AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="BOY_CONSTELLATION" HeaderText="BOY CONSTELLATION" />
                                                 <asp:BoundField DataField="GIRL_CHARAN" HeaderText="GIRL CHARAN" />
                                                 <asp:BoundField DataField="BOY_CHARAN" HeaderText="BOY CHARAN" />
                                                 <asp:BoundField DataField="MATCH" HeaderText="MATCH" />
                                                 <asp:BoundField DataField="GIRL_BOY_CHARAN" HeaderText="GIRL BOY CHARAN" />
                                                 ...
                                                 <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Eka_Nakashtra_Dosha_Update.aspx?q=" + Eval("ID") %>'
