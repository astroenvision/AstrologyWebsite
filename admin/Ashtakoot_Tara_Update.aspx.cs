...
public partial class admin_Ashtakoot_Tara_Update : System.Web.UI.Page
{
    #region Declarations
    admin obj = new admin();
    ...
    protected void LoadData(string Id)
    {
        ...
        ds = obj.GetAshtakootPredictive("Tara_Predictive", Id,"","");
        if (ds.Tables[0].Rows.Count > 0)
        {
            txtTaraPoints.Text = ds.Tables[0].Rows[0]["TARA_POINT"].ToString();
    ...
    protected void btnUpdate_click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Tara_Update), "wq", "alert('Enter Predictive!');", true);
            return;
        }
        ds = obj.UpdateTaraPredictive("Update_Tara_Predictive", lblID.Text, rteDefinition.Value, fckPredictive.Value, fckRemedial.Value, fckExpertOpinion.Value,
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (STATUS == "1")
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Tara_Update), "wq", "alert(' " + Message + "');", true);
                LoadData(lblID.Text);
            }
            else
            {
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Tara_Update), "wq", "alert('Some Error Occured');", true);
            }
        }
        else
        {
