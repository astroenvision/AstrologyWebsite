<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="FreeMatchingUser.aspx.cs" Inherits="admin_FreeMatchingUser" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Free Kundli Matching<small></small></h3>
                        </div>
                    </div>
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="USER ID" Visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblBOYID" runat="server" Text='<%# Server.HtmlEncode(DataBinder.Eval (Container.DataItem, "BOYID").ToString()) %>'></asp:Label>
                                                        <asp:Label ID="lblGIRLID" runat="server" Text='<%# Server.HtmlEncode(DataBinder.Eval (Container.DataItem, "GIRLID").ToString()) %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="NAME" HeaderText="USER NAME" />
                                                <asp:BoundField DataField="MATCH_WITH" HeaderText="MATCH WITH" />
                                                ...
                                                <asp:TemplateField HeaderText="<span><i class='fa fa-eye' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkViewReport" runat="server" NavigateUrl='<%# "~/freecompatibilitymatchingreport.aspx?BoyId=" + Eval("BOYID") + "&GirlId=" + Eval("GIRLID")  %>'
