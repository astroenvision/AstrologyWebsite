...
public partial class admin_Nakshtra_Dosha_Search : System.Web.UI.Page
{
    #region Declarations
    admin obj = new admin();
    ...
    {
        DataSet ds = new DataSet();
        ds = obj.GetAshtakootPredictive("Nakashtra_Dosha_By_Search", "", ddlGirlConstellation.SelectedValue, ddlBoyConstellation.SelectedValue);
        if (ds.Tables[0].Rows.Count > 0)
        {
