<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="ManagePredictive.aspx.cs" Inherits="admin_ManagePredictive" ValidateRequest="false" EnableEventValidation="false" %>
                    ...
                    <div class="row" style="display: block;">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <asp:DropDownList ID="ddlstatus" runat="server" AutoPostBack="true" CssClass="form-control">
                                           ...
                                           <asp:ListItem Value="A" Text="Show" Selected="True"></asp:ListItem>
                                ...
                                <div class="x_title">
                                    <div class="col-md-2">
                                        <asp:Label runat="server" Font-Bold="true">Checked:</asp:Label>
                                        <asp:DropDownList ID="ddlchecked" runat="server" AutoPostBack="true" CssClass="form-control">
                                        <asp:ListItem Value="" Text="--All--" Selected="True"></asp:ListItem>
                                    ...
                                    <div class="col-md-2">
                                        <asp:Label runat="server" Font-Bold="true">Sorting By:</asp:Label>
                                        <asp:DropDownList ID="ddlsortcolumn" runat="server" AutoPostBack="true" CssClass="form-control">
                                        <asp:ListItem Value="MOD_DATE" Text="Modify Date"></asp:ListItem>
                                        <asp:ListItem Value="AUTO_ID" Text="Predictive Id"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-md-2">
                                        <asp:Label runat="server" Font-Bold="true">Sorting Order:</asp:Label>
                                        <asp:DropDownList ID="ddlsortorder" runat="server" AutoPostBack="true" CssClass="form-control">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            CssClass="table table-striped jambo_table bulk_action" HeaderStyle-CssClass="headings" PageSize="50" HeaderStyle-BackColor="#f25e0a" HeaderStyle-ForeColor="White" OnRowDataBound="grdviews_RowDataBound">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Type" Visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HiddenField ID="hdnpredictivetype" runat="server" Value='<%# Bind("PREDICTIVE_TYPE")%>' />
                                                ...
                                                <asp:TemplateField HeaderText="Mod Date" Visible="false">
                                                    ...
                                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbldate" runat="server" Text='<%# Bind("MODIFY_DATE")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
