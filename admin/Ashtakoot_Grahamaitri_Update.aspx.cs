...
public partial class admin_Ashtakoot_Grahamaitri_Update : System.Web.UI.Page
{
    #region Declarations
    admin obj = new admin();
    ...
    protected void LoadData(string Id)
    {
        ...
        ds = obj.GetAshtakootPredictive("Grahamaitri_Predictive", Id,"","");
        if (ds.Tables[0].Rows.Count > 0)
        {
            txtGrahamaitriPoints.Text = ds.Tables[0].Rows[0]["GRAHAMAITRI_POINT"].ToString();
            ...
            txtPointException.Text = ds.Tables[0].Rows[0]["POINT_EXCEPTION"].ToString();
    ...
    protected void btnUpdate_click(object sender, EventArgs e)
    {
        ...
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Grahamaitri_Update), "wq", "alert('Enter Predictive!');", true);
            return;
        }
        ds = obj.UpdateGrahamaitriPredictive("Update_Grahamaitri_Predictive", lblID.Text, rteDefinition.Value, fckPredictive.Value,fckRemedial.Value, fckExpertOpinion.Value,
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            if (STATUS == "1")
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Grahamaitri_Update), "wq", "alert(' " + Message + "');", true);
                LoadData(lblID.Text);
            }
            else
            {
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_Ashtakoot_Grahamaitri_Update), "wq", "alert('Some Error Occured');", true);
            }
        }
        else
        {
