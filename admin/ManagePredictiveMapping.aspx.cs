...
public partial class admin_ManagePredictiveMapping : System.Web.UI.Page
{
    ...
    protected void grdData_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                btnedit.NavigateUrl = ResolveUrl("~/admin/UpdatePredictiveMapping.aspx?table=" + TableName + "&autoid=" + lblautoid.Text.Trim() + "");
    ...
    void bindgridnews()
    {
        try
        {
            ...
            DataSet ds = ad_obj.Get_Natal_Search_Predictives(txtpredictive.Text.Trim(), "~", TableName, KeystringVal.ToUpper(), LogicVal.ToUpper(), PredictiveTypeVal, PredictiveForVal, "", "","", "", "GET");
            if (ds.Tables[0].Rows.Count > 0)
            {
