...
public partial class admin_UpdatePredictiveMapping : System.Web.UI.Page
{
    ...
    {
        Ajax.Utility.RegisterTypeForAjax(typeof(admin_UpdatePredictiveMapping));
            ...
            if (Session["AdminUserId"] != null)
            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (Request["table"] != null && Request["table"].ToString() != "")
                    {
                        ...
                        ddltable.SelectedValue = Request["table"].ToString().Trim();
                        bindgridnews();
                        //bind_books(); --Deepak Comment this on 10/08/2020
                    }
                }
            }
            else
    ...
    {
        DataSet ds = cs_obj.Bind_Natal_Category();
        if (ds.Tables[0].Rows.Count > 0)
        {
            ddlcategory.Items.Clear();
            ddlcategory.DataSource = ds;
            ddlcategory.DataTextField = "CATEGORY_NAME_ID";
    ...
    protected void ddlcategory_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            ds.Dispose();
            ddlquestion_SelectedIndexChanged(sender, e);
        }
    }
    ...
    protected void btninsert_Click(object sender, EventArgs e)
    {
        try
        {
            for (Int32 I32Counter = 0; I32Counter < grdData.Rows.Count; I32Counter++)
            {
                ...
                Label lbllogic = (Label)(grdData.Rows[I32Counter].FindControl("lbllogic"));
                ...
                Label lblhouse = (Label)(grdData.Rows[I32Counter].FindControl("lblhouse"));
                Label lblplanet = (Label)(grdData.Rows[I32Counter].FindControl("lblplanet"));
                Label lblrashi = (Label)(grdData.Rows[I32Counter].FindControl("lblrashi"));
                ...
                Label lblcombination = (Label)(grdData.Rows[I32Counter].FindControl("lblcombination"));
                Label lbllagnarashi = (Label)(grdData.Rows[I32Counter].FindControl("lbllagnarashi"));
                Label lbluniqueid = (Label)(grdData.Rows[I32Counter].FindControl("lbluniqueid"));
                Label lblbook = (Label)(grdData.Rows[I32Counter].FindControl("lblbook"));

                Label lblpredictivetype = (Label)(grdData.Rows[I32Counter].FindControl("lblpredictivetype"));
                ...
                if (cbRows.Checked == true)
                {
                    ...
                    string housevalnew = "", planetvalnew = "", rashivalnew = "", filtervalnew = "", descvalnew = "",Flag="",
                    ...
                    {
                        ScriptManager.RegisterClientScriptBlock(this, typeof(admin_UpdatePredictiveMapping), "wq", "alert('Please select any question!');", true);
                        return;
                    }
                    ...
                    if (TableName == "LAGNA_MST")
                    {
                        Flag = "MAP_LAGNA_PREDICTIVE_TO_OTHER_CATEGORIES";
                    }
                    else
                    {
                        Flag = "INSERT";
                    ...
                    {
                        ScriptManager.RegisterClientScriptBlock(this, typeof(admin_UpdatePredictiveMapping), "wq", "alert('Please select any keystring/filter!');", true);
                        return;
                    }
                    ...
                    {
                        ScriptManager.RegisterClientScriptBlock(this, typeof(admin_UpdatePredictiveMapping), "wq", "alert('Please select predictive type!');", true);
                        return;
                    }
                    ...
                    if (predictivenew != "")
                    {
                        dsinp = ad_obj.Insert_Natal_Predictives(lblhouse.Text, lblplanet.Text, lblrashi.Text, lblkeystring.Text, lbllogic.Text, "", "", subbookval, "", lbluniqueid.Text, "", "", TableName, Flag, housevalnew, planetvalnew, rashivalnew, filtervalnew, descvalnew, namevalnew, chartvalnew, predictivenew, remedialnew, uniqueidvalnew, combination, lbllagnarashi.Text, predictivetypeval, int.Parse(lblautoid.Text),"","","", AdminUserId, "");
            ...
            if (flagcheck == false)
            {
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_UpdatePredictiveMapping), "wq", "alert('Please check any checkbox!');", true);
                return;
            }
            if (flagcheck == true)
            {
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_UpdatePredictiveMapping), "wq", "alert('Data Mapped Successfully!');", true);
                return;
            }
        }
        catch (Exception ex)
        ...
        try
        {
            for (Int32 I32Counter = 0; I32Counter < grdData.Rows.Count; I32Counter++)
            {
                ...
                if (cbRows.Checked == true)
                {
                    ...
                    string IsMapped = ddlismapped.SelectedValue.ToString();
                    if (IsMapped == "0")
                    {
                        IsMapped = "";
                    }
                    dspu = ad_obj.Insert_Natal_Predictives("HouseNone", "PlanetNone", "RashiNone", lblkeystring.Text, "Logic", "Name", "Chart", "Subbook", "Page", lbluniqueid.Text, rtepredictive, rteremedial, TableName, "UPDATE_AFTER_MAPPING", "HouseNew", "PlanetNew", "RashiNew", "FilterNew", "LogicNew", "NameNew", "ChartNew", "PredictiveNew", "RemedialNew", "UniqueidNew", "Combination", "LagnaRashi", PreType, int.Parse(lblautoid.Text.ToString()), txtmappedcategories.Text, IsMapped, "","","");
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_UpdatePredictiveMapping), "wq", "alert('Data Update Successfully!');", true);
                return;
            }
        }
        catch (Exception ex)
    ...
    protected void btndelete_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (flagcheck == true && ResultUpdateVal == "Y")
            {
                ScriptManager.RegisterClientScriptBlock(this, typeof(admin_UpdatePredictiveMapping), "wq", "alert('Data Delete Successfully!');", true);
                bindgridnews();
    ...
    void bindgridnews()
    {
        try
        {
            if (Request["table"] != null && Request["table"].ToString() != "")
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    txtmappedcategories.Text = ds.Tables[0].Rows[0]["MAPPING_CATEGORY"].ToString().Trim();
                    ddlismapped.SelectedValue= ds.Tables[0].Rows[0]["ISMAPPED"].ToString().Trim();
                    ddlpredictivetype.SelectedValue = ds.Tables[0].Rows[0]["PREDICTIVE_TYPE"].ToString().Trim();
