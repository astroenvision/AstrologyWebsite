<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Vaisheshikamsha_Search.aspx.cs" Inherits="admin_Vaisheshikamsha_Search" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Vaisheshikamsha Predictive<small></small></h3>
                        </div>
                    </div>
                                        ...
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="ID">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblID" runat="server" Text='<%# Server.HtmlEncode(DataBinder.Eval (Container.DataItem, "AUTO_ID").ToString()) %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="VARGAS_AMSA_NAME" HeaderText="VARGAS AMSA NAME" HeaderStyle-Width="115" />
                                              <asp:TemplateField HeaderText="PRE PREDICTIVE" Visible="true">
                                                    ...
                                                    <ItemTemplate>
                                                        <FCKeditorV2:FCKeditor ID="rtepredictive" ToolbarSet="Standard" runat="server" BasePath="~/fckeditor/" Width="350px"
                                                            Height="200px" Value='<%# Bind("PRE_PREDICTIVE")%>'>
                                                        </FCKeditorV2:FCKeditor>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="VARGAS_NAME" HeaderText="VARGAS NAME " HeaderStyle-Width="115" />
                                                <asp:BoundField DataField="PREDICTIVE_FLAG" HeaderText="PREDICTIVE FLAG" HeaderStyle-Width="115" />
                                                <asp:BoundField DataField="PRIORITY" HeaderText="PRIORITY" HeaderStyle-Width="175" />
                                                ...
                                                <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Vaisheshikamsha_Update.aspx?q=" + Eval("AUTO_ID") %>'
