<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Manglik_Dosha_Search.aspx.cs" Inherits="admin_Manglik_Dosha_Search" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Manglik Dosha Predictive<small></small></h3>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="MANGLIK_DOSHA_BOY" HeaderText="MANGLIK DOSHA BOY" HeaderStyle-Width="115" />
                                                  <asp:BoundField DataField="MANGLIK_DOSHA_GIRL" HeaderText="MANGLIK DOSHA GIRL" HeaderStyle-Width="115" />
                                              <asp:TemplateField HeaderText="PREDICTIVE" Visible="true">
                                                    ...
                                                    <ItemTemplate>
                                                        <FCKeditorV2:FCKeditor ID="rtepredictive" ToolbarSet="Standard" runat="server" BasePath="~/fckeditor/" Width="350px"
                                                            Height="200px" Value='<%# Bind("PREDICTIVE")%>'>
                                                        </FCKeditorV2:FCKeditor>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="MANGLIK_DOSHA_FOR" HeaderText="MANGLI DOSHA FOR" HeaderStyle-Width="115" />
                                                ...
                                                <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Manglik_Dosha_Update.aspx?q=" + Eval("ID") %>'
