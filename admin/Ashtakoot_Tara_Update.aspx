<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Ashtakoot_Tara_Update.aspx.cs" Inherits="admin_Ashtakoot_Tara_Update" %>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Tara Points</label>
                            <asp:Label ID="lblID" runat="server" Visible="false"></asp:Label>
                            <asp:TextBox runat="server" ID="txtTaraPoints" CssClass="form-control" Enabled="false" ></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
