<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="UpdateCategory.aspx.cs" Inherits="admin_UpdateCategory" %>
                    ...
                    <div class="x_content">
                        <div class="form-label-left input_mask">
                            ...
                            <div class="col-md-6 col-sm-6 form-group has-feedback">
                                ...
                                <asp:TextBox runat="server" ID="txtPreUrl" CssClass="form-control" Enabled="false"></asp:TextBox>
                            </div>
                            <div class="col-md-6 col-sm-6 form-group has-feedback">
                                <label style="font-size: 14px; color: #555; font-weight: bold;">Category Url</label>
                                <asp:TextBox runat="server" ID="txtCatUrl" CssClass="form-control"  Enabled="false"></asp:TextBox>
                            </div>
                            <div class="col-md-6 col-sm-6 form-group has-feedback">
                                <label style="font-size: 14px; color: #555; font-weight: bold;">Post Url</label>
                                <asp:TextBox runat="server" ID="txtPostURL" CssClass="form-control"  Enabled="false"></asp:TextBox>
                            </div>
