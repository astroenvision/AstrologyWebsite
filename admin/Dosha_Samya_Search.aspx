<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Dosha_Samya_Search.aspx.cs" Inherits="admin_Dosha_Samya_Search" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Dosha Samya Predictive<small></small></h3>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="DOSHA_SAMYA_BOY" HeaderText="DOSHA SAMYA BOY" HeaderStyle-Width="115" />
                                                  <asp:BoundField DataField="DOSHA_SAMYA_GIRL" HeaderText="DOSHA SAMYA GIRL" HeaderStyle-Width="115" />
                                              <asp:TemplateField HeaderText="PREDICTIVE" Visible="true">
                                               ...
                                               <asp:BoundField DataField="PRIORITY" HeaderText="PRIORITY" HeaderStyle-Width="175" />
                                                ...
                                                <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Dosha_Samya_Update.aspx?q=" + Eval("ID") %>'
