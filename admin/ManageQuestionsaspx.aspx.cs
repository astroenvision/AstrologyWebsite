...
public partial class admin_ManageQuestionsaspx : System.Web.UI.Page
{
    #region Declaration
    public string ID = "0";
    ...
    protected void grdData_RowUpdating(object sender, System.Web.UI.WebControls.GridViewUpdateEventArgs e)
    {
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, typeof(admin_ManageQuestionsaspx), "wq", "alert(' " + Message + "');", true);
        }
        else
        {
            ScriptManager.RegisterClientScriptBlock(this, typeof(admin_ManageQuestionsaspx), "wq", "alert('Some Error Occured!!');", true);
        }
