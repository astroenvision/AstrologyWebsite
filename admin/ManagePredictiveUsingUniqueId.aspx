<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="ManagePredictiveUsingUniqueId.aspx.cs" Inherits="admin_ManagePredictiveUsingUniqueId" %>
                        ...
                        <div class="col-md-12 col-sm-12  ">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <div class="col-md-2">
                                        <asp:Label runat="server">Logic:</asp:Label>
                                    ...
                                    <div class="col-md-2">
                                        <asp:Label runat="server">Predictive Type:</asp:Label>
                                    ...
                                    <div class="col-md-2">
                                        <asp:Label runat="server">Enter Any Logic</asp:Label>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            CssClass="table table-striped jambo_table bulk_action" HeaderStyle-CssClass="headings" PageSize="10" HeaderStyle-BackColor="#f25e0a" HeaderStyle-ForeColor="White" OnRowDataBound="grdviews_RowDataBound">
                                ...
                                <div class="x_content">
                                    <div style="float: left; width: 100%; margin: 0% auto;padding: 0% 0% 0.5% 0%;">
                                        <span id="lbl_result_gdvpredictive" runat="server" style="color: black;font-weight:bold;"></span>
                                    </div>
                                    <div class="table-responsive">
                                        <asp:GridView ID="gdvpredictive" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="gdvpredictive_PageIndexChanging"
                                            CssClass="table table-striped jambo_table bulk_action" HeaderStyle-CssClass="headings" PageSize="10" 
                                            HeaderStyle-BackColor="#f25e0a" HeaderStyle-ForeColor="White" OnRowDataBound="gdvpredictive_RowDataBound">
                                            <AlternatingRowStyle CssClass="even" />
                                            <Columns>
                                                <%--<asp:TemplateField HeaderText="ID" Visible="true">
                                                    <ItemStyle Wrap="true" VerticalAlign="top" HorizontalAlign="Left"></ItemStyle>
                                                ...
                                                <asp:TemplateField HeaderText="Total Records" Visible="true">
                                                    <ItemStyle Wrap="true" VerticalAlign="top" HorizontalAlign="Left"></ItemStyle>
                                                    <HeaderStyle HorizontalAlign="Left" Width="140px"></HeaderStyle>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbltotalrecords" runat="server" Text='<%# Bind("NOOFRECORDS")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Edit">
                                                    <HeaderStyle VerticalAlign="Middle" HorizontalAlign="Center" Width="70px"></HeaderStyle>
