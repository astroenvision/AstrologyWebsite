<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Vadha_Vainasika_Search.aspx.cs" Inherits="admin_Vadha_Vainasika_Search" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Vadha Vainasika Predictive<small></small></h3>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True"  AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="GIRL_CONSTELLATION" HeaderText="GIRL CONSTELLATION"  />
                                                  <asp:BoundField DataField="BOY_CONSTELLATION" HeaderText="BOY CONSTELLATION"  />
                                                 ...
                                                 <asp:BoundField DataField="STATUS" HeaderText="STATUS" HeaderStyle-Width="115" />
                                                 <asp:BoundField DataField="POINTS" HeaderText="POINTS" HeaderStyle-Width="175" />
                                                 <asp:BoundField DataField="ISMATCH" HeaderText="ISMATCH" HeaderStyle-Width="200" />
                                                     <asp:BoundField DataField="ISMATCH_EXCEPTION" HeaderText="ISMATCH EXCEPTION" HeaderStyle-Width="200" />
                                                 ...
                                                 <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Vadha_Vainasika_Update.aspx?q=" + Eval("ID") %>'
