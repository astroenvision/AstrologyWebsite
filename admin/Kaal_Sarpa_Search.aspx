<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Kaal_Sarpa_Search.aspx.cs" Inherits="admin_Kaal_Sarpa_Search" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Kaal Sarpa Yoga Predictive<small></small></h3>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True"  AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="KAAL_SARPA_TYPE" HeaderText="KAAL SARPA TYPE"  />
                                                   <asp:TemplateField HeaderText="LOGIC" Visible="true">
                                                    ...
                                                    <ItemTemplate>
                                                        <FCKeditorV2:FCKeditor ID="rtepredictive" ToolbarSet="Standard" runat="server" BasePath="~/fckeditor/" Width="350px"
                                                            Height="200px" Value='<%# Bind("LOGIC")%>'>
                                                        </FCKeditorV2:FCKeditor>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                 <asp:BoundField DataField="PRIORITY" HeaderText="PRIORITY" HeaderStyle-Width="115" />
                                                 <asp:BoundField DataField="RAHU_HOUSE" HeaderText="RAHU HOUSE" HeaderStyle-Width="175" />
                                                 <asp:BoundField DataField="KETU_HOUSE" HeaderText="KETU HOUSE" HeaderStyle-Width="200" />
                                                 ...
                                                 <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Kaal_Sarpa_Update.aspx?q=" + Eval("ID") %>'
