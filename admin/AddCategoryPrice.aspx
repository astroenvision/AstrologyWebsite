<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="AddCategoryPrice.aspx.cs" Inherits="admin_AddCategoryPrice" %>
                ...
                <div class="col-md-12 ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <asp:DropDownList ID="ddlCategory" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlCategory_SelectChange" AutoPostBack="true" >
                                ...
                                <asp:TextBox runat="server" ID="txtUsdRate" CssClass="form-control" Text="71.75" Enabled="false"></asp:TextBox>
                                </div>
                                   <div class="col-md-12">
                                <div class="btn btn-round btn-info" >INR</div></div>
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                   <label style="FONT-SIZE: 14px;color: #555; font-weight: bold;">Actual Price</label>
                                   <asp:TextBox runat="server" ID="txtActualPrice" CssClass="form-control" Enabled="false"></asp:TextBox>
                                </div>
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                   <label style="FONT-SIZE: 14px;color: #555; font-weight: bold;">Discount Price</label>
                                   <asp:TextBox runat="server" ID="txtDiscountPrice" CssClass="form-control" Enabled="false"></asp:TextBox>
                                </div>
                                 <div class="col-md-6 col-sm-6  form-group has-feedback">
                                 ...
                                 <div class="col-md-6 col-sm-6  form-group has-feedback">
                                   ...
                                   <asp:TextBox runat="server" ID="txtFinalPrice" CssClass="form-control"  onkeyup="CalculateDiscount();"></asp:TextBox>
                                     ...
                                     <div id="divUsd" runat="server" visible="false">
                                 <div class="col-md-12">
                                <div class="btn btn-round btn-in fo" >USD</div></div>
                         
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                   <label style="FONT-SIZE: 14px;color: #555; font-weight: bold;">Increase USD Price(%)</label>
                                   <asp:TextBox runat="server" ID="txtIncreaseUsdPriceInPer" CssClass="form-control" Enabled="false" onkeyup="CalculateDiscount_USD('UsdPrice');"></asp:TextBox>
                                </div>
                                 <div class="col-md-6 col-sm-6  form-group has-feedback">
                                 ...
                                 <div class="col-md-6 col-sm-6  form-group has-feedback">
                                   ...
                                   <asp:TextBox runat="server" ID="TxtActualPriceinUsd" CssClass="form-control" Enabled="false" ></asp:TextBox>
                                </div>
                                  <div class="col-md-6 col-sm-6  form-group has-feedback">
                                   <label style="FONT-SIZE: 14px;color: #555; font-weight: bold;">USD Discount Price</label>
                                   <asp:TextBox runat="server" ID="txtUSD_DiscountPrice" CssClass="form-control" Enabled="false" ></asp:TextBox>
                                </div>
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                ...
                                <div class="col-md-6 col-sm-6  form-group has-feedback">
                                   ...
                                   <asp:TextBox runat="server" ID="txtUSD_FinalPrice" CssClass="form-control"  Enabled="false"></asp:TextBox>
                                </div>
                                           </div>
