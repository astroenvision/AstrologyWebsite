<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Eka_Nakashtra_Dosha_Update.aspx.cs" Inherits="admin_Eka_Nakashtra_Dosha_Update" %>
     ...
     <div class="right_col" role="main">
        <div class="page-title">
            <div class="title_left">
                <h3>Update Eka Nakashtra Dosha Predictive</h3>
            </div>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Girl Constellation</label>
                            <asp:Label ID="lblID" runat="server" Visible="false"></asp:Label>
                            <asp:TextBox runat="server" ID="txtGirlConstellation" CssClass="form-control" Enabled="false" ></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Boy Constellation</label>
                            <asp:TextBox runat="server" ID="txtBoyConstellation" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Girl Charan</label>
                            <asp:TextBox runat="server" ID="txtGirlCharan" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Boy Charan</label>
                            <asp:TextBox runat="server" ID="txtBoyCharan" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                         <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Girl Boy Charan</label>
                            <asp:TextBox runat="server" ID="txtGirlBoyCharan" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                           <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Match</label>
                            <asp:TextBox runat="server" ID="txtMatch" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
