<%@ Page Language="C#" AutoEventWireup="true" CodeFile="natal_update_predictive.aspx.cs" Inherits="admin_natal_update_predictive" %>
                    ...
                    <div class="form-white-background">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <div class="form-row" style="float: left; width: 100%; margin: 1em 0em 0em 0em; color: #5f5f5f; text-align: left;">
                                    <label>
                                        ...
                                        <asp:DropDownList ID="ddltable" runat="server" CssClass="dropdowncss" AutoPostBack="true"
                                            OnSelectedIndexChanged="ddltable_SelectedIndexChanged" Width="180" Enabled="false">
                                    ...
                                    <label>
                                        <span style="padding-right: 20px;">Unique Id:</span>
                                ...
                                <div class="form-row" style="float: left; width: 100%; margin: 1em 0em 0em 0em; color: #5f5f5f; text-align: left;">
                                    <label>
                                        <span>Keystring/Filter:</span><asp:TextBox ID="txtkeystringnew" runat="server"
                                            Text="" Width="100%" ReadOnly="true"></asp:TextBox>
                                    </label>
                                </div>
                                <div class="form-row" style="float: left; width: 100%; margin: 1em 0em 0em 0em; color: #5f5f5f; text-align: left;">
                                    <label>
                                        <span>Logic:</span><asp:TextBox ID="txtlogic" runat="server"
                                            Text="" Width="100%" ReadOnly="true"></asp:TextBox>
                                    </label>
                                </div>
                               <%-- <div class="form-row" style="float: left; width: 100%; margin: 1em 0em 0em 0em; color: #5f5f5f; text-align: left;">
                                ...
                                <div class="form-row" style="float: left; width: 100%; margin: 1em 0em 0em 0em; color: #5f5f5f; text-align: left;">
                                    <label>
                                        <div style="float: left;">
                                            <span style="padding-right: 38px;">Predictive:</span>
                                            <FCKeditorV2:FCKeditor ID="rtepredictivenew" ToolbarSet="Standard" runat="server" BasePath="~/fckeditor/" Width="900px"
                                                Height="300px">
                                ...
                                <div class="form-row" style="float: left; width: 100%; margin: 1em 0em 0em 0em; text-align: left;">
                                    <asp:Button ID="btnupdate" runat="server" Text="Update Predictive" CssClass="buttoncss marginlft" OnClick="btnupdate_Click" />
                                    <asp:Button ID="btndelete" runat="server" Visible="false" Text="Delete" CssClass="buttoncssfltright" OnClick="btndelete_Click" OnClientClick="return ConfirmDelete();" />
                                </div>
