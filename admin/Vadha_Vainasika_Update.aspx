<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Vadha_Vainasika_Update.aspx.cs" Inherits="admin_Vadha_Vainasika_Update" %>
    ...
    <div class="right_col" role="main">
        <div class="page-title">
            <div class="title_left">
                <h3>Update Vadha Vainasika Predictive</h3>
            </div>
            ...
            <div class="col-md-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Points</label>
                            <asp:TextBox runat="server" ID="txtPoints" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                        ...
                        <div class="col-md-2 col-sm-6  form-group has-feedback">
                            <label style="font-size: 14px; color: #555; font-weight: bold;">Is Match Exception</label>
                            <asp:TextBox runat="server" ID="txtIsMatchException" CssClass="form-control" Enabled="false"></asp:TextBox>
                        </div>
                        ...
                        <div class="col-md-12  form-group has-feedback">
                            ...
                            <FCKeditorV2:FCKeditor ID="fckDefinition" runat="server" BasePath="~/fckeditor/" Height="300"></FCKeditorV2:FCKeditor>
                        </div>
                        <div class="col-md-12  form-group has-feedback">
