...
public partial class admin_RegisteredUserList : System.Web.UI.Page
{
    #region Declarations
    admin obj = new admin();
    ...
    protected void BindGrid()
    {
        ...
        ds = obj.GetDashboardDetailsNew("GET_REGISTER_USER" ,txtUserName.Text , txtFromDate.Text , txtToDate.Text , ddlSearchBy.SelectedValue, ddlSortColumn.SelectedValue, ddlSortBy.SelectedValue,"", Month);
