...
public partial class admin_FreeUserList : System.Web.UI.Page
{
    #region Declarations
    admin obj = new admin();
    ...
    protected void BindGrid()
    {
        ...
        ds = obj.GetDashboardDetailsNew("GETDETAILS", txtUserName.Text, txtFromDate.Text, txtToDate.Text, ddlSearchBy.SelectedValue,ddlSortColumn.SelectedValue,ddlSortBy.SelectedValue , "6" , Month);
    ...
    protected void grdData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Delete")
        {
            ...
            DataSet ds = new DataSet();
            ds = sub_obj.AstDeleteCommon(rowno, "", "", "", "DELETE_USER_CHART_DETAILS");
            if(ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(this, typeof(admin_FreeUserList), "wq", "alert('Some error occured!');", true);
                    return;
                }
