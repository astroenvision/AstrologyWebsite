<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="ManageAstrologer.aspx.cs" Inherits="admin_ManageAstrologer" %>
                        ...
                        <div class="title_right">
                            <div class="col-md-5 col-sm-5  form-group pull-right top_search">
                                <div class="input-group" style="display:block;text-align: right;">
                                    <asp:HyperLink ID="btnAddUser" runat="server" Text="Add Astrologer" CssClass="btn btn-success" NavigateUrl="~/admin/AddAstrologer.aspx" Target="_blank" />
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="ASTROLOGER ID" Visible="true">
                                                    <ItemStyle Wrap="true" VerticalAlign="top" HorizontalAlign="Left"></ItemStyle>
                                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblUSERID" runat="server" Text='<%# Bind("ASTROLOGER_ID")%>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="ASTROLOGER NAME">
                                                    <ItemStyle Wrap="true" VerticalAlign="top" HorizontalAlign="Left"></ItemStyle>
                                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cog' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemStyle></ItemStyle>
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/ManageAstrologerPrice.aspx?q=" + Eval("USER_ID")  %>'
                                                ...
                                                <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cog' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/AddAstrologer.aspx?q=" + Eval("ASTROLOGER_ID")  %>'
