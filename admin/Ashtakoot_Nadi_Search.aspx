<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Ashtakoot_Nadi_Search.aspx.cs" Inherits="admin_Ashtakoot_Nadi_Search" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Nadi Predictive<small></small></h3>
                        </div>
                    </div>
                                        ...
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="DEFINITION" Visible="true">
                                                    ...
                                                    <ItemTemplate>
                                                        <FCKeditorV2:FCKeditor ID="rtepredictive" ToolbarSet="Standard" runat="server" BasePath="~/fckeditor/" Width="500px"
                                                            Height="200px" Value='<%# Bind("DEFINITION")%>'>
                                                        </FCKeditorV2:FCKeditor>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="ISMATCH" HeaderText="IS MATCH" HeaderStyle-Width="120" />
                                                <asp:BoundField DataField="ISMATCH_EXCEPTION" HeaderText="IS MATCH EXCEPTION" HeaderStyle-Width="170" />
                                                ...
                                                <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Ashtakoot_Nadi_Update.aspx?q=" + Eval("ID") %>'
                                                            Target="_blank" Font-Size="1.4em"><i  class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</asp:HyperLink>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                            <EmptyDataTemplate>
