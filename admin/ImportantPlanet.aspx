<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="ImportantPlanet.aspx.cs" Inherits="admin_ImportantPlanet" %>
                    ...
                    <div class="row" style="display: block;">
                        ...
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                ...
                                <div class="x_title">
                                    <div class="col-md-3">
                                            <asp:DropDownList ID="ddlPlanet" runat="server" AutoPostBack="true" CssClass="form-control">
                                            <asp:ListItem Value="9" Selected="TRUE">The Most Important Planet</asp:ListItem>
                                            <asp:ListItem Value="10">Two Most Important Planet</asp:ListItem>
                                            <asp:ListItem Value="11">Three Most Important Planet</asp:ListItem>
                                        </asp:DropDownList>
                                        </div>
                                         <div class="col-md-2">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            CssClass="table table-striped jambo_table bulk_action" HeaderStyle-CssClass="headings"   OnRowDataBound="grdData_RowDataBound" OnRowCommand="grdData_RowCommand"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="USER ID" Visible="false">
                                                    ...
                                                    <ItemTemplate>
                                                       ...
                                                       <asp:Label ID="lblEMailID" runat="server" Visible="false" Text='<%# Server.HtmlEncode(DataBinder.Eval (Container.DataItem, "EMAILID").ToString()) %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Show Chart</span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkaReport" runat="server"  title="View Chart" Target="_blank" Font-Size="1.4em"><i  class="fa fa-eye" aria-hidden="true"></i></asp:HyperLink>
                                                      </ItemTemplate>
                                                </asp:TemplateField>
