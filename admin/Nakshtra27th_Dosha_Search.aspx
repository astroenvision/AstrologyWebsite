<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Nakshtra27th_Dosha_Search.aspx.cs" Inherits="admin_Nakshtra27th_Dosha_Search" %>
                ...
                <ContentTemplate>
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Nakshtra 27th Dosha Predictive<small></small></h3>
                        </div>
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="grdData" runat="server" AllowPaging="True"  AutoGenerateColumns="False" OnPageIndexChanging="grdData_PageIndexChanging"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="GIRL_RASHI" HeaderText="GIRL RASHI" HeaderStyle-Width="175" /> 
                                                <asp:BoundField DataField="BOY_RASHI" HeaderText="BOY RASHI" HeaderStyle-Width="200" />
                                                ...
                                                <asp:TemplateField HeaderText="&nbsp; <span><i class='fa fa-cogs' aria-hidden='true'></i></span>">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:HyperLink ID="lnkEdit" runat="server" NavigateUrl='<%# "~/admin/Nakshtra27th_Dosha_Update.aspx?q=" + Eval("ID") %>'
