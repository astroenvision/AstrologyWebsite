<%@ Page Language="C#" AutoEventWireup="true" CodeFile="researchtool_rashi.aspx.cs" Inherits="researchtool_rashi" EnableEventValidation="false"%>
...
<script type="text/javascript" language="javascript" src="javascript/researchtool_rashi.js"></script>
...
<asp:DropDownList ID="clgroup" CssClass="drpo_homenew" runat="server"></asp:DropDownList>
 ...
 <tr>
  <div class="d_header_3">
    <p>
    Choose Single Or Multiple Combination's From Following Vargas / Rashi's</p>
   </div>
  <div class="d_header_3">
 ...
 <td style="padding-left:00px;border:1px ;border-color:#7DAAE3; ">
   <div id="Divgrid1" class="divg" style= "display:none; " >
    ...
    <td runat="server" id="hdsviewgrid" style="width:97%; " align="left"  ></td>
     ...
     <div id="clinetnamediv" runat="server"  class="div_name_id_div_searchpage"  style="width:857px; height: 300px; margin-left:5px;" >
         <div class="colum-td-head" style="width:97% !important; margin-left: 0px;">
             ...
             <asp:Button ID="cross" runat="server" Text="X" style="margin-left: 700px; margin-top: -19px;"  /></div>
           ...
           <div id="rashi_div" style="width:140px; float:left;" font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">Rashi
             ...
             <div id="house_div" style="width:140px; float:left;" font-weight="600" font-family="Open Sans" font-size="11px" ForeColor="White" runat="server">House
           </div>
           ...
           <div style="width:140px;height:200px; float:left;"><asp:Label ID="ha"  runat="server" Text=""></asp:Label></div>
