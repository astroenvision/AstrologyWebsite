...
public partial class most_important_planet_report : System.Web.UI.Page
{
    #region Declarations
    ...
    public string j10 = "", h10 = "", j1 = "", h1 = "", RashiID0 = "", RashiID1 = "", j2 = "", h2 = "", RashiID2 = "", RashiID3 = "", RashiID4 = "", RashiID5 = "", flag = "", flagtitle = "",
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            Ajax.Utility.RegisterTypeForAjax(typeof(most_important_planet_report));
    ...
    void GetUserOutputDetais(string cartidval, string emailid, string groupval, string clientid)
    {
        try
        {
            ...
            if (dsd.Tables[0].Rows.Count > 0)
            {
                ...
                resultid.InnerHtml += "<tr><td class='rptprsnl_detailslefttabletd1'>Time of Birth</td><td class='rptprsnl_detailslefttabletd2'>&nbsp;:&nbsp;&nbsp;" + tobval + " (24 hrs)</td></tr>";
    ...
    protected void BindCharts(string Flag)
    {
        ...
        {
            string flagval = Request.QueryString["flag"].ToString().Trim();
            if (flagval == "single")
            {
                flagtitle = "The Most Important planet for You";
                flag = "GET_SINGLE_MOST_IMPORTANT_PLANET";
            }
            if (flagval == "two")
            {
                flagtitle = "Two Important planet for You";
                flag = "GET_TWO_MOST_IMPORTANT_PLANET";
            }
            if (flagval == "three")
            {
                flagtitle = "Three Important planet for You";
                flag = "GET_THREE_MOST_IMPORTANT_PLANET";
            }
        }
        dslp = obj_subs.GetLagnaPredictive(lagnarashival, flag);
        TBL.Append("<div style='margin-top: 10px;margin-bottom:15px;'>");
        if (Flag == "FOR_PDF")
        {
            TBL.Append("<div style='padding:0em 0em 0.4em 0em;margin: 0em auto 0.5em auto;width: 99%;text-align: left;color: #f25e0a;font-weight: bold;border-bottom: 2px solid #f25e0a;font-size: 1.3em;font-family:Roboto,sans-serif;'>" + flagtitle + "</div>");
        ...
        {
            TBL.Append("<div style='padding:0em 0em 0.4em 0em;margin: 0em auto 0.5em auto;width: 99%;text-align: left;color: #f25e0a;font-weight: bold;border-bottom: 2px solid #f25e0a;font-size: 1.1em;font-family:Roboto,sans-serif;'>" + flagtitle + "</div>");
    ...
    protected void ShowNewChart(string ChartNo)
    {
        p21 = ""; p22 = ""; p23 = ""; p24 = ""; p25 = ""; p26 = ""; p27 = ""; p28 = ""; p29 = ""; p210 = ""; p211 = ""; p212 = ""; HeaderValue = "";
        j21 = ""; j22 = ""; j23 = ""; j24 = ""; j25 = ""; j26 = ""; j27 = ""; j28 = ""; j29 = ""; j210 = ""; j211 = ""; j212 = "";
        h21 = ""; h22 = ""; h23 = ""; h24 = ""; h25 = ""; h26 = ""; h27 = ""; h28 = ""; h29 = ""; h210 = ""; h211 = ""; r11 = ""; h212 = "";
