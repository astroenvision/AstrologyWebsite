<%@ Page Language="C#" AutoEventWireup="true" CodeFile="planetaspectplanet.aspx.cs" Inherits="planetaspectplanet" %>
...
<head id="Head1" runat="server">
    <title>Planet Aspect Planet</title>
     <script type="text/javascript" language="javascript" src="javascript/planetaspectplanet.js"></script>
...
<td><asp:Label ID="Label6" runat="server" Text="in House" ></asp:Label></td>
<td><asp:DropDownList ID="house" runat="server" Width="100px" ></asp:DropDownList></td>

<td><asp:Label ID="Label2" runat="server" Text="Aspected By" ></asp:Label></td>
